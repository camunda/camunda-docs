...
5. Add a descriptive name using the properties panel. For this guide, we'll use `Call Microservice`. Since you previously opened the **General** section of the properties panel, it is likely still open when working with your service task configuration.
