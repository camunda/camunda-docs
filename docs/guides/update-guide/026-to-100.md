...
adjustments must be made to migrate from Camunda Cloud 0.26.x to 1.0.0.
...
[Zeebe](/product-manuals/zeebe/deployment-guide/index.md),
[Operate](/product-manuals/operate/deployment/configuration.md)
and
[Tasklist](/product-manuals/tasklist/deployment/configuration.md).
