...
To start building a form, log in to your [Camunda Platform 8](./create-account.md.md) account or open [Desktop Modeler](./components/modeler/about.md) and take the following steps:
