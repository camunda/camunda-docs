...
You must create a cluster if you have a new Camunda Platform 8 account. Otherwise, if you want to deploy a diagram, you will be redirected to the cluster creation first of all.
