...
| **[Data Migrator](./data-migrator/)**                 | Copies Camunda 7 runtime instances and history (audit log) to Camunda 8.                                                                                                        | [Download releases](https://github.com/camunda/camunda-7-to-8-migration-tooling/releases) \| [Source code](https://github.com/camunda/camunda-7-to-8-migration-tooling/tree/main/data-migrator)     |
