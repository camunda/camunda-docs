...
As Camunda 8 is a complete rewrite of Camunda 7, you must convert your models (BPMN, DMN, and Camunda Forms) and some of your code to work with the Orchestration Cluster REST API.
