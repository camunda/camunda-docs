...
- For low-risk processes, you can use the Web Modeler [process application development lifecycle](/docs/components/modeler/web-modeler/process-application-pipeline.md) to quickly develop and progress low-risk process application releases through the stages of a typical development lifecycle. [Milestone comparison](/docs/components/modeler/web-modeler/milestones.md#compare-milestones) (Visual and XML diffing) and [Git Sync](/docs/components/modeler/web-modeler/git-sync.md) provide a powerful combination.
