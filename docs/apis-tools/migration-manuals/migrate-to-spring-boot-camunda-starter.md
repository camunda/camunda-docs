...
description: "Migrate from Zeebe Spring SDK to Spring Boot Camunda Starter. This guide provides an overview of the migration process."
---
...
- The Zeebe Spring SDK remains available until Camunda 8.10.
