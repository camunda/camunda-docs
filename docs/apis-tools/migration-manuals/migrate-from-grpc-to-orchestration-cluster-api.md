...
The [Camunda Java Client](/apis-tools/java-client/getting-started.md) officially switched to using the Orchestration Cluster API in version 8.8.0 as the default communication method with the cluster. Please refer to the [Camunda Java Client migration guide](migrate-to-camunda-java-client.md#protocol-and-connection-rest-vs-grpc-selection) for details on how to use gRPC instead.
