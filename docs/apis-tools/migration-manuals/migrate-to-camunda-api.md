...
- All endpoints allow for fully leveraging the new [authorization-based access control concept](../../components/concepts/access-control/authorizations.md) wherease the component endpoints only support the configuration of full (wildcard) or no access.
