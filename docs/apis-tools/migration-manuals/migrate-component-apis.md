...
To continue using the V1 APIs, users and clients must be assigned the appropriate permissions under the new model. The general impact is outlined in the [Camunda 8 introduction](/components/whats-new-in-88.md#identity)
...
values={[
{label: 'Operate V1 API', value: 'operate'},
{label: 'Tasklist V1 API', value: 'tasklist'},
]}>

<TabItem value="operate">
### Operate permissions to new authorization
...
### Tasklist permissions to authorizations
