...
CPT's JSON test cases use the same schema as [test case files in Test mode](/components/hub/workspace/modeler/validation/test-case-files.md), so you can edit the same files in Test mode and execute them with CPT.
