...
```python
class CamundaClient(configuration=None, auth_provider=None, logger=None, clock=None, **kwargs)
```
...
```python
def cancel_cluster_rebalance(**kwargs)
```
...
```python
def delete_history_backup_as_cluster_admin(backup_id, *, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def delete_runtime_backup_as_cluster_admin(backup_id, *, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def delete_runtime_backup_state_as_cluster_admin(*, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def get_cluster_exporting_status(**kwargs)
```
...
```python
def get_cluster_rebalance(**kwargs)
```
...
```python
def get_cluster_upgrade_status(**kwargs)
```
...
```python
def get_history_backup_as_cluster_admin(backup_id, *, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def get_runtime_backup_as_cluster_admin(backup_id, *, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def get_runtime_backup_state_as_cluster_admin(*, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def list_history_backups_as_cluster_admin(*, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, prefix=<camunda_orchestration_sdk.types.Unset object>, verbose=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def list_runtime_backups_as_cluster_admin(*, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, prefix=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def pause_cluster_exporting(*, soft=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def resume_cluster_exporting(**kwargs)
```
...
```python
def sync_runtime_backup_state_as_cluster_admin(*, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def take_history_backup_as_cluster_admin(*, data, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def take_runtime_backup_as_cluster_admin(*, data=<camunda_orchestration_sdk.types.Unset object>, physical_tenant_id=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
def trigger_cluster_rebalance(*, data=<camunda_orchestration_sdk.types.Unset object>, dry_run=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
