...
```python
async def assign_process_instance_business_id(process_instance_key, *, data, **kwargs)
```
...
| `startup_jitter_max_seconds` | `float` \| `None`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |             |
...
```python
async def delete_decision_instance(decision_evaluation_key, *, data=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
async def get_system_configuration(**kwargs)
```
...
```python
async def resume_process_instance(process_instance_key, *, data=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
async def resume_process_instances_batch_operation(*, data, **kwargs)
```
...
```python
async def search_process_definition_variable_names(process_definition_key, *, data=<camunda_orchestration_sdk.types.Unset object>, consistency=None, **kwargs)
```
...
```python
async def suspend_process_instance(process_instance_key, *, data=<camunda_orchestration_sdk.types.Unset object>, **kwargs)
```
...
```python
async def suspend_process_instances_batch_operation(*, data, **kwargs)
```
