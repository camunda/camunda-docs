---
title: "Type Alias: ListHistoryBackupsAsClusterAdminErrors"
sidebar_label: "ListHistoryBackupsAsClusterAdminErrors"
mdx:
  format: md
---

# Type Alias: ListHistoryBackupsAsClusterAdminErrors

```ts
type ListHistoryBackupsAsClusterAdminErrors = object;
```
