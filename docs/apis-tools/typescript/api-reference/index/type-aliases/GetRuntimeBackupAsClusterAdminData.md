---
title: "Type Alias: GetRuntimeBackupAsClusterAdminData"
sidebar_label: "GetRuntimeBackupAsClusterAdminData"
mdx:
  format: md
---

# Type Alias: GetRuntimeBackupAsClusterAdminData

```ts
type GetRuntimeBackupAsClusterAdminData = object;
```
