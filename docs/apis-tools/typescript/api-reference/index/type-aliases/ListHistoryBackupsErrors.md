---
title: "Type Alias: ListHistoryBackupsErrors"
sidebar_label: "ListHistoryBackupsErrors"
mdx:
  format: md
---

# Type Alias: ListHistoryBackupsErrors

```ts
type ListHistoryBackupsErrors = object;
```
