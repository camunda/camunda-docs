---
title: "Type Alias: ClusterRuntimeBackupTenantInfoWritable"
sidebar_label: "ClusterRuntimeBackupTenantInfoWritable"
mdx:
  format: md
---
...
```ts
type ClusterRuntimeBackupTenantInfoWritable = object;
```
