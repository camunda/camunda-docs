---
title: "Type Alias: AssignProcessInstanceBusinessIdErrors"
sidebar_label: "AssignProcessInstanceBusinessIdErrors"
mdx:
  format: md
---

# Type Alias: AssignProcessInstanceBusinessIdErrors

```ts
type AssignProcessInstanceBusinessIdErrors = object;
```
