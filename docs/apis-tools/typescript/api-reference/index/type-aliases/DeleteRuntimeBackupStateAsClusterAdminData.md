---
title: "Type Alias: DeleteRuntimeBackupStateAsClusterAdminData"
sidebar_label: "DeleteRuntimeBackupStateAsClusterAdminData"
mdx:
  format: md
---
...
```ts
type DeleteRuntimeBackupStateAsClusterAdminData = object;
```
