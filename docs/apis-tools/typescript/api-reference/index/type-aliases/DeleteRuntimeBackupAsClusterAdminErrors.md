---
title: "Type Alias: DeleteRuntimeBackupAsClusterAdminErrors"
sidebar_label: "DeleteRuntimeBackupAsClusterAdminErrors"
mdx:
  format: md
---

# Type Alias: DeleteRuntimeBackupAsClusterAdminErrors

```ts
type DeleteRuntimeBackupAsClusterAdminErrors = object;
```
