---
title: "Type Alias: ClusterRuntimeBackupInfoWritable"
sidebar_label: "ClusterRuntimeBackupInfoWritable"
mdx:
  format: md
---

# Type Alias: ClusterRuntimeBackupInfoWritable

```ts
type ClusterRuntimeBackupInfoWritable = object;
```
...
```ts
physicalTenants: ClusterRuntimeBackupTenantInfoWritable[];
```
