---
title: "Type Alias: ElementInstanceFilterFields"
sidebar_label: "ElementInstanceFilterFields"
mdx:
  format: md
---

# Type Alias: ElementInstanceFilterFields

```ts
type ElementInstanceFilterFields = object;
```
