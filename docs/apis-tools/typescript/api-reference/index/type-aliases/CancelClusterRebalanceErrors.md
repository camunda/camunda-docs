---
title: "Type Alias: CancelClusterRebalanceErrors"
sidebar_label: "CancelClusterRebalanceErrors"
mdx:
  format: md
---

# Type Alias: CancelClusterRebalanceErrors

```ts
type CancelClusterRebalanceErrors = object;
```
