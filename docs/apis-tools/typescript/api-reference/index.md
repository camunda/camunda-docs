...
[tests/effect-worker-di.test.ts](https://github.com/camunda/orchestration-cluster-api-js/blob/main/effect-worker-di.test.ts) for worked examples that mock both
