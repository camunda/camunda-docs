...
:::note
Clients using a valid generated token have access to all resources within an organization, similar to [organization admin and owner access](/components/hub/workspace/modeler/collaboration/collaboration.md#organization-admin-and-owner-access).
