...
:::note
Zeebe's [backpressure mechanism](../../../self-managed/components/zeebe/operations/backpressure) can also be configured.
:::
...
If you're using a reverse proxy or a load balancer between your worker and your gateway, you may need to configure additional parameters to ensure the job stream is not closed unexpectedly with an error. If you observe regular 504 timeouts, read our guide on [job streaming](../../../self-managed/components/zeebe/zeebe-gateway/job-streaming).
