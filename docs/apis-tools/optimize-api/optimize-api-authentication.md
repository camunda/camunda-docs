...
1. [Create client credentials](/components/hub/organization/manage-clusters/manage-api-clients.md#create-a-client) in [Camunda Hub](/components/hub/workspace/modeler/index.md).
