...
| `GET /v1/decision-instances/{id}`               |                                       Get decision instances by id   | The field `id` must be used here as path variable, because the `key` field is not unique for decision instances                                                                                                                                                                                                                                                                                                                               |
