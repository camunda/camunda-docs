...
Properties related to the connection of the Camunda client to Camunda cloud. They will only be used to compose default connection details if the client is configured to `camunda.client.mode: saas`.
