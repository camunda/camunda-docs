...
:::note
Please check the new [Tasklist REST API](/docs/apis-tools/tasklist-api-rest/tasklist-api-rest-overview.md) - it has the same functionalities as the current GraphQL API but it provides a more streamlined and efficient way of interacting with our service.

The GraphQL API will be deprecated in the near future. To ensure a smooth transition, we will continue to support our GraphQL API for a period of time, giving you the opportunity to migrate to the new REST API version at your own pace. We will provide further details on the timeline and process for this migration soon.
:::
