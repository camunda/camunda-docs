...
click Job "/versioned_docs/version-8.9/apis-tools/migration-manuals/migrate-to-camunda-user-tasks.md"
click ZeebeTasks "/versioned_docs/version-8.9/apis-tools/migration-manuals/migrate-to-camunda-user-tasks.md"
...
- If you still use older job worker-based user tasks, review [migrating to Camunda user tasks](/versioned_docs/version-8.9/apis-tools/migration-manuals/migrate-to-camunda-user-tasks.md) and complete that migration before upgrading to 8.10, because this capability relied on the removed V1 Tasklist API.
