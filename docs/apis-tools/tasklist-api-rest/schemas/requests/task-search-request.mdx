...
#### [<code style={{ fontWeight: 'normal' }}>TaskSearchRequest.<b>dueDate</b></code>](#)<Bullet />`DateFilter`

> Specifying a range of due dates for the tasks to search for.

#### [<code style={{ fontWeight: 'normal' }}>TaskSearchRequest.<b>sort</b></code>](#)<Bullet />`TaskOrderBy` <Badge class="secondary" text="list"/>
