...
#### [<code style={{ fontWeight: 'normal' }}>DateFilter.<b>from</b></code>](#)<Bullet />`string` <Badge class="secondary" text="non-null"/>
...
#### [<code style={{ fontWeight: 'normal' }}>DateFilter.<b>to</b></code>](#)<Bullet />`string` <Badge class="secondary" text="non-null"/>
