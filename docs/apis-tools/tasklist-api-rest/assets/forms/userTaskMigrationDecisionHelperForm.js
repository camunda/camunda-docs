  ...
  components: [
    ...
    },
    {
      components: [
        {
          content:
            '<style>\n.decision-item {\n  font-size: 16px; \n  margin-top: 0px;\n}\n\n.info-text {\n  font-size: 12px;\n  margin-top: 4px;\n  color: #2e2e2;\n}\n</style>\n\n<div class="decision-item">\n  Do you run or develop a custom task application, or plan to do so?\n</div>\n<div class="info-text">\nA custom task application means you previously used the Tasklist API (REST or GraphQL) or <a href="https://docs.camunda.io/docs/next/self-managed/concepts/exporters/">custom exporters</a> to manage user tasks. Review the migration guidance for the current Orchestration Cluster API model.\n</div>',
          label: "HTML",
          type: "html",
          layout: {
            row: "Row_1t8ben5",
