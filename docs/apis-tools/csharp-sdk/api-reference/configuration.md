...
| -------------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Config`             | `Dictionary<String>` | Strongly typed env-style overrides (CAMUNDA_* keys).                                                                                                                                                                                                                                                                                                      |
...
| `TenantIds`               | `IReadOnlyList<String>` | Restrict job activation to the given tenant IDs (multi-tenant setups). Cannot be combined with — setting both is rejected with . If neither nor is set (or is empty), the activation request falls back to [CamundaConfig.DefaultTenantId] (which itself defaults to "&lt;default&gt;" and can be overridden via the CAMUNDA_DEFAULT_TENANT_ID environment variable).                                                                                                                                                                                                                  |
| `TenantId`                | `String`                | Convenience for the common single-tenant case. Equivalent to setting to [TenantId]. Cannot be combined with .                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
