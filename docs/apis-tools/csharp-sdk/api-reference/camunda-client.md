...
#### DeleteDecisionInstanceAsync(DecisionInstanceKey, DeleteDecisionInstanceRequest, CancellationToken)

```csharp
public Task DeleteDecisionInstanceAsync(DecisionInstanceKey decisionInstanceKey, DeleteDecisionInstanceRequest body, CancellationToken ct = default)
```
