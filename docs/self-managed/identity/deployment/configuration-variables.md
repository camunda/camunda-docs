...
See additional details for [running Identity on Amazon Aurora PostgreSQL](/self-managed/platform-deployment/amazon-aurora.md#running-identity-on-amazon-aurora-postgresql).
