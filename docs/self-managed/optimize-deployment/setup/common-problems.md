...
The most common cause for this issue is that the engine endpoint Optimize uses is not configured correctly. Check your [configuration](../configuration/#connection-to-camunda-platform-7) and ensure the engine REST URL is set correctly.
