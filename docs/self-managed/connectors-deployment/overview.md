...
id: overview
title: Overview
description: "Overview connectors."
---
...
:::note
[Inbound connectors](/components/connectors/use-connectors/inbound.md) require Operate to be deployed as part of your Camunda Self-Managed installation.
