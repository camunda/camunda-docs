...
[Docker Compose](/self-managed/installation/deploy/local/docker-compose.md), [Helm charts](/self-managed/installation/overview.md), and the [manual setup](/self-managed/installation/deploy/local/manual.md#run-connectors).
...
If you use the [Docker Compose](/self-managed/installation/deploy/local/docker-compose.md) installation, you can thus fetch all Connector templates that match the versions of the Connectors used in the backend.
