...
- **Docker pull limits** apply when downloading Camunda 8 images from Docker Hub. To avoid potential disruptions, authenticate with Docker Hub, use a mirror registry or follow our guide [Installing in an air-gapped environment](./guides/air-gapped-installation.md).
