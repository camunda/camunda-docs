...
You can test the Zeebe Gateway by asking for the cluster topology with the [Orchestration Cluster REST API](/apis-tools/camunda-api-rest/camunda-api-rest-overview.md):
