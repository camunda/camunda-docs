...
For a detailed guide on generating and using a token, conduct the relevant documentation on [authenticating with the Camunda 8 REST API](/apis-tools/orchestration-cluster-api-rest/orchestration-cluster-api-rest-authentication.md).
