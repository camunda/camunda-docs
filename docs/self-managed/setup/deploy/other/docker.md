...
| Console                                   | [camunda/console:latest](https://hub.docker.com/r/camunda/console)                                                                                                                                                                                                                     | [Configuration variables](http://localhost:3000/docs/next/self-managed/console-deployment/configuration/)              |
