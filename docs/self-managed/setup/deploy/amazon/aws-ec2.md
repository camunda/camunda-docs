...
Camunda metrics are exposed by default using the Prometheus format. To learn more about how to scrape Camunda 8, see [metrics](/self-managed/components-upgrade/monitoring/metrics.md).
...
Please conduct the general topic of backups in the [documentation](/self-managed/components-upgrade/backup-restore/backup-and-restore.md).
...
Please conduct the general topic of troubleshooting in the [documentation](/self-managed/components-upgrade/troubleshooting/troubleshooting.md).
