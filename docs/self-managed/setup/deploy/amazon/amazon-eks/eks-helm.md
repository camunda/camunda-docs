...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/merge-branch/generic/kubernetes/single-region/procedure/check-zeebe-cluster-topology.sh
```
...
```json reference
https://github.com/camunda/camunda-deployment-references/blob/merge-branch/generic/kubernetes/single-region/procedure/check-zeebe-cluster-topology-output.json
```
