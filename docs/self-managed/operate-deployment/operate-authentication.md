...
Operate provides a [REST API](/docs/apis-tools/operate-api/overview/) under the endpoint `/v1`. Clients can access this API using a JWT access token in an authorization header `Authorization: Bearer <JWT>`.
