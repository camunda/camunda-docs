...
The Orchestration cluster provides a number of built-in roles for easier setup. For details on available roles and their permissions, see the [Authorizations](../concepts/authorizations.md) page.
