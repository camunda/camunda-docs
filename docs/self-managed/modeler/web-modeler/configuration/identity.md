...
By default, communication between Web Modeler and Identity is not encrypted, as it usually happens backend-to-backend within the same [Docker](self-managed/installation/deploy/other/docker.md) network or [Kubernetes](/self-managed/installation/overview.md) cluster.
