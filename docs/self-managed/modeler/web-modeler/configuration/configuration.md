...
| `CAMUNDA_MODELER_CLUSTERS_0_URL_ZEEBE_GRPC`          | The address where your cluster can be reached.                 | `grpc://camunda-zeebe-gateway:26500`, `grpcs://camunda.example.com:26500` |
| `CAMUNDA_MODELER_CLUSTERS_0_URL_ZEEBE_REST`          | The address where the Zeebe REST API can be reached.           | `http://camunda-zeebe-gateway:8080`, `https://camunda.example.com`  |
| `CAMUNDA_MODELER_CLUSTERS_0_URL_OPERATE`             | The address where Operate can be reached.                      | `https://operate.example.com`     |
| `CAMUNDA_MODELER_CLUSTERS_0_URL_TASKLIST`            | The address where Tasklist can be reached.                     | `https://tasklist.example.com`    |
| `CAMUNDA_MODELER_CLUSTERS_0_OAUTH_URL`               | The address of your token issuer.                              | `http://camunda-keycloak/auth/realms/camunda-platform/protocol/openid-connect/token`, `https://keycloak.example.com/auth/realms/camunda-platform/protocol/openid-connect/token`    |
| `CAMUNDA_MODELER_CLUSTERS_0_OAUTH_SCOPE`             | A comma-separated list of the scopes to use with this cluster. | `camunda-identity`                        |
