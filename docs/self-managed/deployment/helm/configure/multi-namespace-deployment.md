...
Update Management deployment to deploy Console Self-Managed. For more details, visit this [Installation guide](/self-managed/deployment/helm/install/quick-install.md#install-console).
