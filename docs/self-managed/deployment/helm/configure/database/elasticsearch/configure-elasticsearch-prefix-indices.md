...
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Elasticsearch/OpenSearch Exporter indices | `camunda.data.exporters.{elasticsearch\|opensearch}.args.index-prefix` (and `CAMUNDA_DATA_EXPORTERS_{ELASTICSEARCH\|OPENSEARCH}_ARGS_INDEX_PREFIX`)     |
