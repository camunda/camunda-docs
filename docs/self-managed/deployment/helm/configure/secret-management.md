...
For additional details on Identity secrets during installation, visit the [installation guide](/self-managed/deployment/helm/install.md#create-identity-secrets).
