...
For supported versions, see [supported environments](/reference/supported-environments.md#camunda-8-self-managed) and the [RDBMS support policy](/self-managed/deployment/helm/configure/database/rdbms-support-policy.md).
