...
If you're using Keycloak deployed via the Keycloak Operator (such as in the [operator-based infrastructure guide](/self-managed/deployment/helm/configure/vendor-supported-infrastructure.md)), use `kubectl port-forward svc/keycloak-service 18080:18080` instead.
