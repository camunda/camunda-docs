...
The region slots are declared in [variables.tf](https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/terraform/clusters/variables.tf). Adjust the regions, short names, and CIDR blocks to your environment before applying.
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/export_environment_prerequisites.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/register-kubecontexts.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/storageclass-configure.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/storageclass-verify.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/submariner/install-subctl.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/submariner/deploy-broker.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/submariner/join-clusters.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/submariner/verify-submariner.sh
```
</details>
...
The security group rules are declared explicitly in [security.tf](https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/terraform/clusters/security.tf) rather than allowing all traffic between VPCs:
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/create-rdbms-secret.sh
```
</details>
...
```yaml reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/helm-values/camunda-values.yml
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/install-chart.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/submariner/export-services.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/check-cluster-topology.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/measure-rdbms-latency.sh
```
</details>
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/c3ccc64e4a6f4a3c17149067c38ca80f96548bfb/aws/kubernetes/eks-multi-region-rdbms/procedure/submariner/diagnose-submariner.sh
```
</details>
