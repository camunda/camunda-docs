...
| 3. Cutover         | **Maintenance window**<br />Typically 5–60 min (or ~5 min with warm reindex) | Freeze traffic, take a final backup, restore data, run the Helm upgrade, and resume. |
...
| ------------------------- | ----------------- | ------------------------------------------ |
| < 1 GB                    | ~5 min            | ~5 min                                     |
| 1–10 GB                   | ~10–40 min        | ~5 min                                     |
| 10–50 GB                  | ~40 min–2 hours   | ~5 min                                     |
| > 50 GB                   | 2+ hours          | ~5 min                                     |
