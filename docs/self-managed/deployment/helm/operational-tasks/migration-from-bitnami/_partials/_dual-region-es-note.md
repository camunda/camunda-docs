...
If you need to perform this migration in a dual-region environment, follow the [single-region migration procedure](../bitnami-to-operators.md) and apply it individually to each region.
:::
