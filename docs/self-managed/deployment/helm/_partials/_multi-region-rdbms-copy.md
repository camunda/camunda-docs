...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/eb903cc041aacccb9a3202baf76801faa1ae5cce/aws/kubernetes/eks-multi-region-rdbms/procedure/get-your-copy.sh
```
