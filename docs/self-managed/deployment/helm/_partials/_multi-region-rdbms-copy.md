...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/ee5e1ca727fa11e9d29558929f9c4612c10e4bcc/aws/kubernetes/eks-multi-region-rdbms/procedure/get-your-copy.sh
```
