...
title: Camunda 8.3 to 8.4 Helm chart upgrade
...
For more details, check [Connect to an OpenID Connect provider](/self-managed/deployment/helm/configure/authentication-and-authorization/connect-to-an-oidc-provider.md).
