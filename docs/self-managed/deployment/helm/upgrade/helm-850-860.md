...
title: Camunda 8.5 to 8.6 Helm chart upgrade
...
The separated Ingress Helm configuration has been deprecated in 8.6, and will be removed from the Helm chart in 8.8. If using a separated Ingress, switch to a [combined Ingress](/self-managed/deployment/helm/configure/ingress/ingress-setup.md) to ensure a smooth upgrade experience.
