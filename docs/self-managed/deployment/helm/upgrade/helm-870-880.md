  ...
  security:
    authentication:
      ...
      oidc:
        ...
        # Configure the claim in the access token to identify a client, default: sub
        clientIdClaim: "azp"
        ...
        groupsClaim: "groups"
        # For Microsoft Entra ID the following claims are required
        scope: "openid,profile,offline_access,<YOUR_AUDIENCE>/.default"
