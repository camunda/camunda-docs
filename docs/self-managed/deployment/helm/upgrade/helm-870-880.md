...
| `operate.retention`<br/>`tasklist.retention`                                                         | Former Operate and Tasklist retention configurations needs to get merged into `orchestration.retention`, there is no possibility to have different retention polices for Operate, Tasklist and Zeebe anymore as they become the joint Orchestration Cluster application.                                                                                                                                                       |
| `operate.retention`<br/>`tasklist.retention`                                                         | Former Operate and Tasklist retention configurations needs to get merged into `orchestration.retention`, there is no possibility to have different retention polices for Operate, Tasklist and Zeebe anymore as they become the joint Orchestration Cluster application.                                                                                                                                                       |
...
| `tasklist.identity.userAccessRestrictions.enabled`                                                   | There is no equivalent key in the 13.x Helm Chart, you would need to enable the Tasklist V1 API and access restrictions through `orchestration.{env\|envFrom\|configuration}` see [Configure user task access restrictions](../../../components/orchestration-cluster/tasklist/user-task-access-restrictions.md) on the relevant configuration properties.                                                                     |
| **Remove remaining component specific keys**                                                         |                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `operate`                                                                                            | Please revise whether any of the remaining config may be relevant for the new joint `orchestration` configuration and remove it after.                                                                                                                                                                                                                                                                                         |
| `tasklist`                                                                                           | Please revise whether any of the remaining config may be relevant for the new joint `orchestration` configuration and remove it after.                                                                                                                                                                                                                                                                                         |
| `zeebeGateway`                                                                                       | Please revise whether any of the remaining config may be relevant for the new joint `orchestration` configuration and remove it after.                                                                                                                                                                                                                                                                                         |
