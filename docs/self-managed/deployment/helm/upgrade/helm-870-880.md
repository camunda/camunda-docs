...
| **Retention**                      | Due to application consolidation, retention configuration per application is no longer supported. Retention policies must now be configured on Orchestration cluster level. See [Configure data retention](/self-managed/deployment/helm/configure/data-retention.md) for details.                                                                                                       |
