...
| `tasklist.identity.userAccessRestrictions.enabled`                                                   | There is no equivalent key in the 13.x Helm Chart, you would need to enable the Tasklist V1                                                                                                                                                                                                                                                                                                                                    |
| **Remove remaining component specific keys**                                                         |                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `operate`                                                                                            | Please revise whether any of the remaining config may be relevant for the new joint `orchestration` configuration and remove it.                                                                                                                                                                                                                                                                                               |
| `tasklist`                                                                                           | Please revise whether any of the remaining config may be relevant for the new joint `orchestration` configuration and remove it.                                                                                                                                                                                                                                                                                               |
| `zeebeGateway`                                                                                       | Please revise whether any of the remaining config may be relevant for the new joint `orchestration` configuration and remove it.                                                                                                                                                                                                                                                                                               |
