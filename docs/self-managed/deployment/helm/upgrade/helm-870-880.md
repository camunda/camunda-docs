...
- **Single secondary storage (e.g. single central Elasticsearch / OpenSearch cluster):**  
...
In any case, the regions must be upgraded **simultaneously**, though specific caveats may apply as outlined above.
