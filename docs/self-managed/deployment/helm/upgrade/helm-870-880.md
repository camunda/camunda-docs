...
Disable the migration components from [Step 3: Prepare and run the upgrade](#step-3-prepare-and-run-the-upgrade) so they aren’t recreated on your next helm upgrade.
