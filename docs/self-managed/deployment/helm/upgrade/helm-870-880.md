...
and [Assess Camunda 8.8 changes and impact](/self-managed/update/administrators/prepare-for-admin-upgrade/#step-2-assess-camunda-88-changes-and-impact) before proceeding with your upgrade from 8.7.  
:::
...
| Change                             | Description                                                                                                                                                                                                                                                                                                                                                                              |
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Application consolidation**      | Zeebe, Zeebe Gateway, Operate, and Tasklist are consolidated into a single deployment artifact called the [Orchestration Cluster](/reference/glossary/#orchestration-cluster).                                                                                                                                                                                                           |
...
| **Multitenancy**                   | A new configuration model is introduced. See [Configure multitenancy](/self-managed/deployment/helm/configure/configure-multi-tenancy.md).                                                                                                                                                                                                                                               |
...
For an internal setup, follow the [Internal Keycloak guide](self-managed/deployment/helm/configure/authentication-and-authorization.md##internal-keycloak)
.
For an external Keycloak deployment, make sure your `values.yaml` is configured as described in [OpenID connect provider setup](/self-managed/deployment/helm/configure/connect-to-an-oidc-provider.md).
...
Review the new [secret conventions](/self-managed/deployment/helm/configure/secret-management/) in 8.8 and upgrade your secrets accordingly.
...
If you used multitenancy in 8.7, be aware that a new configuration model is introduced in 8.8. See [Configure multitenancy](/self-managed/deployment/helm/configure/configure-multi-tenancy.md) for details.
