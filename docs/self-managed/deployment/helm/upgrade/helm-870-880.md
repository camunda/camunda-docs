...
- A `*-importer` deployment appears to handle remaining 8.7 records.
...
- Data migration logs should contain the following [lines](../../../components/components-upgrade/870-to-880.md#monitor-completion-1)
- Identity migration logs should contain the following [lines](../../../components/components-upgrade/870-to-880.md#monitor-completion)
