...
In v10.0.0, it is possible to use external OpenSearch. For more information on how to set up external OpenSearch, refer to [using external OpenSearch](/self-managed/deployment/helm/configure/database/using-existing-opensearch.md).
