...
Note that the number of migrations, the final version, and the execution time may vary depending on your the exact versions you migrate between and your database setup.
