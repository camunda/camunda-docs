...
| `global.elasticsearch.tls.existingSecret`         | Use `global.elasticsearch.tls.secret.existingSecret`.                                                                                                                                                     |
| `global.opensearch.tls.existingSecret`            | Use `global.opensearch.tls.secret.existingSecret`.                                                                                                                                                        |
