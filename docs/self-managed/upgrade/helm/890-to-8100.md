...
Camunda 8.10 consolidates Console and Web Modeler into Camunda Hub. Therefore, you must replace all `console` and `webModeler` top-level configurations with `camundaHub`.
