...
| `orchestration.log4j2`                                                                                                                            | Move to a file-content `extraConfiguration` entry (`log4j2.xml`) with `springImport: false`. See [excluding files from `spring.config.import`](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/configure/application-configs.md#excluding-files-from-springconfigimport).                                                                                                 |
