...
Create an [EKS Pod Identity association](https://docs.aws.amazon.com/eks/latest/userguide/pod-id-association.html) for each component service account instead of using the `eks.amazonaws.com/role-arn` annotation.
