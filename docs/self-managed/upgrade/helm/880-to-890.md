...
| `webModeler.webapp.*`                             | Removed. The `webapp` component no longer exists; `restapi` now serves both the API and the web application. Remove all `webModeler.webapp.*` keys from your values file.                                                                                                                                                                    |
