...
With dynamic cluster management, clusters can regularly [send license information](/self-managed/components/orchestration-cluster/zeebe/configuration/broker.md#console-ping-configuration) to a discovery endpoint:
