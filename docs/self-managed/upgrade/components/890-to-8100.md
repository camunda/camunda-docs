...
- Hub logs a `WARN` for each translated setting at startup, naming the 8.9 setting and the 8.10 equivalent it was translated to. Check this log after upgrading to confirm the translation, especially the merged `audiences` list, matches what you expect.
