...
**Action:** Change these API clients to [OIDC bearer tokens](/apis-tools/optimize-api/optimize-api-authentication.md). Then remove the setting. To keep the 8.9 behavior for the duration of 8.10, set `optimize.security.csl.enabled=false`.
