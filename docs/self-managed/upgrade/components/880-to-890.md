...
Refer to the [configuration page](/self-managed/components/hub/configuration/properties.md#identity--keycloak) for details on these properties.
...
Refer to the [configuration page](/self-managed/components/hub/configuration/properties.md#websocket) for details on these properties.
...
Refer to the [configuration page](/self-managed/components/hub/configuration/properties.md#feature-flags) for details on these properties.
...
Refer to the [configuration page](/self-managed/components/hub/configuration/properties.md#unstable-configuration-options) for details on this property.
