...
- **Configure a custom prefix:** Configure your own prefix via:
  ...
  - Environment variable: `CAMUNDA_CONNECTOR_SECRETPROVIDER_ENVIRONMENT_PREFIX`
...
Refer to the [configuration page](/self-managed/components/hub/configuration/modeler-configuration.md#identity--keycloak) for details on these properties.
...
Refer to the [configuration page](/self-managed/components/hub/configuration/modeler-configuration.md#websocket) for details on these properties.
...
Refer to the [configuration page](/self-managed/components/hub/configuration/modeler-configuration.md#feature-flags) for details on these properties.
...
Refer to the [configuration page](/self-managed/components/hub/configuration/modeler-configuration.md#unstable-configuration-options) for details on this property.
...
Refer to the [logging documentation](/self-managed/components/hub/configuration/logging.md#client-log-level) for more details.
...
[proxy configuration troubleshooting guide](/self-managed/components/hub/troubleshooting/troubleshoot-proxy-configuration.md#resolution).
...
[SSL configuration guide](/self-managed/components/hub/configuration/modeler-ssl.md#optional-provide-a-custom-certificate).
...
For advanced configuration options, see [logging](/self-managed/components/hub/configuration/logging.md).
