...
To learn more about how to configure mapping rules, see the Identity guide on [managing mapping rules](/self-managed/identity/orchestration-identity/mapping-rules/managing-mapping-rules.md).
