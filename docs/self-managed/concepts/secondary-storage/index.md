...
| Secondary storage | Stores workflow, decision, and task data for querying, visualization, and API access.                                             | Elasticsearch / OpenSearch, RDBMS (H2, PostgreSQL, MariaDB, MySQL, SQL Server, Oracle) |
...
| RDBMS (H2, PostgreSQL, MariaDB, MySQL, SQL Server, Oracle) | Self-Managed 8.9+    | Lightweight development (H2) and enterprise-grade RDBMS deployments for Operate, Tasklist, and APIs. |
