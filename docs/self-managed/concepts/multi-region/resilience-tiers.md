...
| **Data loss (RPO)**     | 15 min – 4 hours (backup-interval dependent)                                            | 0 minutes                                                                                                                                                         | No engine-state loss. No secondary-storage loss when replication monitoring is on and the disk holds the lag          |
