...
| **Recovery time (RTO)** | ~1–4 hours                                                                              | ~15 minutes                                                                                                                                                       | No operator step restores Zeebe processing. Partitions that lost their leader pause during Raft re-election                  |
| **Data loss (RPO)**     | 15 min – 4 hours (backup-interval dependent)                                            | 0 minutes                                                                                                                                                         | No engine-state loss. Secondary-storage recovery depends on replication monitoring and retained Zeebe log segments           |
