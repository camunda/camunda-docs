...
| **Data loss (RPO)**     | 15 min – 4 hours (backup-interval dependent)                                            | 0 minutes                                                                                                                                                         | 0 minutes, database dependent (see note below)                                                                                                                                                                                                                        |
