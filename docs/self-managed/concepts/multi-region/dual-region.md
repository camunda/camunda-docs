...
|                                       Operate | Active-passive (user traffic) (see [Active-active](#active-active)) | Embedded in the Orchestration cluster | <ul><li>Both regions maintain synchronized data state</li><li>Only primary serves users</li></ul>                                                                                                                                                                                                                                    | Can handle region failure without data loss when properly configured |
|                                      Tasklist | Active-passive (user traffic) (see [Active-active](#active-active)) | Embedded in the Orchestration cluster | <ul><li>Both regions maintain synchronized data state</li><li>Only primary serves users</li></ul>                                                                                                                                                                                                                                    | Can handle region failure without data loss when properly configured |
