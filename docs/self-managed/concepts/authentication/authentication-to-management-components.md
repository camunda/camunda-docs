...
Authentication to the Camunda 8 management and modeling components and their resources is managed by [Management Identity](/self-managed/components/management-identity/overview.md). This includes components such as [Web Modeler](/self-managed/components/hub/modeler-overview.md), [Console](/self-managed/components/hub/overview.md), and [Optimize](/self-managed/components/optimize/overview.md).
