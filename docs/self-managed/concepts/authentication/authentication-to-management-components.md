...
Authentication to the Camunda 8 management and modeling components and their resources is managed by [Management Identity](/self-managed/components/management-identity/overview.md). This includes components such as Camunda Hub and [Optimize](/self-managed/components/optimize/overview.md).
