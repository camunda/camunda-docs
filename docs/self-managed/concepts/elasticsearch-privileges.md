...
When [updating](/self-managed/components/components-upgrade/update-guide/introduction.md) to a newer version of Camunda 8 which requires data migration, the following are required:
