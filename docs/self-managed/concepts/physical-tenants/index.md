...
| Cluster operations | Cluster-wide operations use a cluster-scoped API.                                                        | Shared                |
...
- REST: `/v2/physical-tenant/{physicalTenantId}/...`
...
## Storage validation and readiness
