...
| Limitation                                         | Impact                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| :------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Incompatible secondary-storage types               | Tenants must use the same compatibility class: RDBMS, Elasticsearch/OpenSearch, or no secondary storage. RDBMS and `none` cannot be mixed with another class. For startup compatibility validation, Elasticsearch and OpenSearch are treated as one class and can be mixed. See [storage isolation](./storage-isolation.md#known-limitations).                                                                                                                                       |
