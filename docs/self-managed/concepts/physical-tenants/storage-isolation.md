...
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/actuator/health/readiness`                      | Node-level readiness based on secondary-storage schema initialization for Elasticsearch, OpenSearch, and RDBMS. It is `UP` when at least one Physical Tenant is ready and `DOWN` when no tenant is ready. It does not mean that every tenant is healthy. |
