...
- Browse the [single-region ECS Fargate guide](/self-managed/deploy-to-production/deploy-your-baseline/containers/amazon-ecs/aws-ecs.md) for a comparison with the simpler single-region pattern.
