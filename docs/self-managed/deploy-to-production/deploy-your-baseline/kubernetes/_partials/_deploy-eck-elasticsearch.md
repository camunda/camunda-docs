...
For more details on the Elasticsearch deployment, see [Elasticsearch deployment in the operator-based infrastructure guide](/self-managed/deploy-to-production/plan-your-deployment/kubernetes-operators.md#elasticsearch-deployment).
