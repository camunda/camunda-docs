...
- Keycloak may default to `aud: "account"` and require additional setup. See [External Keycloak](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/set-up-authentication/external-keycloak.md) for details.
