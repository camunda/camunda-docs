...
To try out Camunda 8 or for development purposes, consider signing up for our [SaaS offering](https://camunda.com/platform/). If you already have an AKS cluster, you can skip ahead to the [Helm guide](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/provision-your-cluster/microsoft-aks/aks-helm.md).
...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| Secondary storage      | [Elasticsearch via ECK Operator](/self-managed/deploy-to-production/plan-your-deployment/kubernetes-operators.md#deploy-elasticsearch) | [Azure Database for PostgreSQL](/self-managed/deployment/helm/configure/database/rdbms.md) |
...
For more details on the PostgreSQL deployment with CloudNativePG Operator, see [PostgreSQL deployment in the operator-based infrastructure guide](/self-managed/deploy-to-production/plan-your-deployment/kubernetes-operators.md#postgresql-deployment) for a production-grade setup with automated scaling, upgrades, and built-in security.
:::
...
Now that you've exported the necessary values, you can proceed with installing Camunda 8 using Helm charts. Follow the guide [Camunda 8 on Kubernetes](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/provision-your-cluster/microsoft-aks/aks-helm.md) for detailed instructions on deploying the platform to your Kubernetes cluster.
