...
- Each of your OpenShift clusters must meet at least the minimum capacity requirements for a cluster. Refer to the [cluster specification guide](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/provision-your-cluster/red-hat-openshift/self-hosted/redhat-openshift.md#cluster-specification) for details on resource allocation and infrastructure needs.
...
- The version of your OpenShift clusters must be included in the [supported versions list](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/provision-your-cluster/red-hat-openshift/self-hosted/redhat-openshift.md#supported-versions).
...
This guide assumes a generic deployment on OpenShift. If you are interested in a tested topology, follow the [ROSA Dual-Region Guide](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/provision-your-cluster/red-hat-openshift/on-aws-rosa/terraform-setup-dual-region.md).
...
_If you are unsure about the values of the backup bucket, please refer to the [S3 backup bucket module setup](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/provision-your-cluster/red-hat-openshift/on-aws-rosa/terraform-setup-dual-region.md#s3-backup-bucket-module-setup) as a reference for implementation._
...
For more details on the ECK operator deployment, see the [operator-based infrastructure guide](/self-managed/deploy-to-production/plan-your-deployment/kubernetes-operators.md#elasticsearch-deployment).
