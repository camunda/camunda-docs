...
| ------------------------- | ------------------------------------------ | ---------------------------------------------- | ---------- | ------------------------------------------------- |
| **Testing & evaluation**  | [Quick install](/self-managed/quickstart/quick-install.md)           | Embedded H2 (single-broker only)               | Low        | Local development, POCs, learning                 |
...
- If you don’t have required infrastructure, see [deploy required dependencies](/self-managed/deploy-to-production/plan-your-deployment/kubernetes-operators.md).
:::

## Installation guides

- **[Quick install](/self-managed/quickstart/quick-install.md)**:  
...
- **[Deploy required dependencies](/self-managed/deploy-to-production/plan-your-deployment/kubernetes-operators.md)**:  
