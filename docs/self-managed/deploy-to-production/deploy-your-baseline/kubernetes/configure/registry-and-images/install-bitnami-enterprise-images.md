...
- Recommendation: For production environments, Camunda recommends using managed services or [deploying required dependencies with Kubernetes operators](/self-managed/deploy-to-production/plan-your-deployment/kubernetes-operators.md) rather than Bitnami subcharts.
  :::
...
For detailed instructions, see [Deploy required dependencies with Kubernetes operators](/self-managed/deploy-to-production/plan-your-deployment/kubernetes-operators.md).
