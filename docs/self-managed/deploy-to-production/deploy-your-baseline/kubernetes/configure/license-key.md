...
For more details on working with secrets, see [Secret management](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/configure/secret-management.md).
