...
The following example uses scripts from the Terraform installation to deploy and configure Camunda 8. You can adapt these scripts to your own environment. Alternatively, use the [manual installation instructions](/self-managed/deploy-to-production/manual/install.md) to perform the base installation and configuration.
