...
| ------------------------- | --------------------------------------------------------------- | ---------------------------------------------- | ---------- | ------------------------------------------------- |
| **Testing & evaluation**  | [Quick install](/self-managed/quickstart/administrator/helm.md) | Embedded H2 (single-broker only)               | Low        | Local development, POCs, learning                 |
...
- If you don’t have required infrastructure, see [deploy required dependencies](/self-managed/deploy-to-production/plan/kubernetes-operators.md).
  :::

## Installation guides

- **[Quick install](/self-managed/quickstart/administrator/helm.md)**:  
...
- **[Deploy required dependencies](/self-managed/deploy-to-production/plan/kubernetes-operators.md)**:  
