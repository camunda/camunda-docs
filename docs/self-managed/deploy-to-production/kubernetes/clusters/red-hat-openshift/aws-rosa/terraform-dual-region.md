...
Terraform can initially appear complex. If you're new to it, you might want to start by considering [deployment in a single region](terraform.md) first.
...
Read more about the [failover procecure](/self-managed/extend/availability-and-disaster-recovery/dual-region-operational-procedure.md#procedure).
...
The next steps are generic and referenced in the **[Generic OpenShift Dual-Region for Camunda 8 guide](/self-managed/deploy-to-production/kubernetes/clusters/red-hat-openshift/self-hosted/dual-region.md#setup-advanced-cluster-management-and-submariner)**.
