...
- A Kubernetes cluster; refer to the [Terraform guide](/self-managed/deploy-to-production/kubernetes/clusters/microsoft-aks/terraform.md) for details.
...
In addition to the infrastructure diagram provided in the [Terraform setup guide](/self-managed/deploy-to-production/kubernetes/clusters/microsoft-aks/terraform.md), this section installs Camunda 8 following the architecture described in the [reference architecture](/self-managed/reference-architecture/reference-architecture.md).
...
When using standard authentication (username and password), specific environment variables must be set with valid values. Follow the guide for [Terraform](/self-managed/deploy-to-production/kubernetes/clusters/microsoft-aks/terraform.md#set-up-azure-authentication) to set them correctly.
...
For more configuration options, refer to the [Helm chart documentation](https://artifacthub.io/packages/helm/camunda/camunda-platform#parameters). Additionally, explore our existing resources in the [Camunda 8 Helm chart](/self-managed/deploy-to-production/kubernetes/install/index.md) and [related guides](/self-managed/deploy-to-production/kubernetes/configure/index.md).
