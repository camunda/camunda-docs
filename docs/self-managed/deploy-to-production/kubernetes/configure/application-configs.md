---
sidebar_label: Component configuration
...
For the complete list of configuration options per component, see the [Self-Managed Components documentation](/self-managed/components/orchestration-cluster/overview.md) (this is where each component documents its supported application configuration).
...
- [Components (Self-Managed)](/self-managed/components/orchestration-cluster/overview.md)
