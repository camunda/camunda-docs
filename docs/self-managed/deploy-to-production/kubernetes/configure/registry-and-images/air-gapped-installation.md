...
- [Web Modeler images](/self-managed/deploy-to-production/containers/docker.md#component-images):
...
- [Console images](/self-managed/deploy-to-production/containers/docker.md#component-images):
  - `console/console-sm`
...
- PostgreSQL is also a dependency for Web Modeler.
  - This dependency is optional: you can install PostgreSQL with Helm or use an existing [external database](/self-managed/quickstart/administrator/helm.md#optional-configure-external-database).
