...
import MigrationTip from '@site/docs/self-managed/deploy-to-production/kubernetes/_partials/_migration-tip.md'
...
- Recommendation: For production environments, Camunda recommends using managed services or [deploying required dependencies with Kubernetes operators](/self-managed/deploy-to-production/plan/kubernetes-operators.md) rather than Bitnami subcharts.
  :::
...
For detailed instructions, see [Deploy required dependencies with Kubernetes operators](/self-managed/deploy-to-production/plan/kubernetes-operators.md).
