...
Add extra Kubernetes manifests to the Camunda 8 [Helm chart](/self-managed/deploy-to-production/kubernetes/install/index.md) by defining them in the `values.yaml` file. Use this to include resources such as ConfigMaps, Deployments, or Services.
