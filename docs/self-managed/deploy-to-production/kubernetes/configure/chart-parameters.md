...
import MigrationTip from '@site/docs/self-managed/manage/upgrade/migration-from-bitnami/\_partials/\_migration-tip.md'
...
Deploy PostgreSQL, Elasticsearch or OpenSearch, and Keycloak separately from the Camunda Helm chart. This lets you use your preferred deployment methods, leverage managed services, and manage infrastructure lifecycles independently of Camunda. See [deploy required dependencies with Kubernetes operators](/self-managed/deploy-to-production/plan/kubernetes-operators.md).
...
See [RDBMS configuration](/self-managed/manage/databases/relational-database/configuration.md) and the glossary entry [RDBMS](/reference/glossary.md#rdbms).
:::
