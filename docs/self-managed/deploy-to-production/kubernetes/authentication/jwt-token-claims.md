...
- Keycloak may default to `aud: "account"` and require additional setup. See [External Keycloak](/self-managed/deploy-to-production/kubernetes/authentication/external-keycloak.md) for details.
