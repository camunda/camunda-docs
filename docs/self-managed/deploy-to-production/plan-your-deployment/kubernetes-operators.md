...
import MigrationTip from '@site/docs/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/_partials/_migration-tip.md'
...
If you prefer to continue using Bitnami subcharts, you can enable them by using Bitnami Enterprise images. See [Install Bitnami enterprise images](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/configure/registry-and-images/install-bitnami-enterprise-images.md) for detailed instructions.
:::
...
For end-to-end configuration patterns (OIDC-enabled "Full Cluster" including Optimize, Web Modeler, Console, and Identity), see the Full Cluster section of our [Helm installation guide](/self-managed/quickstart/quick-install.md#full-cluster).
...
- [Configure Ingress and TLS](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/configure/ingress/index.md)
- [Set up monitoring and observability](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/configure/application-configs.md)
- [Configure multi-tenancy](/self-managed/deployment/helm/configure/configure-multi-tenancy.md)
- [Production deployment guide](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/install/production/index.md)
