...
Camunda 8 Self-Managed can be deployed on any Kubernetes cluster using [Helm charts](/self-managed/installation/install.md), like EKS. However, there are a few pitfalls to avoid as described below.
