...
<details>
  ...
  <div>
    <img alt="operate and tasklist login" src={require('/docs/self-managed/installation/guides/assets/operate-tasklist-login.png').default}/>
  </div>
</details>
<details>
  <summary>Operate and Tasklist Dashboard</summary>
  <div>
    <img alt="operate and tasklist dashboard" src={require('/docs/self-managed/installation/guides/assets/operate-tasklist-dashboard.png').default}/>
  </div>
</details>
