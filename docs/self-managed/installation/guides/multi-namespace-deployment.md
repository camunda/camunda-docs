...
Update Management deployment to deploy Console Self-Managed. For more details, visit this [Installation guide](/self-managed/installation/deploy/deploy.md#install-console).
