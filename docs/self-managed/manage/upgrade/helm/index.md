...
If you are upgrading from a version earlier than 8.8, see [upgrading from an earlier version](/self-managed/manage/upgrade/index.md#upgrading-from-an-earlier-version).
:::

:::warning Upgrading to Camunda 8.10
Camunda 8.10 (chart 15.x) requires the Helm CLI v4. Switch to the Helm v4 CLI before you run `helm upgrade`. No release-state migration is required. See [Move from the Helm v3 CLI to v4](/self-managed/manage/upgrade/helm-v3-to-v4.md).
:::
...
- [Component upgrade from 8.9 to 8.10](/self-managed/manage/upgrade/components/890-to-8100.md)
