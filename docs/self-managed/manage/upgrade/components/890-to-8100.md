...
Use this page with the deployment upgrade guide for your environment. Start with the [Upgrade Camunda 8 overview](/self-managed/manage/upgrade/index.md), then apply any component-specific steps that match your setup.
