...
:::caution
Component-level changes are part of the overall [upgrade process](/self-managed/manage/upgrade/index.md). Follow the upgrade path for your deployment method and apply component-level steps when required by your configuration.
:::
...
<p class="link-arrow">[Upgrade Camunda components from 8.9 to 8.10](/self-managed/manage/upgrade/components/890-to-8100.md)</p>
