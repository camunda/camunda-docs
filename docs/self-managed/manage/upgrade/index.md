...
import OverviewImg from '@site/docs/self-managed/assets/hero-upgrade-89.png';
...
<p class="link-arrow">[Prepare for upgrade](/self-managed/manage/upgrade/prepare-for-upgrade.md)</p>
...
<p class="link-arrow">[Component upgrade from 8.8 to 8.9](/self-managed/manage/upgrade/components/890-to-8100.md)</p>
...
<p class="link-arrow">[Upgrade components](/self-managed/manage/upgrade/components/890-to-8100.md)</p>
