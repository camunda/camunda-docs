...
For the full API reference including response codes, see the [Optimize backup management API](/self-managed/manage/back-up-and-restore/optimize-backup.md#create-backup-api).
...
For the full API reference including response codes, see the [Optimize backup management API](/self-managed/manage/back-up-and-restore/optimize-backup.md#delete-backup-api).
...
For the full API reference, see the [Optimize backup management API](/self-managed/manage/back-up-and-restore/optimize-backup.md#get-backup-info-api).
