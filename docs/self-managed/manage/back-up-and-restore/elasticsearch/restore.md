...
| Snapshot repository | Elasticsearch or OpenSearch is configured to use the same snapshot repository as the backup. See [prerequisites](/self-managed/manage/back-up-and-restore/elasticsearch/backup.md#prerequisites).                                |
...
:::
   ...
   <details>
      ...
      Using the [Web Applications management API](/self-managed/manage/back-up-and-restore/webapps-backup.md#get-backups-list-api) to list backups.
   ...
   <details>
      ...
      Using the [Optimize management API](/self-managed/manage/back-up-and-restore/optimize-backup.md#get-backup-info-api) to list backups.
   ...
   <details>
      ...
      Using the [Zeebe management API](/self-managed/manage/back-up-and-restore/zeebe-backup-and-restore.md#list-backups-api) to list backups.
...
| Backup storage     | Zeebe is configured with the same backup storage as outlined in the [prerequisites](/self-managed/manage/back-up-and-restore/elasticsearch/backup.md#prerequisites).                             |
...
Assuming you're using the official [Camunda Helm chart](/self-managed/deploy-to-production/kubernetes/install/index.md), you'll have to adjust your Helm `values.yml` to supply the following temporarily.
