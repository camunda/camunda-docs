...
If you need tenant-isolated document storage details for Physical Tenants, see [Physical Tenant isolation model](/self-managed/extend/tenancy/physical-tenants/isolation-model.md).
...
Learn how to set it up in the [storage configuration guide](/self-managed/manage/document-handling/configuration/index.md).
