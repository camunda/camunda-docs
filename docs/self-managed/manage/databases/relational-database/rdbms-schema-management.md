...
2. SQL scripts are available in the Camunda release bundle or from the [Liquibase scripts page](/self-managed/manage/databases/relational-database/access-sql-liquibase-scripts.md).
