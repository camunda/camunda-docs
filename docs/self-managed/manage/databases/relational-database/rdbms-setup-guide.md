...
- For **Orchestration Cluster configuration reference**, see [RDBMS configuration overview](/self-managed/manage/databases/relational-database/configuration.md).
...
- For **supported vendors and versions**, see the [RDBMS version support policy](/self-managed/manage/databases/relational-database/rdbms-support-policy.md).
- For **deployment-specific setup**, see [Helm RDBMS configuration](/self-managed/manage/databases/relational-database/rdbms.md) or [manual RDBMS configuration](/self-managed/deploy-to-production/manual/rdbms/configuration.md).
  :::
...
- **Versions**: See the [RDBMS version support policy](/self-managed/manage/databases/relational-database/rdbms-support-policy.md).
...
For full Helm reference, see [RDBMS configuration in Helm](/self-managed/manage/databases/relational-database/rdbms.md).
...
For full manual setup, see [RDBMS configuration for manual installations](/self-managed/deploy-to-production/manual/rdbms/configuration.md).
...
For detailed Aurora setup, see [Orchestration Cluster RDBMS configuration](/self-managed/manage/databases/relational-database/configuration.md) and [Web Modeler configuration](/self-managed/components/hub/configuration/database.md).
...
- **Helm**: [JDBC driver management in Helm](/self-managed/manage/databases/relational-database/rdbms-jdbc-drivers.md)
- **Manual**: [Manual installation driver setup](/self-managed/deploy-to-production/manual/rdbms/configuration.md#jdbc-driver-management)
...
For access to SQL/Liquibase scripts or manual DBA procedures, see [Access SQL and Liquibase scripts](/self-managed/manage/databases/relational-database/access-sql-liquibase-scripts.md).
...
3. Verify database schema was initialized. See [access SQL and Liquibase scripts](/self-managed/manage/databases/relational-database/access-sql-liquibase-scripts.md) for the complete table list for your database platform.
4. Run [RDBMS validation tests](/self-managed/manage/databases/relational-database/validate-rdbms.md).
...
- [RDBMS troubleshooting](/self-managed/manage/databases/relational-database/rdbms-troubleshooting.md)
