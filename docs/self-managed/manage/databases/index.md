...
- [Elasticsearch privileges](/self-managed/manage/databases/elasticsearch-opensearch/elasticsearch-privileges.md)
- [OpenSearch privileges](/self-managed/manage/databases/elasticsearch-opensearch/opensearch-privileges.md)
- [Configure the RDBMS exporter](/self-managed/manage/databases/relational-database/configuration.md)

:::note
For guidance on coordinating backups between Zeebe (primary storage) and your configured secondary storage backend—whether Elasticsearch, OpenSearch, or an RDBMS—see the [backup and restore overview](/self-managed/manage/back-up-and-restore/index.md).
:::
