...
- **Supported versions:**: Check the [supported environments](/reference/supported-environments.md) and [RDBMS support policy](/self-managed/manage/databases/relational-database/rdbms-support-policy.md) pages to confirm which PostgreSQL versions are supported.
