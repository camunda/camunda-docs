...
Use the [Data Layer Dashboard](/self-managed/manage/monitoring/metrics.md) to monitor performance and detect issues with your secondary storage integration.
