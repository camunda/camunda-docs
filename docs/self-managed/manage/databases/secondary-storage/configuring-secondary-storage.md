...
More information about RDBMS in the Camunda Helm chart can be found on this [configuration page](/self-managed/manage/databases/relational-database/rdbms.md).
...
More information about Elasticsearch in the Camunda Helm chart can be found in [using external Elasticsearch](/self-managed/manage/databases/elasticsearch-opensearch/using-external-elasticsearch.md).
