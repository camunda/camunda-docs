...
If you are designing Physical Tenant isolation, see [Physical Tenant isolation model](/self-managed/extend/tenancy/physical-tenants/isolation-model.md) for the tenant-level execution and routing boundaries that sit on top of secondary storage.
...
<p><a href="../relational-database/benchmark-results" class="link-arrow">RDBMS benchmark results</a></p>
