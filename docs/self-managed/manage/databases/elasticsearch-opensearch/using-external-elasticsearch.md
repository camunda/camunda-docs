...
This page applies to the Orchestration Cluster only. If you also deploy Optimize, configure Optimize separately using [use external Elasticsearch for Optimize with Helm](/self-managed/manage/databases/optimize/using-external-elasticsearch.md).
...
Use the custom values file to [deploy Camunda 8](/self-managed/deploy-to-production/kubernetes/index.md):
