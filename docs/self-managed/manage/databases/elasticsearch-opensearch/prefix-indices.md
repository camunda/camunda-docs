...
- [Use external Elasticsearch](/self-managed/manage/databases/elasticsearch-opensearch/using-external-elasticsearch.md)
- [Use external OpenSearch](/self-managed/manage/databases/elasticsearch-opensearch/using-external-opensearch.md)
