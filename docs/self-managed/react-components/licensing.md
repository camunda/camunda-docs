...
For Helm installations, license keys can be configured globally in your `values.yaml` file. See the [Helm installation documentation](/self-managed/installation-methods/helm/configure/license-key.md) for more details.
