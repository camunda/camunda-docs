...
For Helm installations, license keys can be configured globally in your `values.yaml` file. See the [License key](/self-managed/deploy-to-production/kubernetes/configure/license-key.md) for more details.
