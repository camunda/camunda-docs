...
| docker-compose-web-modeler.yaml | **Standalone Web Modeler** - Runs only Web Modeler and its dependencies (Management Identity, Keycloak, PostgreSQL). See [Deploy with Web Modeler](#deploy-with-web-modeler).                                                                                                                |
...
| Orchestration Cluster Admin | [http://localhost:8080/identity](http://localhost:8080/identity) | Manage users and permissions for Orchestration Cluster (lightweight).                                                                                                                                                      |
...
| Management Identity | [http://localhost:8084](http://localhost:8084) | [Manage users](../../../components/admin/admin-introduction.md) for Console, Optimize, and Web Modeler                                                                                         |
