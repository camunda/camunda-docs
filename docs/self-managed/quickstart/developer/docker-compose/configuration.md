...
| `docker-compose-web-modeler.yaml` | Standalone Web Modeler configuration. Runs only Web Modeler and its dependencies. For deployment details, see [deploy with Web Modeler](/self-managed/quickstart/developer/docker-compose/connectors-and-modeling.md#deploy-with-web-modeler).                                       |
...
To select another Orchestration Cluster backend, see [configure secondary storage with Docker Compose](/self-managed/quickstart/developer/docker-compose/secondary-storage.md).
:::
...
- Review [install and start with Docker Compose](/self-managed/quickstart/developer/docker-compose/install-start.md).
- Review [configure secondary storage with Docker Compose](/self-managed/quickstart/developer/docker-compose/secondary-storage.md).
- Review [use connectors and deploy processes with Docker Compose](/self-managed/quickstart/developer/docker-compose/connectors-and-modeling.md).
