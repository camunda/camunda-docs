...
For container-based local deployments, see the [developer quickstart with Docker Compose](/self-managed/quickstart/developer/docker-compose/index.md).

For CLI flags and permanent configuration, see [configure Camunda 8 Run](/self-managed/quickstart/developer/c8run/configuration.md).
...
For Docker Compose environments, use the stop commands in the [developer quickstart with Docker Compose](/self-managed/quickstart/developer/docker-compose/index.md).

## Next steps

- Review [configure Camunda 8 Run](/self-managed/quickstart/developer/c8run/configuration.md).
- Review [configure secondary storage in Camunda 8 Run](/self-managed/quickstart/developer/c8run/secondary-storage.md).
