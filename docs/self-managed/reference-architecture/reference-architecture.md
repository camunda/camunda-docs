...
| Authorizations            | Fine-grained <a href="/components/concepts/access-control/authorizations.md">authorizations</a> provide consistent access control for process instances, tasks, and decisions across components and APIs.                                                                                                                                                                                                                                            |                                                                                                                                                                                              |
