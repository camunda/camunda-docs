...
- **[Amazon ECS with Fargate (dual region)](/self-managed/reference-architecture/aws/ecs-dual-region-fargate/ecs-dual-region-fargate.md)**: Active-active across two AWS regions, backed by Aurora Global Database. Experimental reference architecture.
