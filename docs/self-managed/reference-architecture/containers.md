...
With container-based deployments, you can run the [Camunda 8 Orchestration Cluster](./reference-architecture.md#orchestration-cluster-vs-camunda-hub) in a portable, consistent runtime with the benefits of containerization, without managing Kubernetes.
