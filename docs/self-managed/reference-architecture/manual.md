...
- [Amazon EC2 deployment](/self-managed/deploy-to-production/deploy-your-baseline/manual/aws-ec2.md) - a standard production setup with support for high availability.
