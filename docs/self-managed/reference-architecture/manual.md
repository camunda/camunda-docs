...
The orchestration components rely on [Elasticsearch/OpenSearch](/reference/glossary.md#elasticsearch--opensearch) as their secondary storage for indexing and search.
