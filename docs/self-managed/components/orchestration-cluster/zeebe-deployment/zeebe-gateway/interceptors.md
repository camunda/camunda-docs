...
Camunda 8 relies on [Identity](/self-managed/components/management-identity/managing-tenants.md) for tenant management.
...
Zeebe supports [multi-tenancy](/self-managed/concepts/multi-tenancy.md), or the ability for a single Zeebe installation to serve
...
functionality is already provided by [Identity](/self-managed/components/management-identity/managing-tenants.md).
...
[configurations](/self-managed/components/orchestration-cluster/zeebe-deployment/configuration/configuration.md)
