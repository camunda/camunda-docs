...
If your Zeebe deployment is managed by our [Helm charts](/self-managed/installation-methods/helm/install.md), the rolling update procedure is already automated.
