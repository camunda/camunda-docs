...
If your Zeebe deployment is managed by our [Helm charts](/self-managed/deploy-to-production/kubernetes/install/index.md), the rolling update procedure is already automated.
