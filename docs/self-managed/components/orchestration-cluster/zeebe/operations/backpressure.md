...
Alternatively, [flow control write rate limits](/self-managed/manage/flow-control/index.md) can also be used with static write rate limits or throttling. This prevents the
