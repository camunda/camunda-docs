...
| processInstanceRetentionMode | Controls how completed process instance data is grouped during archiving. Allowed values: `PI_HIERARCHY` (default), `PI_HIERARCHY_IGNORE_LEGACY`, `PI`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `PI_HIERARCHY` |
| processInstanceRetentionMode | Controls the retention behavior for process instance hierarchies in secondary storage (Elasticsearch/OpenSearch only). Allowed values: `PI_HIERARCHY` (default), `PI_HIERARCHY_IGNORE_LEGACY`, `PI`.                                                                                                                                                                                                                                                                                                                                                                                                                         | `PI_HIERARCHY` |
