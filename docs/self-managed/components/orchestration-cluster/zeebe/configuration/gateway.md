...
| memberId             | Sets the member ID of the gateway in the cluster. This setting can also be overridden using the environment variable `ZEEBE_GATEWAY_CLUSTER_MEMBERID`. This is a legacy property; use `camunda.cluster.gateway-id` instead.                                                                                                                          | gateway                                    |
