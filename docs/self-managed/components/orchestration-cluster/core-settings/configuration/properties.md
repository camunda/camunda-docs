...
| `camunda.security.authentication.oidc.endsession-endpoint-uri`      | Sets the OIDC provider's end session endpoint URI explicitly. Only takes effect if `camunda.security.authentication.oidc.issuer-uri` is not set.                                                                                                                                                                                          |                                      |
