...
See [all configuration options](/self-managed/components/orchestration-cluster/core-settings/configuration/properties.md#camundadatawait-states) to learn more.
...
With Camunda 8 Self-Managed, you control the [secondary storage retention policy](/self-managed/components/orchestration-cluster/core-settings/configuration/properties.md#data---secondary-storage), which applies to wait state records:
