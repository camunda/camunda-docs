...
| :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------ |
| `camunda.mode`     | <p>Defines the mode in which Camunda is running. This is used to activate or deactivate certain features. The mode can be set via the <code>camunda.mode</code> property. Valid, non-null values are:<ul><li><code>all-in-one</code></li><li><code>broker</code></li><li><code>gateway</code></li></ul>The mode is interpreted as case-insensitive. A <code>null</code> value means that launch modes are not used, and the behavior of the application is defined by the active profiles and configuration properties.</p> | `null`        |
| `camunda.insecure` | <p>Activates or deactivates security and authentication layers when the application is launched using <code>camunda.mode</code>. The affected components are the Gateway (embedded or dedicated), the authentication layer, and the authorization layer. Intended for development and local testing, not for production use.</p>                                                                                                                                                                                            | `false`       |
...
| `camunda.webapps.operate.ui-enabled` | <p>Decides whether the Operate UI is enabled or not. If <code>false</code>, the Operate API v1 will still be available, but Operate will not be accessible with a web browser.</p> | `true`        |
...
| `camunda.webapps.tasklist.ui-enabled` | <p>Decides whether the Tasklist UI is enabled or not. If <code>false</code>, the Tasklist API v1 will still be available, but Tasklist will not be accessible with a web browser.</p> | `true`        |
...
| `camunda.webapps.identity.ui-enabled` | <p>Decides whether the Identity UI is enabled or not. If <code>false</code>, the Identity API v1 will still be available, but Identity will not be accessible with a web browser.</p> | `true`        |

### `camunda.system`

| Property                          | Description                                                                                                                                                                                                                                                                                                                                                                                                             | Default value |
| :-------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------ |
| `camunda.system.cpu-thread-count` | <p>Controls the number of non-blocking CPU threads to be used</p><p><strong>Warning:</strong> You should never specify a value that is larger than the number of physical cores available.</p><p>Good practice is to leave 1–2 cores for IO threads and the operating system (it has to run somewhere).</p><p>For example, when running Zeebe on a machine which has 4 cores, a good value would be <code>2</code>.</p> | `2`           |
...
| Property                                      | Description                                                                                                                                                                                                                                                                                                     | Default value |
| :-------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------ |
| `camunda.system.upgrade.enable-version-check` | <p>Toggles the version check restriction, used for migration.</p><p>This is useful for testing migration logic on snapshot or alpha versions.</p><p>The default value <code>true</code> means it is not allowed to migrate to an incompatible version such as: <code>SNAPSHOT</code> or <code>alpha</code>.</p> | `true`        |
...
| Property                                    | Description                                                                                                                                                                                                                                                                                                     | Default value |
| :------------------------------------------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------ |
| `CAMUNDA_SYSTEM_UPGRADE_ENABLEVERSIONCHECK` | <p>Toggles the version check restriction, used for migration.</p><p>This is useful for testing migration logic on snapshot or alpha versions.</p><p>The default value <code>true</code> means it is not allowed to migrate to an incompatible version such as: <code>SNAPSHOT</code> or <code>alpha</code>.</p> | `true`        |
