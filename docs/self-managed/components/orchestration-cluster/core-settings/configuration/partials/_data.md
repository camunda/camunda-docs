...
| `camunda.data.audit-log.user-task-completion-variable-audit-enabled` | Record variable creates and updates caused by Camunda user task completion in the `USER_TASKS` category. Actor category and entity exclusion filters still apply. Variable values aren't recorded. | `false`                                   |
...
| `CAMUNDA_DATA_AUDITLOG_USERTASKCOMPLETIONVARIABLEAUDITENABLED` | Record variable creates and updates caused by Camunda user task completion in the `USER_TASKS` category. Actor category and entity exclusion filters still apply. Variable values aren't recorded. | `false`                                                                                                                                                                     |
