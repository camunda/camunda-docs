...
| `camunda.api.grpc.max-connection-age`       | <p>Set the maximum age of a gRPC connection before the gateway proactively closes it (via GOAWAY), forcing the client to reconnect.</p><p>If unset, the gateway keeps gRPC's own default of an unbounded connection age.</p>                                                                                 | Null          |
...
| `CAMUNDA_API_GRPC_MAXCONNECTIONAGE`      | <p>Set the maximum age of a gRPC connection before the gateway proactively closes it (via GOAWAY), forcing the client to reconnect.</p><p>If unset, the gateway keeps gRPC's own default of an unbounded connection age.</p>                                                                                 | Null          |
