...
| `camunda.security.authentication.oidc.resource`                                              | List of resource indicators to include in token and authorization requests. Used to specify target resources as defined in [RFC 8707](https://datatracker.ietf.org/doc/html/rfc8707). Environment variable: `CAMUNDA_SECURITY_AUTHENTICATION_OIDC_RESOURCE_0`, `CAMUNDA_SECURITY_AUTHENTICATION_OIDC_RESOURCE_1`, etc.                                                           |                                      |
...
| `camunda.security.authentication.providers.oidc.<provider-id>.resource`                     | List of resource indicators to include in token and authorization requests. Used to specify target resources as defined in [RFC 8707](https://datatracker.ietf.org/doc/html/rfc8707). Environment variable: `CAMUNDA_SECURITY_AUTHENTICATION_PROVIDERS_OIDC_<PROVIDER_ID>_RESOURCE_0`, etc.                                            |                                      |
