...
| `camunda.security.http-headers.content-security-policy.mode`              | Selects the built-in default policy. Options: `SELF_MANAGED`, `SAAS`, `CUSTOM`. Set this to `CUSTOM` to apply your own policy from `policy-directives`.          | [`Content-Security-Policy`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy)                                                                                                                                           | `SELF_MANAGED`                    |
...
| `camunda.security.authentication.oidc.user-info-uri`                                         | Sets the OIDC provider's user info URI explicitly. Only takes effect if the issuer URI is not set.                                                                                                                                                                                                                                                                              |                                      |
...
| `CAMUNDA_SECURITY_AUTHENTICATION_OIDC_ENDSESSIONENDPOINTURI`                                  | Sets the OIDC provider's end session endpoint URI explicitly. Only takes effect if `CAMUNDA_SECURITY_AUTHENTICATION_OIDC_ISSUERURI` is not set.                                                                                                                                                                                                                                 |                                      |
...
| `CAMUNDA_SECURITY_AUTHENTICATION_OIDC_USERINFOURI`                                            | Sets the OIDC provider's user info URI explicitly. Only takes effect if the issuer URI is not set.                                                                                                                                                                                                                                                                              |                                      |
...
| `CAMUNDA_SECURITY_HTTPHEADERS_CONTENTSECURITYPOLICY_MODE`             | Selects the built-in default policy. Options: `SELF_MANAGED`, `SAAS`, `CUSTOM`. Set this to `CUSTOM` to apply your own policy from `CAMUNDA_SECURITY_HTTPHEADERS_CONTENTSECURITYPOLICY_POLICYDIRECTIVES`. | [`Content-Security-Policy`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy)                                                                                                                                           | `SELF_MANAGED`                    |
