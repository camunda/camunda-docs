...
| `camunda.security.authentication.oidc.resource`                                              | List of resource indicators to include in token requests. Used to specify target resource servers as defined in [RFC 8707](https://datatracker.ietf.org/doc/html/rfc8707).                                                                                                                                                                                                      |                                      |
...
| `camunda.security.authentication.providers.oidc.<provider-id>.resource`                     | List of resource indicators to include in token requests. Used to specify target resource servers as defined in [RFC 8707](https://datatracker.ietf.org/doc/html/rfc8707).                                                                                                                                                             |                                      |
