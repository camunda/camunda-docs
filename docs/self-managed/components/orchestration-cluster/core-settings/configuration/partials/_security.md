...
| `camunda.security.authentication.oidc.assitional-jwk-set-uris`                               | Sets additional JWK Set URIs to fetch from the OIDC provider. This can be useful if your provider uses separate endpoints for different types of keys (e.g. ID tokens vs. access tokens).                                                                                                                                                                                       |                                      |
...
| `CAMUNDA_SECURITY_AUTHENTICATION_OIDC_ASSITIONALJWKSETURIS.[0]`                               | Sets additional JWK Set URIs to fetch from the OIDC provider. This can be useful if your provider uses separate endpoints for different types of keys (e.g. ID tokens vs. access tokens).                                                                                                                                                                                       |                                      |
