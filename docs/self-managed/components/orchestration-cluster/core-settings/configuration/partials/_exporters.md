...
Reusing a shared prefix can cause Zeebe ILM/ISM policies and wildcard index patterns to also match Orchestration Cluster indices, which may lead to unexpected data loss.
