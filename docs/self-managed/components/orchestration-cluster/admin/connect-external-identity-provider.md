...
If you deploy Camunda 8 Self-Managed with Helm, use the [Helm chart authentication and authorization guides](/self-managed/deploy-to-production/kubernetes/authentication/index.md) to configure OIDC and Admin.
:::
...
- [Helm chart authentication and authorization configuration](/self-managed/deploy-to-production/kubernetes/authentication/index.md)
