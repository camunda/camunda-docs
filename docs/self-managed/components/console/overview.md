...
- **Job dashboard**: See job types, job counts, and worker activity across the cluster. For details, see the [Job dashboard](/components/console/manage-clusters/job-dashboard.md).
