...
- **Cluster Status Dashboard**: Monitor the health of your orchestration cluster (Zeebe, Operate, Tasklist, Admin), connectors, and external services such as Optimize.
