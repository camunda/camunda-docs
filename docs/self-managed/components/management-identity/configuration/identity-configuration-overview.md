...
- Keycloak is started as a component in a [Docker Compose](/self-managed/quickstart/developer/docker-compose/index.md) and [Helm](/self-managed/deploy-to-production/kubernetes/install/index.md) Camunda 8 self-managed deployment.
