...
2.  Click **Administrator Console** and log in using the Keycloak administrator credentials.
    ...
    - When deploying Camunda 8 with [Helm charts](/self-managed/deploy-to-production/kubernetes/index.md), you can extract the password as detailed in [secrets extraction](/self-managed/manage/upgrade/helm/index.md#secrets-extraction).
