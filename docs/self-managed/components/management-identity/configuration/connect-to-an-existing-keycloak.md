...
If you deploy Camunda 8 Self-Managed with Helm, use the [Helm chart guide for connecting to an external Keycloak instance](/self-managed/deploy-to-production/kubernetes/authentication/external-keycloak.md) instead.
:::
...
[Helm chart setup for existing Keycloak](/self-managed/deploy-to-production/kubernetes/authentication/external-keycloak.md#create-a-secret).
:::
