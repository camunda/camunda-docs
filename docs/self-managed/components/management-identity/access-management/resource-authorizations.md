...
- [Operate resource based permissions](/self-managed/components/orchestration-cluster/operate-deployment/operate-authentication.md#resource-based-permissions)
- [Tasklist resource based permissions](/self-managed/components/orchestration-cluster/tasklist-deployment/tasklist-authentication.md#resource-based-permissions)
