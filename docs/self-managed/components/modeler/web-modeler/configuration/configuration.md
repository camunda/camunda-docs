...
| `CAMUNDA_MODELER_CLUSTERS_0_AUTHORIZATIONS_ENABLED` | Indicates if [authorizations](/components/concepts/access-control/authorizations.md) are enabled for the cluster. If `true`, users will see a hint when they deploy from Web Modeler.                                                                                                                                                                                                                                                                               | `true`                                                          |
