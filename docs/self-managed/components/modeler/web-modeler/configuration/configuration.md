...
| `NONE`                                                                                                                                                                                                                  | Web Modeler does not send any token.                                                                                                                                                    | Requests to the cluster do not require an access token at all because [authentication is disabled](/self-managed/components/orchestration-cluster/zeebe-deployment/security/client-authorization.md#camunda-identity-authorization).                        |
