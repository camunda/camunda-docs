...
Set up Web Modeler on Self‑Managed by configuring core services like the database, identity, networking, and environment‑specific options before going live.

<p><a href="../configuration/" class="link-arrow">Configuration overview</a></p>

## Troubleshoot

Diagnose and resolve common issues in Web Modeler on Self‑Managed, including database connection, proxy configuration and missing data problems among others.

<p><a href="../troubleshooting/troubleshoot-database-connection/" class="link-arrow">Troubleshoot database connection</a></p>
