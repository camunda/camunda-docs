...
Refer to the [Zeebe Gateway configuration documentation](/self-managed/components/orchestration-cluster/zeebe-deployment/security/secure-client-communication.md#gateway)
