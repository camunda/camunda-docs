...
The table marks the settings that Camunda 8.10 deprecates or no longer uses. For the full mapping to `camunda.security.*`, see [legacy configuration keys](/self-managed/upgrade/components/890-to-8100.md#legacy-security-configuration-keys-are-deprecated).

| YAML path                                        | Environment variable                                    | Default value   | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------------------------------ | ------------------------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|                                                  |
| security.auth.token.lifeMin                      |                                                         | 60              | Not used in 8.10 unless you opt into the 8.9 component-specific configuration fallback. Optimize uses token-based authentication to keep track of which users are logged in. Define the lifetime of the token in minutes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| security.auth.token.secret                       | CAMUNDA_OPTIMIZE_SECURITY_AUTH_TOKEN_SECRET             | null            | Not used in 8.10 unless you opt into the 8.9 component-specific configuration fallback. Optional secret used to sign authentication tokens, it's recommended to use at least a 64-character secret. If set to `null` a random secret will be generated with each startup of Optimize.                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| security.responseHeaders.HSTS.max-age            | CAMUNDA_OPTIMIZE_SECURITY_RESPONSE_HEADERS_HSTS_MAX_AGE | 63072000        | Deprecated in 8.10. Use `camunda.security.http-headers.hsts.max-age-in-seconds`. HTTP Strict Transport Security (HSTS) is a web security policy mechanism which helps to protect websites against protocol downgrade attacks and cookie hijacking. This field defines the time, in seconds, that the browser should remember that this site is only to be accessed using HTTPS. If you set the number to a negative value no HSTS header is sent.                                                                                                                                                                                                                                                                              |
...
| es.settings.index.number_of_replicas     | CAMUNDA_OPTIMIZE_ELASTICSEARCH_SETTINGS_INDEX_NUMBER_OF_REPLICAS     | 1             | How often data should be replicated to handle node failures.                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| YAML path                                      | Environment variable                                              | Default value   | Description                                                                                                                                                        |
| ---------------------------------------------- | ----------------------------------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|                                                | CAMUNDA_OPTIMIZE_DATABASE                                         | `elasticsearch` | Type of database being used. Either `elasticsearch` or `opensearch`                                                                                                |
...
| opensearch.settings.index.nested_documents_limit | CAMUNDA_OPTIMIZE_OPENSEARCH_SETTINGS_INDEX_NESTED_DOCUMENTS_LIMIT | 10000         | Optimize uses nested documents to store list information such as activities or variables belonging to a process instance. This setting defines the maximum number of activities, variables, or incidents that a single process instance can contain. This limit helps to prevent out of memory errors and should be used with care. See [troubleshooting](#troubleshooting) if you hit this limit, and refer to the OpenSearch documentation on this topic for more information. |
...
| entity.nameMaxLength       | CAMUNDA_OPTIMIZE_ENTITY_NAME_MAX_LENGTH | 32768         | Maximum number of characters allowed in the name of a report, collection, dashboard, or alert. Longer names are rejected with a validation error when the entity is created or updated. Lower this value to enforce a stricter naming policy.                                                                                                                                                                                                                                                                                                 |
