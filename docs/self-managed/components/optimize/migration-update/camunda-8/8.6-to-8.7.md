---
id: 8.6-to-8.7
description: "To update Optimize to version 8.7, perform the steps in the migration and update instructions.The update to 8.7 can be performed from any 8.6 release."
