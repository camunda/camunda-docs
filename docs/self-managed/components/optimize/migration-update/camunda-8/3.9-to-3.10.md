---
id: 3.9-to-3.10
description: "To update Optimize to version 3.10, perform the steps in the migration and update instructions.The update to 3.10 can be performed from any 3.9.x release."
