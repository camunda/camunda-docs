...
description: "To update Optimize to version 3.9.x-preview-1, perform the following steps: Migration & Update Instructions. The update to 3.9.x-preview-1 can be performed..."
