...
description: "To update Optimize to version 8.4/3.12, perform the steps in the migration and update instructions. The update to 8.4/3.12 can be performed from any 8.3/3.11..."
