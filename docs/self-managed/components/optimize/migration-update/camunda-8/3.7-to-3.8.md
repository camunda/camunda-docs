---
id: 3.7-to-3.8
description: "To update Optimize to version 3.8.x, perform the following steps: Migration & Update Instructions.The update to 3.8.x can be performed from any 3.7.x release."
