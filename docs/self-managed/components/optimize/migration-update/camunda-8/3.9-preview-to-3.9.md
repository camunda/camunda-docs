...
description: "To update Optimize to version 3.9.x, perform the steps in the migration and update instructions. The update to 3.9.x can be performed from any 3.8.x or any..."
