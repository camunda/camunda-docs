...
description: "Troubleshooting guide for issues caused by incorrect proxy configuration in Camunda Hub."
---

Troubleshoot and resolve issues in Camunda Hub caused by incorrect or incomplete proxy configuration.

## Issue

Users experience a variety of failures when Camunda Hub attempts to communicate with external services. These issues can manifest as:
