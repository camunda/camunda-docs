...
To restore project access for the affected users, Web Modeler admins already have the [access](../../../../components/hub/workspace/modeler/collaboration/collaboration.md#organization-admin-and-owner-access) needed to reassign collaborators to orphaned projects.
