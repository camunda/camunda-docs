...
To restore project access for the affected users, Web Modeler admins already have the [elevated access](../../../../components/hub/workspace/modeler/collaboration/collaboration.md#super-user-mode) needed to reassign collaborators to orphaned projects.
