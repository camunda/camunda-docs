...
If that doesn't work, resolve the general connection issue first (see [the platform deployment troubleshooting section](self-managed/troubleshooting/index.md), for example.)
...
Ensure you properly [configured your Zeebe Ingress to support ALPN](self-managed/troubleshooting/index.md#zeebe-ingress-grpc).
