...
The Camunda 8 [Helm](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/install/index.md) and [Docker Compose](/self-managed/quickstart/developer-quickstart/docker-compose.md) distributions provide a local Zeebe cluster configured by default.
