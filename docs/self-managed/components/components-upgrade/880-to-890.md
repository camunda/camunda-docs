...
description: "The following sections explain which adjustments must be made to migrate from Camunda 8.8.x to 8.9.x. Web Modeler's restapi component now uses Apache Log4j 2..."
---
