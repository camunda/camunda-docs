...
- What exporter-side filters are and how to configure them, see:
  - [Elasticsearch exporter](../../orchestration-cluster/zeebe/exporters/elasticsearch-exporter/)
  - [OpenSearch exporter](../..//orchestration-cluster/zeebe/exporters/opensearch-exporter/)

- When to use exporter-side filters for Optimize and how to perform a safe re-import, see:
  - [Camunda 8 system configuration (Optimize)](../../optimize/configuration/system-configuration-platform-8/)
