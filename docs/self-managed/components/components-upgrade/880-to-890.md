...
RocksDB strategy is now automatic (`FRACTION`), which lets Camunda allocate
the RocksDB memory based on a fraction of total memory. For more information
see the [resource planing page](/self-managed/components/orchestration-cluster/zeebe/operations/resource-planning.md).
