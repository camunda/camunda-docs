...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **read**       | `PROCESS_DEFINITION:*:READ_PROCESS_DEFINITION`<br></br>`PROCESS_DEFINITION:*:READ_PROCESS_INSTANCE`<br></br>`DECISION_DEFINITION:*:READ_DECISION_DEFINITION`                                                                                                                                                                           |
| **write**      | all **read** permissions<br></br>`PROCESS_DEFINITION:*:CANCEL_PROCESS_INSTANCE`<br></br>`PROCESS_DEFINITION:*:UPDATE_PROCESS_INSTANCE`<br></br>`PROCESS_DEFINITION:*:MODIFY_PROCESS_INSTANCE`<br></br>`PROCESS_DEFINITION:*:DELETE_PROCESS_INSTANCE`<br></br>`RESOURCE:*:DELETE_DECISION_INSTANCE`<br></br>`RESOURCE:*:DELETE_PROCESS` |
...
| Resource                                                                                                                  | Required permission(s)                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
...
| Operations and batch operations                                                                                           | Users can only view operations they created                                                                                     |
