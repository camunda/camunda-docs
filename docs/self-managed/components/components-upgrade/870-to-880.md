...
In any case follow the configuration instructions for the secondary storage for Elasticsearch or OpenSearch and supply the respective values for Tasklist and Operate index prefixes.
