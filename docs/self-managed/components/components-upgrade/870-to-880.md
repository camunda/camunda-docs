...
To fully leverage the new authorizations and customize access, refer to the access control documentation for [Operate](/components/operate/overview/access-control.md) and [Tasklist](/components/tasklist/userguide/access-control.md).
