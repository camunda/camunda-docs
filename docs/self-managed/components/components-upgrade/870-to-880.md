...
Throughout this section, references to Elasticsearch or OpenSearch are interchangeable. See the [glossary entry for Elasticsearch/OpenSearch](/reference/glossary.md#elasticsearchopensearch) for terminology and guidance on secondary storage.
