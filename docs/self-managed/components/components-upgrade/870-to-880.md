...
To ease the effort for migrating data from [Management Identity](../management-identity/overview.md) to the new [Orchestration Cluster Identity](/components/identity/identity-introduction.md), a Identity Migration Application is provided.
