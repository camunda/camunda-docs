...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **read**       | `PROCESS_DEFINITION:*:READ_PROCESS_DEFINITION`<br>`PROCESS_DEFINITION:*:READ_PROCESS_INSTANCE`<br>`DECISION_DEFINITION:*:READ_DECISION_DEFINITION`                                                                                                                                                       |
| **write**      | all **read** permissions<br>`PROCESS_DEFINITION:*:CANCEL_PROCESS_INSTANCE`<br>`PROCESS_DEFINITION:*:UPDATE_PROCESS_INSTANCE`<br>`PROCESS_DEFINITION:*:MODIFY_PROCESS_INSTANCE`<br>`PROCESS_DEFINITION:*:DELETE_PROCESS_INSTANCE`<br>`RESOURCE:*:DELETE_DECISION_INSTANCE`<br>`RESOURCE:*:DELETE_PROCESS` |
...
| Incident statistics for processes                                                                                         | `PROCESS_DEFINITION:{bpmnProcessId}:READ_PROCESS_DEFINITION`<br>`PROCESS_DEFINITION:{bpmnProcessId}:READ_PROCESS_INSTANCE` |
