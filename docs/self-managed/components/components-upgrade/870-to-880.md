...
2. In the `camunda/bin` directory, the `prefix-migration` script will execute the prefix migration, which can be executed locally.
   ...
   In both cases follow the configuration instructions for the secondary storage of your type and supply the respective values for Tasklist and Operate index prefixes.
