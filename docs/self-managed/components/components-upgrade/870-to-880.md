...
The default logging configuration is now available directly in the documentation for quick reference.  
See the [full logging documentation](../orchestration-cluster/core-settings/configuration/logging.md#default-logging-configuration) for details and advanced settings.
...
Use the correct variable for each component when enabling or customizing logging.

### Pattern layout changes

The default log pattern has changed as follows:
