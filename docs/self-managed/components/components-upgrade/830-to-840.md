...
description: "Review which adjustments must be made to update from Camunda 8.3.x to Camunda 8.4.0."
---
...
For more details, refer to the [Camunda Helm update instructions](/self-managed/installation-methods/helm/upgrade/index.md#v83).
:::
