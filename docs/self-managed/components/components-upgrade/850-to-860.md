...
title: Camunda update 8.5 to 8.6
...
Starting in version 8.6.0, Zeebe Gateway memory usage has increased due to the introduction of new features. While this enhances Gateway performance, it may require additional memory to operate optimally.

If you're using the default memory limit of `512Mi`, consider increasing it to at least `600Mi` to avoid performance issues.
