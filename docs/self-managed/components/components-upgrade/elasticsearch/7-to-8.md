...
description: "When updating from Elasticsearch 7 to Elasticsearch 8, follow the Elasticsearch migration guide. Refer to Camunda 8 supported environments when updating to..."
---
