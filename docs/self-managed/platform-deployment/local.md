...
The installation of Optimize is described in [Optimize Setup](../../optimize-deployment/setup/installation). A local setup in Camunda 8 is not yet supported out-of-the-box, use [Docker](../docker/#optimize) instead.