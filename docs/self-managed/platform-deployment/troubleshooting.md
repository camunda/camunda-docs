...
[Identity documentation](/docs/self-managed/identity/troubleshooting/troubleshoot-identity/#solution-2-identity-making-requests-from-an-external-ip-address).
