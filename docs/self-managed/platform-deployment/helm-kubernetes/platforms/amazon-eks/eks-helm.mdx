...
# The Ingress Helm Chart version
...
With the C8 Helm chart deployed, consider continuing your journey by [interacting with the zeebe-gateway](../../../../../zeebe-deployment/security/client-authorization/).
