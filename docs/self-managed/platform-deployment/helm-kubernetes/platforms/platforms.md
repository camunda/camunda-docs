...
In addition to [Upstream Kubernetes](https://kubernetes.io/) and [CNCF Certified Kubernetes distributions](https://www.cncf.io/training/certification/software-conformance/) (which could be deployed on cloud or on-premise), Camunda only officially tests the following platforms:
