...
**Zeebe**: Configure the [OpenSearch exporter](/self-managed/components/orchestration-cluster/zeebe-deployment/exporters/opensearch-exporter.md).
...
- **Zeebe Gateway** is deployed as a stateless service. We support [Kubernetes startup and liveness probes](/self-managed/components/orchestration-cluster/zeebe-deployment/configuration/gateway-health-probes.md) for Zeebe.
