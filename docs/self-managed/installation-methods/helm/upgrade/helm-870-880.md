...
The Process Migration app migrates from the old, separated indices in Elasticsearch or OpenSearch on 8.7 to the new unified indices on 8.8.
...
- Before upgrading, the 8.7 zeebe workers should already have some load and should NOT be idle. Otherwise the migration will fail.
  :::
