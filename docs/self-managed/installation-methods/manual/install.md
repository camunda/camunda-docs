...
The installation of Optimize is described in [Optimize Setup](/self-managed/components/optimize/install-and-start.md). A local setup in Camunda 8 is not yet supported out-of-the-box, use [Docker](/self-managed/installation-methods/docker/docker.md#optimize) instead.
