...
:::note
We tested the snapshot interval via a Zeebe Chaos experiment. Learn more about this testing and snapshot intervals in our [Zeebe Chaos blog](https://zeebe-io.github.io/zeebe-chaos/2022/02/01/High-Snapshot-Frequency/#snapshot-interval).
:::
