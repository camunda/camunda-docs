...
For the configuration properties used to assign identity providers to tenants, see [configuration reference](/self-managed/extend/tenancy/physical-tenants/configuration-reference.md).

For how operations are authorized at the cluster and tenant level, see [authorization model](/self-managed/extend/tenancy/physical-tenants/authorization-model.md).
...
For complete configuration examples, see [configuration reference](/self-managed/extend/tenancy/physical-tenants/configuration-reference.md).
