...
- [Physical Tenant isolation model](/self-managed/extend/tenancy/physical-tenants/isolation-model.md)
- [Provisioning and lifecycle](/self-managed/extend/tenancy/physical-tenants/provisioning-and-lifecycle.md)
- [Multi-tenancy overview](/self-managed/extend/tenancy/index.md)
