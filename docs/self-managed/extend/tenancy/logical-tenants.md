...
Logical Tenants are best for cost-efficient sub-division of teams or departments within the same organization. See [Multi-tenancy overview](/self-managed/extend/tenancy/index.md) to compare with other isolation models.
...
- Need stronger isolation? See [Physical Tenants](/self-managed/extend/tenancy/physical-tenants/index.md).
- Compare all models: [Multi-tenancy overview](/self-managed/extend/tenancy/index.md).
