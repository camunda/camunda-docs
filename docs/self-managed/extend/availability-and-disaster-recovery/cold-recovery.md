...
You must back up **both** Primary and Secondary storage layers for a complete Cold Recovery backup. See [backup and restore](/self-managed/manage/back-up-and-restore/index.md).
...
The RDBMS backup path is the **first phase** of new backup capabilities and currently covers a narrower set of components than the Elasticsearch/OpenSearch path. See [relational database backup](/self-managed/manage/back-up-and-restore/rdbms/backup.md) for the components it includes.
...
For provider-specific guidance, see [backup and restore](/self-managed/manage/back-up-and-restore/index.md).
...
For configuration instructions and scheduling guidance, see [backup and restore](/self-managed/manage/back-up-and-restore/index.md).
...
5. **Restore Camunda Orchestration cluster**: Follow the [restore procedure](/self-managed/manage/back-up-and-restore/index.md).
...
The total elapsed time across all these steps is the realized RTO. For step-by-step restore instructions, see [backup and restore](/self-managed/manage/back-up-and-restore/index.md).
...
- [Dual-Region](/self-managed/extend/availability-and-disaster-recovery/dual-region.md)
- [Backup and restore overview](/self-managed/manage/back-up-and-restore/index.md)
- [Zeebe backup management API](/self-managed/manage/back-up-and-restore/zeebe-backup-and-restore.md)
- [Elasticsearch backup](/self-managed/manage/back-up-and-restore/elasticsearch/backup.md)
- [Elasticsearch restore](/self-managed/manage/back-up-and-restore/elasticsearch/restore.md)
- [RDBMS backup](/self-managed/manage/back-up-and-restore/rdbms/backup.md)
- [RDBMS restore](/self-managed/manage/back-up-and-restore/rdbms/restore.md)
