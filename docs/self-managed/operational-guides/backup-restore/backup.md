...
This step uses the [management API](/self-managed/components/orchestration-cluster/zeebe-deployment/operations/management-api.md?exporting=softPause#exporting-api).
...
### 10. Resume exporting in Zeebe using the [management API](/self-managed/components/orchestration-cluster/zeebe-deployment/operations/management-api.md)
