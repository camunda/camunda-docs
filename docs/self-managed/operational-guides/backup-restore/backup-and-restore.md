...
| Configure component backup storage.                      | <p>Configure the backup storage for the components. This is also important for restoring a backup.</p><p><ul><li>[Operate](/self-managed/components/orchestration-cluster/operate-deployment/operate-configuration.md#backups)</li><li>[Optimize Elasticsearch](/self-managed/components/optimize/configuration/system-configuration.md#elasticsearch-backup-settings) / [Optimize OpenSearch](/self-managed/components/optimize/configuration/system-configuration.md#opensearch-backup-settings)</li><li>[Tasklist](/self-managed/components/orchestration-cluster/tasklist-deployment/tasklist-configuration.md#backups)</li><li>[Zeebe](/self-managed/components/orchestration-cluster/zeebe-deployment/configuration/broker.md#zeebebrokerdatabackup)</li></ul></p> |
...
| [Orchestration Cluster](/self-managed/components/orchestration-cluster/zeebe-deployment/configuration/gateway.md#managementserver) | 9600 |
