...
2. Confirm proper configuration (eg. shards, replicas count, etc.)
...
9. Wait until all components are restored to their respective backup ids (see [how to monitor a Camunda 8 cluster](./monitoring.md)).
