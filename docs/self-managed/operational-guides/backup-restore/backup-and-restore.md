...
:::info
The RDBMS backup path does **not** support Optimize. If you use Optimize, you must back up and restore Camunda components using the [Elasticsearch / OpenSearch path](#elasticsearch--opensearch).
:::
