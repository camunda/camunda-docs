...
export const esCards = [
  {
    link: "./backup/elasticsearch/es-backup#elasticsearch--opensearch-prerequisites",
    title: "Prerequisites",
    image: IconGear,
    description:
  ...
  {
    link: "./backup/elasticsearch/es-backup",
  ...
  {
    link: "./restore/elasticsearch/es-os-restore",
...
export const rdbmsCards = [
  {
    link: "./backup/rdbms/rdbms-backup#prerequisites",
    title: "Prerequisites",
    image: IconGear,
    description:
  ...
  {
    link: "./backup/rdbms/rdbms-backup",
    title: "Create a backup",
    image: IconCloud,
    description:
  ...
  {
    link: "./restore/rdbms/rdbms-restore",
    title: "Restore a backup",
    image: IconRepeat,
    description:
