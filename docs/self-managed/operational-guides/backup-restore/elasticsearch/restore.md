...
Assuming you're using the official [Camunda Helm chart](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/install/index.md), you'll have to adjust your Helm `values.yml` to supply the following temporarily.
