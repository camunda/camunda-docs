---
id: es-os-restore
title: "Restore Elasticsearch or OpenSearch snapshots"
sidebar_label: "Elasticsearch/OpenSearch snapshot restore"
...
Restore a previous snapshot of Elasticsearch or OpenSearch for Camunda components
...
| Snapshot repository | Elasticsearch or OpenSearch is configured to use the same snapshot repository as the backup. See [prerequisites](../../backup/elasticsearch/backup.md#prerequisites).                                                            |
...
After restoring the Elasticsearch/OpenSearch snapshots, restore Zeebe primary storage with [in-process restore](../in-process-restore.md). If in-process restore is not available for your Camunda version, use the [legacy restore application](./es-restore.md).
