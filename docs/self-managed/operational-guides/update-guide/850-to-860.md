...
In Camunda 8.6 the Spring-Zeebe community project was replaced by the [Spring Zeebe SDK](../../../apis-tools/camunda-spring-boot-sdk/getting-started.md).

As [testing support for the Camunda Spring Boot SDK](../../../apis-tools/camunda-spring-boot-sdk/getting-started.md#writing-test-cases) was only added with the 8.6.7 release, Camunda recommends you migrate directly to version 8.6.7 or later.
