...
- `ZEEBE_BROKER_EXPORTERS_ELASTICSEARCH_ARGS_EXPORTLEGACYRECORDS=true` for Elasticsearch
- `ZEEBE_BROKER_EXPORTERS_OPENSEARCH_ARGS_EXPORTLEGACYRECORDS=true` for OpenSearch
