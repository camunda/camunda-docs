...
description: "Review which adjustments must be made to upgrade from Camunda 8.7.x to Camunda 8.8.0."
---

The following sections explain which adjustments must be made to upgrade from Camunda 8.7.x to 8.8.x.
