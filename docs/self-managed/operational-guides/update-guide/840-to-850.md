...
Follow the [upgrade instructions](/self-managed/installation-methods/helm/upgrade/helm-840-850.md) to upgrade from Camunda Helm chart v9.x.x to Camunda Helm chart v10.x.x.
