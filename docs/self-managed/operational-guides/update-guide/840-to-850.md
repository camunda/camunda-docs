...
Carefully follow the [upgrade instructions](/self-managed/installation/guides/helm-kubernetes/upgrade.md#v1000) to upgrade from Camunda Helm chart v9.x.x to Camunda Helm chart v10.x.x.
