...
Updating may take longer as almost all the Operate data must be reindexed in Elasticsearch to add the `tenantId` field. To speed up data migration during version update
consider adding more resources to Elasticsearch cluster.
