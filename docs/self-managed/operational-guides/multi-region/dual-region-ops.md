...
- `cURL` or similar to interact with the [Camunda 8 REST API](/apis-tools/orchestration-cluster-api-rest/camunda-api-rest-overview.md).
...
1. Use the [Camunda 8 REST API](../../../apis-tools/orchestration-cluster-api-rest/camunda-api-rest-overview.md) to retrieve the list of the remaining brokers
