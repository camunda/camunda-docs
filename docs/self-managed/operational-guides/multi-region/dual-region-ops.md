...
- `cURL` or similar to interact with the [Orchestration Cluster REST API](/apis-tools/camunda-api-rest/camunda-api-rest-overview.md).
...
1. Use the [Orchestration Cluster REST API](../../../apis-tools/camunda-api-rest/camunda-api-rest-overview.md) to retrieve the list of the remaining brokers
