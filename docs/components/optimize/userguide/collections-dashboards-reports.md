...
description: "Optimize uses a single visualization for reports, and dashboards combine these visualizations, akin to a spreadsheet or a set of comparative charts."
---
