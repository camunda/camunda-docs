...
| [Email Inbound](/components/connectors/out-of-the-box-connectors/email-inbound.md) and [Email Outbound](/components/connectors/out-of-the-box-connectors/email-outbound.md) | Supports sending Camunda documents as attachments, or storing incoming attachments as Camunda documents. These documents are automatically stored in the Camunda document store and available to map in the result expression. |
