...
attribute on the `decision` element. It can be changed via the properties panel on the right side of the screen under the **Deploy** button after selecting the respective
