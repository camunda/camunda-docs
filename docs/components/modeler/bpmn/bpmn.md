...
[Camunda Hub](/components/hub/workspace/modeler/index.md) and Desktop Modeler both offer a similar core BPMN 2.0 Modeling experience:
...
Using BPMN in Hub or Desktop Modeler, you can create more BPMN 2.0 elements like task types and event definitions.
