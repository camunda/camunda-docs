...
id: signal-events
title: "Signal events"
description: "Signal events are events which reference a signal.Broadcasting a signal will trigger _all_ signal events matching the name of the broadcasted signal."
---
