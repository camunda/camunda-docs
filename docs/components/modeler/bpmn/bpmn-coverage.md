...
The following BPMN elements are supported by our modeling tools. Elements highlighted in <Highlight color="#11c399">green</Highlight> are supported for execution by the Camunda 8. Click on an element to navigate to the documentation.
