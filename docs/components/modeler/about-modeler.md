...
- [Out-of-the-box Connectors](/guides/implementing-connectors.md) - Out-of-the-box Connectors provide prebuilt connectivity with a number of outside systems to accelerate automation across those systems.
- [Custom Connectors](/components/integration-framework/connectors/custom-built-connectors/connector-templates.md) - Orchestrate your service landscape with custom Connectors, the building blocks to scale your business process modeling.
