...
| Clusters requiring basic authentication                           | Clusters that require basic authentication are not currently supported. You must use another value from the list of [available authentication methods](../../../../self-managed/modeler/web-modeler/configuration/configuration.md#available-authentication-methods) for compatibility. |
