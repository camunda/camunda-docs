...
description: "You can import a BPMN or DMN diagram into Web Modeler using several methods: - In a project, click New > Upload files and select the files from your computer."
---
