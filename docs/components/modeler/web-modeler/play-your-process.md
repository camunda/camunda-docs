...
- While you can still interact with your process instance in Play—such as completing jobs or publishing messages—you may be unable to resolve incidents if they occur beyond the 100th flow node instance, as Play does not track them. In this case, incident resolution can be managed in Operate.
- Play doesn't support call activities with feel expressions
