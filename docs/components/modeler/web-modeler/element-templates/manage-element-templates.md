...
To create a new element template, follow the steps described in [Generate an element template](./element-template-generator.md#generate-a-connector-template).
