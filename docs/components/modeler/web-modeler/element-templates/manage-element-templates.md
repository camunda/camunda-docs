...
description: "export const UploadIcon = () => <span style={{verticalAlign: 'text-top'}}><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='16'."
text-top"}}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16"..."
---
