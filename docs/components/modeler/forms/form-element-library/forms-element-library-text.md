...
title: Text view
description: "A Markdown-powered text component allowing to display simple information to the user.- Text: Either an expression, plain text, or templating syntax."
---
