---
id: using-hub-and-desktop-modeler-together
...
- Camunda Hub only supports defining one template per file. When you [publish an element template](/components/hub/workspace/modeler/element-templates/manage-element-templates.md#publish-an-element-template), you must update the version.
  :::
