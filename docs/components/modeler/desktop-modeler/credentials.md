...
:::note
This page covers credentials that authenticate connector tasks, such as an AWS Credential. It is unrelated to the connection credentials (client ID and client secret) you enter to [connect Desktop Modeler to Camunda](./connect-to-camunda-8.md), which authenticate Desktop Modeler itself.
:::
