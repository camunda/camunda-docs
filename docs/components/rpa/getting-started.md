...
1. **Download Camunda Modeler**: Download the latest version of Camunda Modeler from the [Camunda website](https://camunda.com/download/modeler/). Because RPA scripts run locally, we recommend testing using the [Desktop Modeler](../../modeler/desktop-modeler/).
