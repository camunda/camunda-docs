...
You can get started developing and testing your scripts locally without a Camunda connection using [Desktop Modeler](../modeler/desktop-modeler/index.md), or use [Web Modeler](../modeler/web-modeler/launch-web-modeler.md) if you already have a Camunda instance available.
