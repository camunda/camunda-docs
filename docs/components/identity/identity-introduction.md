...
| [Global user task listeners](global-user-task-listener.md) | Cluster-wide listeners that react to user task lifecycle events across all processes without modifying BPMN models.                 | Self-Managed only |
