...
To follow the steps in this guide, you must be [authorized to update batch operations](https://docs.camunda.io/docs/next/components/operate/userguide/access-control/#optional-authorizations).
