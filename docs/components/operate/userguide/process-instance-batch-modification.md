...
1. On the **Processes** page, in the **Filter** panel, select the **Name** and **Version** of the process you want to modify. For detailed guidance on filtering, see [filter process instances](./filter-process-instances.md).
