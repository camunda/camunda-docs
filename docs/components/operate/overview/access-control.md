...
| View `USER_TASKS` operations for instances of a specific process definition.                          | `Process Definition`               | A process definition ID or `*` for all process definitions.                        | `READ_USER_TASK`                                                                                                                           |
