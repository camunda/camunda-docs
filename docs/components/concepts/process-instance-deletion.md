...
The Zeebe engine queries [secondary storage](/self-managed/manage/databases/secondary-storage/index.md) for process instances to delete. For each instance found, the engine writes a delete command to the log, which results in a deleted event.
