...
:::note
This page provides a conceptual overview of multi-tenancy. For detailed configuration and implementation in Self-Managed deployments, see [Multi-tenancy in Self-Managed](/self-managed/concepts/multi-tenancy/multi-tenancy-overview.md).
:::
...
For details on configuring and using multi-tenancy in your Self-Managed deployment, see [Multi-tenancy](/self-managed/concepts/multi-tenancy/multi-tenancy-overview.md).
