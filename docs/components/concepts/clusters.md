...
Free Trial `dev` (or untagged) clusters are automatically paused 8 hours after the creation of the cluster or since you last resumed the paused cluster. Auto-pause occurs regardless of cluster usage.
