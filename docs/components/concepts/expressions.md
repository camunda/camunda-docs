...
- Sequence flow on an exclusive gateway: [condition](/components/modeler/bpmn/bpmn-processes/exclusive-gateways/exclusive-gateways.md#conditions)
- Message catch event/receive task: [correlation key](/components/modeler/bpmn/bpmn-processes/message-events/message-events.md#messages)
- Multi-instance activity: [input collection](/components/modeler/bpmn/bpmn-processes/multi-instance/multi-instance.md#defining-the-collection-to-iterate-over), [output element](/components/modeler/bpmn/bpmn-processes/multi-instance/multi-instance.md#collecting-the-output)
...
- Timer catch event: [timer definition](/components/modeler/bpmn/bpmn-processes/timer-events/timer-events.md#timers)
- Message catch event/receive task: [message name](/components/modeler/bpmn/bpmn-processes/message-events/message-events.md#messages)
- Service task: [job type](/components/modeler/bpmn/bpmn-processes/service-tasks/service-tasks.md#task-definition), [job retries](/components/modeler/bpmn/bpmn-processes/service-tasks/service-tasks.md#task-definition)
- Call activity: [process id](/components/modeler/bpmn/bpmn-processes/call-activities/call-activities.md#defining-the-called-process)
