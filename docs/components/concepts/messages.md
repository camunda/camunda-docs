...
id: messages
title: "Messages"
description: "Process instances can respond to incoming messages. Published messages must be mapped onto a process instance. This step is called message correlation."
---
