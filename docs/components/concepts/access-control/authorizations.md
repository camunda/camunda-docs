...
| ------------------------------------ | -------------------------------------- | -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Application**                      | `*`, `operate`, `tasklist`, `identity` | Application name                                   | `ACCESS`                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| **Mapping Rule**                     | `*`, `my_mapping`                      | All mapping rules / Mapping Rule ID                | `CREATE`, `READ`, `UPDATE`, `DELETE`                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| **Resource**                         | `*`, `my_form`, `order_process`        | All resources / Form ID / BPMN Process ID / DRD ID | `CREATE`, `DELETE_DRD`, `DELETE_FORM`, `DELETE_PROCESS`, `DELETE_RESOURCE`                                                                                                                                                                                                                                                                                                                                                                 |
