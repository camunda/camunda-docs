...
You can also use integrations in certain programming frameworks, like the [Camunda Spring Boot SDK](../../../apis-tools/camunda-spring-boot-sdk/getting-started.md) in the Java world, which starts the job worker and implements the subscription automatically in the background for your glue code.
