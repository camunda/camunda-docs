...
- The Camunda Spring Boot SDK only offers test support since 8.6.7 and later releases.
...
2. Use the [Camunda Spring Boot SDK and its test library](../../../apis-tools/camunda-spring-boot-sdk/getting-started.md).
