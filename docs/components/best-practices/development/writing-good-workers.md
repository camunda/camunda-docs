...
The [Camunda Spring Boot SDK](/apis-tools/camunda-spring-boot-sdk/getting-started.md) provides a more elegant way of writing this, but also uses a normal worker from the Java client underneath. In this case, your code might look like this:
...
In the Camunda Spring Boot SDK, you can do this using a [configuration](/apis-tools/camunda-spring-boot-sdk/configuration.md#execution-threads).
