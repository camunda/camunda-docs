...
tags:
  - BPMN
description: "Document patterns that share common characteristics and find a satisfying solution for modeling them. When modeling, you will sometimes realize that some sit..."
---
