...
tags:
  ...
  - Webapps
  - Web applications
description: "Configure CSRF protection for your Camunda instance."
---
...
`camunda.security.csrf.enabled: true  # Set to 'false' to disable CSRF protection`

**Environment variable:**  
`CAMUNDA_SECURITY_CSRF_ENABLED=true  # Set to false to disable CSRF protection`
