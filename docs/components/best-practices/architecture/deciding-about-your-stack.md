...
Discover more in our [getting started guide for microservices orchestration](/guides/getting-started-orchestrate-microservices.md) or the [Camunda Spring Boot SDK instructions](../../../apis-tools/camunda-spring-boot-sdk/getting-started.md).
...
Integrate the [Camunda Spring Boot SDK](../../../apis-tools/camunda-spring-boot-sdk/getting-started.md) into the Spring Boot project by adding necessary dependencies to the project’s `pom.xml` file, and configure the application to use Camunda services.
