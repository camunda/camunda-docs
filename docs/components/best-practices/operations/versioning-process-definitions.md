...
:::caution Camunda Platform 8
With Camunda Platform 8 you cannot yet influence the version of the started process instance via the call activity. This feature is on the roadmap. At the moment, [a new process instance of the latest process definition version is started](/docs/bpmn-dmn/bpmn/call-activities/).
:::
