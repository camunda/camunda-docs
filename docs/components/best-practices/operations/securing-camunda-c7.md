...
This best practice targets Camunda Platform 7.x only! For Camunda Cloud please visit [Zeebe Security](/docs/self-managed/zeebe-deployment/security/) instead.
:::
