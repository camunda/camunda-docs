...
Camunda provides example Grafana dashboards in a public [GitHub repository](https://github.com/camunda/camunda-observability) that you can use to explore and visualize Cluster Metrics.
