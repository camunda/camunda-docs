...
Auto-updates can be enabled during [cluster creation](/components/hub/organization/manage-clusters/create-cluster.md) or in the **Settings** tab. Depending on your [role](/components/hub/organization/manage-users/manage-users.md), this may appear grayed out in the **Settings** tab.
