...
We have two specific Upgrade Guides in place written for operators of [Self-Managed Installations](../self-managed/update/index.md) and developers using [APIs and our SDKs](../apis-tools/migration-manuals/index.md).
