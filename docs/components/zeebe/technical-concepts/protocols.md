...
Note that while gRPC requires HTTP/2, the [Orchestration Cluster REST API](/apis-tools/camunda-api-rest/camunda-api-rest-overview.md) can work with either HTTP/1.1 or HTTP/2.
