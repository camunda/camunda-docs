...
Note that while gRPC requires HTTP/2, the [Camunda 8 REST API](/apis-tools/orchestration-cluster-api-rest/camunda-api-rest-overview.md) can work with either HTTP/1.1 or HTTP/2.
