...
To reach a well-distributed leadership again the [Rebalancing API](../../../self-managed/zeebe-deployment/operations/rebalancing.md) can be used. Be aware that this is on best effort basis.
:::
