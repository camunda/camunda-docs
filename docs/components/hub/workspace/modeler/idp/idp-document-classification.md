...
1. Click **Publish** and select either:
   ...
   - **Publish to organization**: The document extraction template is made available as a shared resource within your organization. This option is only available for Organization Owners or Organization Admins.
