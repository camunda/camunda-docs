...
Projects contain process applications. Process applications contain files and folders.
...
Use folders to semantically group and organize your diagrams within a process application. User access to a folder is inherited from the project.
