...
- **Organization Admin**: Manages the organization, its members, and its workspaces. Acts as the organization's super-user, with full access to every workspace and project — no separate super-user mode needs to be enabled. _Formerly the **Admin** role._
