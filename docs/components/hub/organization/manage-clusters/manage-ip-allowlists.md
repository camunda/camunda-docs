...
:::info Camunda Hub access
In Camunda SaaS, Camunda Hub has access to clusters by default, as allowlist assignments for IP addresses used by Camunda Hub are managed automatically.
:::
