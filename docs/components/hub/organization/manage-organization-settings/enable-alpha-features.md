...
description: "Learn how admin users can manage access to alpha features in Camunda Hub."
...
Customers in other subscriptions can still turn on/off these settings directly from Camunda Hub.  
:::
...
Admins can know when someone accepts the alpha terms and when features are enabled or disabled under the [**Activity** tab}(./view-organization-activity.md).

### Enable AI-powered features

To use AI-powered alpha features, you must agree to the **Terms for AI Usage** before the toggle will appear in the **Status** column:
