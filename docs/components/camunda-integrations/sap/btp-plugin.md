...
description: "The Camunda SAP Business Technology Platform (BTP) plugin is an artifact run on BTP. It consists of a UI5 app, a CAP service layer and backend (using..."
---
