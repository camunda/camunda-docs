...
- If notifications are not shown, check Microsoft Teams notifications are enabled, and verify that the relevant [notification rules](./ms-teams-notifications.md) are configured for the channel or personal chat.
