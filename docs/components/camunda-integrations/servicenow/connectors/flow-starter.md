...
:::tip
Store ServiceNow credentials securely as [SaaS-managed secrets](/components/hub/organization/manage-clusters/manage-secrets.md) and reference them in the connector configuration (e.g., `{{secrets.snUser}}`).
:::
