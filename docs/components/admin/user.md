...
In a SaaS environment, user management is handled through [Camunda Hub](/components/console/manage-organization/manage-users.md). From Camunda Hub, you can invite new users to your organization and manage their roles. For more advanced user management, you can configure [single sign-on (SSO)](/components/console/manage-organization/external-sso.md) to integrate with your own identity provider.
