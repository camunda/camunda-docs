...
| List resource templates | Retrieves a list of available resource templates on the MCP server.<br/>These are similar to resources, but include a set of parameters for dynamic resource access. | No additional configuration required.                                                                               |
