...
To do this, design [user task forms](/components/hub/workspace/modeler/modeling/utilize-forms.md) in the local language, and set the Tasklist interface to use the same language.
