...
In Camunda 8 SaaS, Tasklist V2 mode is enabled by default in version 8.8 and later. You cannot change this setting in Camunda Hub for SaaS clusters. To revert to Tasklist V1 mode, contact [Camunda support](https://camunda.com/services/support/), who can update the cluster configuration for you.
