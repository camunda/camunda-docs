...
:::note
When using JVM properties, to ensure Camunda can properly access Camunda components, non-proxy hosts must contain `camunda-platform-zeebe|camunda-platform-keycloak`.
:::
