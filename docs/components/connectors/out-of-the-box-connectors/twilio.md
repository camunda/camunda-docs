...
:::note
Use SaaS-managed secrets to store your account SID and auth token so you don't expose sensitive information directly from the process. See [managing secrets](https://docs.camunda.org/manual/latest/user-guide/process-engine/secrets/) to learn more.
:::
...
:::note
Use SaaS-managed secrets to store your credentials securely. Refer to the [SaaS-managed secrets documentation](/components/hub/organization/manage-clusters/manage-secrets.md) for more details.
:::
