...
Select **Bearer token** in the **Type** dropdown in the **Authentication** section and enter your bearer token value. Use [SaaS-managed secrets](/components/hub/organization/manage-clusters/manage-secrets.md) to avoid exposing sensitive credentials.
...
Store your credentials securely using [SaaS-managed secrets](/components/hub/organization/manage-clusters/manage-secrets.md).
