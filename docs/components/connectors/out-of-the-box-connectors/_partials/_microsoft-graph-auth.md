...
Select **Bearer token** in the **Type** dropdown in the **Authentication** section and enter your bearer token value. Use [secrets](/components/connectors/use-connectors/index.md#using-secrets) to avoid exposing sensitive credentials.
...
Store your credentials securely using [secrets](/components/connectors/use-connectors/index.md#using-secrets).
