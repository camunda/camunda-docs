...
If you are using Camunda 8 Self-Managed, you can only authenticate using [Identity](/self-managed/components/operate-deployment/operate-authentication.md#identity).
:::
...
- [Authentication with a Self-Managed Operate deployment](/self-managed/components/operate-deployment/operate-authentication.md#identity)
