...
| `MIGRATION_MISSING_TOOLS`                    | Tools referenced by the AI Agent were removed after a process instance migration. Removing or renaming tools is not supported. See [process instance migrations](../../../agentic-ai-aiagent.md#process-instance-migrations) for details.                  |
| `MIGRATION_GATEWAY_TOOL_DEFINITIONS_CHANGED` | Gateway tool definitions have changed after a process instance migration. Adding or removing gateway tools to a running agent is not supported. See [process instance migrations](../../../agentic-ai-aiagent.md#process-instance-migrations) for details. |
