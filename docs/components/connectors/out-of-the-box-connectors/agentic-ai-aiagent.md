...
| Storage Type        | No       | <p>Select where to store the conversation memory:</p><p><ul><li><p>**Process Variable**: Stores conversation memory as process variables (default). Suitable for shorter conversations.</p></li><li><p>**Document Storage**: Stores conversation memory as Camunda documents. Suitable for longer conversations that might exceed process variable limits.</p></li></ul></p>                                                                                                                                       |
...
| Document TTL        | No       | <p>When using Document Storage, specify the time-to-live (TTL) for stored conversation documents in ISO 8601 duration format.</p><p><ul><li><p>Default TTL is 30 days if not specified.</p></li><li><p>Example: `P30D` for 30 days, `P7D` for 7 days, `PT1H` for 1 hour.</p></li><li><p>Only appears when Storage Type is set to Document Storage.</p></li></ul></p>                                                                                                                                               |
