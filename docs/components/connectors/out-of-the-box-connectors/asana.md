...
:::note
Use SaaS-managed secrets to avoid exposing your Asana personal access token as plain text. Refer to our documentation on [managing secrets](/components/hub/organization/manage-clusters/manage-secrets.md) to learn more.
:::
