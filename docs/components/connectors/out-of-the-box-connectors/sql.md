...
To avoid exposing your sensitive data as plain text, use SaaS-managed secrets. Follow our documentation on [managing secrets](/components/hub/organization/manage-clusters/manage-secrets.md) to learn more.
