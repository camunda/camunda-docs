...
1. Download and extract the latest [Camunda 8 Run](/self-managed/quickstart/developer/c8run/index.md) release (at
...
3. Edit `connectors-application.properties` and add the following line to include your custom config file:
   ...
   ```
4. [Start Camunda 8 Run](/self-managed/quickstart/developer/c8run/install-start.md#install-and-start-camunda-8-run).
