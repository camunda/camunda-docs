...
description: "The GitLab connector is an outbound connector that allows you to connect your BPMN service with GitLab to manage GitLab issues and releases."
---
