...
:::note
We do not recommend exposing your AWS IAM credentials as plain text and instead use Camunda secrets. Refer to [manage secrets](components/console/manage-clusters/manage-secrets.md) to learn more.
:::
