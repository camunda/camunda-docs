...
:::note
Use secrets to avoid exposing your AWS IAM credentials as plain text. Refer to [managing secrets](components/hub/organization/manage-clusters/manage-secrets.md) to learn more.
:::
