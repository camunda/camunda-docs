...
1. Open the AI Agent Task or AI Agent Sub-process element in [Camunda Hub](/components/hub/workspace/modeler/index.md) or [Desktop Modeler](/components/modeler/desktop-modeler/index.md). Set the process' modeler/execution version to Camunda 8.10 or later. This makes the new element template available to select. If you use Desktop Modeler, upgrade to version 5.51.0 or later first. Earlier versions can't parse the `zeebe:agentDefinition` extension element that the new templates use, and show the template status **Not found** instead. See the [Desktop Modeler changelog](https://github.com/camunda/camunda-modeler/blob/master/CHANGELOG.md#5510) for release details.
