...
When **Document location** is **Uploaded document**, a **Document source** dropdown selects where that document comes from. Select one of the following options, then complete the field it reveals:

| Document source      | Reveals field        | Description                                                                                                                        |
| :------------------- | :------------------- | :--------------------------------------------------------------------------------------------------------------------------------- |
| **Camunda Document** | **Camunda document** | Reference a document in the Camunda document store, by FEEL expression. Only PNG and JPEG are supported, real-time execution only. |
