...
:::note
To work with document you must upload them first, [using the Camunda 8 REST API](/apis-tools/orchestration-cluster-api-rest/specifications/create-document.api.mdx) for example.
