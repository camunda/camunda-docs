...
:::note
To work with document you must upload them first, [using the Orchestration Cluster REST API](/apis-tools/camunda-api-rest/specifications/create-document.api.mdx) for example.
