...
- [Amazon SageMaker Connector](/components/connectors/out-of-the-box-connectors/amazon-eventbridge.md) - Interact with [AWS SageMaker service](https://aws.amazon.com/sagemaker/) from your BPMN process.
