...
description: "The Google Sheets connector is an outbound connector that allows you to work with an existing or new spreadsheet on Google Drive from your BPMN process."
---
