...
The **EasyPost Connector** allows you to create addresses, parcels, and shipments, as well as purchase and verify shipments with [EasyPost Service](https://www.easypost.com/) from your BPMN process to create addresses, parcels, and shipments, as well as purchase and verify shipments.
