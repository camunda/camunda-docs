...
Additionally, the [Camunda Marketplace](/components/modeler/web-modeler/modeling/camunda-marketplace.md) provides connectors by Camunda partners and community contributors.
...
You can develop connector templates using the [`element template` feature](/components/modeler/element-templates/create/defining-templates.md). You can also look at existing [examples](https://github.com/camunda/camunda-modeler/blob/master/resources/element-templates/cloud-samples.json).
