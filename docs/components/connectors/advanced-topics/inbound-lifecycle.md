...
However, in general, one executable can be reused for multiple inbound connector elements in the diagram. See [Deduplication](deduplication) to learn more.
...
- [Search process definitions](/apis-tools/orchestration-cluster-api-rest/specifications/search-process-definitions)
- [Search message subscriptions](/apis-tools/orchestration-cluster-api-rest/specifications/search-message-subscriptions)
