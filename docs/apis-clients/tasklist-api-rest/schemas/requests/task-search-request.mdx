...
> (renamed equivalent of [`TaskQuery.processDefinitionId`](docs/apis-clients/tasklist-api/inputs/task-query.mdx#code-style-fontweight-normal-taskquerybprocessdefinitionidbcodestring-) field).

#### [<code style={{ fontWeight: 'normal' }}>TaskSearchRequest.<b>processInstanceKey</b></code>](#)<Bullet />`string`

> Reference to process instance
> (renamed equivalent of [`TaskQuery.processInstanceId`](docs/apis-clients/tasklist-api/inputs/task-query.mdx#code-style-fontweight-normal-taskquerybprocessinstanceidbcodestring-) field).
