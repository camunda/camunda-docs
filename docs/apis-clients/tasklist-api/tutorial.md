...
- [A cluster on Camunda Platform 8](../../../components/cloud-console/manage-clusters/create-cluster)
- [A set of API credentials; remember to check the Tasklist option when creating them](../../../components/cloud-console/manage-clusters/manage-api-clients). Don't forget to save these, we'll need them later.
