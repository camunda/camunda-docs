...
For **root process instances** and **decision instances**, follow the steps provided in the [Operate guide](/self-managed/components/orchestration-cluster/operate-deployment/usage-metrics.md).
