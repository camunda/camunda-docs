...
| **SaaS**              | Both contractual and optional telemetry are enabled by default, and there is no self-service control to disable optional telemetry. To disable telemetry, contact your Camunda account team (CSM/TAM).                                            |
