...
:::note
Some 8.8 features was originally released with [8.7 alphas](./880.md#870), but are now available in 8.8.0-alpha1. For more information, see the Camunda 8.7 and 8.8 [release update blog](https://camunda.com/blog/2025/01/camunda-87-88-release-update/).
:::
