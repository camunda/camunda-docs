...
For more information, see the [Camunda Exporter documentation](/self-managed/zeebe-deployment/exporters/camunda-exporter.md).

### Backup and restore changes <span class="badge badge--long" title="This feature affects Self-Managed">Self-Managed</span>

Camunda backups have been overhauled and made easier. The web application backups are merged together under one endpoint.
