...
:::note
This feature was originally released with [8.7.0-alpha2](./880.md#870-alpha2), but is now available in 8.8.0-alpha1. For more information, see the Camunda 8.7 and 8.8 [release update blog](https://camunda.com/blog/2025/01/camunda-87-88-release-update/).
:::
