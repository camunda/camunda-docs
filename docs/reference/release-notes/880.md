...
Camunda now provides a Spring Boot SDK for the Camunda 8 REST API, unifying process management, user tasks, and identity features under one dedicated starter. This simplifies the interaction between a Spring Boot application and Camunda 8, and allows you to:
