...
### BPMN Copilot now supports diagram-to-text
...
This release introduces a real-time cluster capacity metric and enhanced documentation with clear best practices for monitoring and scaling your Camunda Platform 8 clusters—empowering proactive measures, reducing downtime risk, and ensuring consistent performance.
