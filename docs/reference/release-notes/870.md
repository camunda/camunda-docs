...
The new outbound Box connector allows you to interact with your [Box.com](https://www.box.com/) account content.
...
- Delete Folder: Delete folders from Box.
...
- The Document store API now supports uploading files in batches.
...
### Support Ad-Hoc Subprocess BPMN Pattern <span class="badge badge--long" title="This feature affects SaaS">SaaS</span><span class="badge badge--long" title="This feature affects Self-Managed">Self-Managed</span><span class="badge badge--medium" title="This feature affects Modeler">Modeler</span>
...
### Task Listeners for Assigning and Completing Events <span class="badge badge--long" title="This feature affects SaaS">SaaS</span><span class="badge badge--long" title="This feature affects Self-Managed">Self-Managed</span><span class="badge badge--medium" title="This feature affects Modeler">Modeler</span><span class="badge badge--medium" title="This feature affects Operate">Operate</span>

Task lifecycle management is enhanced with Task Listeners, enabling users to react more effectively to various task lifecycle events.
...
- Operations engineers can easily check details of active and completed task listeners within instances, as well as efficiently resolve task listener incidents.
...
The predefined development stage cluster for the process application is also used when launching Play. This feature was already available in SaaS and is now also made available for self-managed as part of unifying the deployment experience.
