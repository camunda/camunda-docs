...
You can now create SaaS automation clusters in a new Singapore (asia-southeast1) region.

Use this region if you:

- Operate in Singapore and Southeast Asian (SEA) countries, to improve overall processing speed and reduce latency.
- Require cluster data to remain within Singapore to support your local data residency and compliance needs.
