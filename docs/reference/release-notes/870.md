...
Play now offers multi-tenancy, enabling you to have an isolated, dedicated testing environment without additional costs. This feature is available for Web Modeler in Self-Managed environments.
...
Web Modeler now supports stronger governance and change control. This ensure safe production deployment for processes with low to medium complexity and criticality. The following capabilities are now available:
