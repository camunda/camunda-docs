...
### Ad-hoc subprocess BPMN pattern support <span class="badge badge--long" title="This feature affects SaaS">SaaS</span><span class="badge badge--long" title="This feature affects Self-Managed">Self-Managed</span>

The ad-hoc subprocess BPMN element is now supported.

- This new kind of subprocess allows more flexible process flows with a compact visual representation.
- It is the first step towards dynamic processes and execution of ad-hoc activities.

:::note
This release only supports manual deployment of the element to the engine via XML. Modeler support for this element is planned for the next alpha release.
:::
...
To learn more about this Connector, see [Box Connector](/docs/components/connectors/out-of-the-box-connectors/box.md).
...
To learn more about this feature, see [Scenarios](/docs/components/modeler/web-modeler/play-your-process.md#scenarios).
