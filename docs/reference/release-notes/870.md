...
| :-------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------- |
| 14 January 2025 | <ul><li>[ Camunda 8 core ](https://github.com/camunda/camunda/releases/tag/8.7.0-alpha4)</li><li>[ Connectors ](https://github.com/camunda/connectors/releases/tag/8.7.0-alpha4)</li></ul> | [Release blog](https://camunda.com/blog/2025/01/camunda-alpha-release-february-2025) |
...
The document extraction UI allows users to configure projects for structured (form extraction) and unstructured (LLM extraction) data.

- Users can define the taxonomy, test cases, and choose models for LLM-based extraction.
- Form-based extraction is available for capturing value pairs from structured documents.
- Projects can be published and shared across the organization, making the extraction capabilities widely accessible.

### BPMN Copilot <span class="badge badge--long" title="This feature affects SaaS">SaaS</span>

Thanks to Camunda's integrated BPMN Copilot for SaaS, anybody can go from 0 to 80% of a process diagram in minutes. Users can generate process diagrams from natural language descriptions, then collaborate on it with their colleagues. The text interface means that even BPMN novices can make meaningful, accurate diagrams.

### Ad-hoc subprocesses

The new Camunda version supports a new BPMN element: [the ad-hoc subprocess](/components/modeler/bpmn/ad-hoc/ad-hoc.md). This new kind of subprocess allows more flexible process flows with a compact visual representation. It is the first step towards dynamic processes and execution of ad-hoc activities.

### BPMN Copilot available as an NPM package

<!-- https://github.com/camunda/product-hub/issues/2607 -->
