...
Due to key architecture refactoring and improvements, this [alpha release](/reference/release-policy.md) contains the following known issue that will be resolved in a future release.

**Issue:** Self-Managed customers using the 8.7.0-alpha2 Helm Chart cannot login to Operate. To mitigate this issue, you can...
