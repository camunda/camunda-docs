...
Due to key architecture improvements and refactoring, this alpha release contains known issues that will be resolved in the upcoming releases.

- Self-Managed customers using the 8.7.0-alpha2 Helm Chart cannot login to Operate. To mitigate this issue, you can...
