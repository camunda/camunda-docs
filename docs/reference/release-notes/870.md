...
| :--------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------ |
| 11 February 2025 | <!-- <ul><li>[ Camunda 8 core ](https://github.com/camunda/camunda/releases/tag/8.7.0-alpha4)</li><li>[ Connectors ](https://github.com/camunda/connectors/releases/tag/8.7.0-alpha4)</li></ul> --> | <!-- [Release blog](https://camunda.com/blog/2025/02/camunda-alpha-release-march-2025/) --> |

### Play multi-tenancy <span class="badge badge--long" title="This feature affects Self-Managed">Self-Managed</span>

Play now offers isolation so you can have a dedicated manual testing environment without additional costs. This is available for all Web Modeler Self-Managed environments.

<!-- https://github.com/camunda/product-hub/issues/2653 -->

### Process landscape visualization

The process landscape solution provides a comprehensive, hierarchical view of all related processes. This release enables automation leads to:
...
For more information, see the [process landscape visualization](/components/modeler/web-modeler/process-landscape-visualization.md) documentation.

<!-- https://github.com/camunda/product-hub/issues/2432 -->

### Web Modeler governance and change control

Web Modeler now supports stronger governance and change control to ensure safe production deployments for processes with low to medium complexity and criticality. The following capabilities are now available:
...
For more information, see the [process governance](/docs/components/modeler/web-modeler/process-application-pipeline.md) documentation.

<!-- https://github.com/camunda/product-hub/issues/2583 -->

### BPMN-to-text in BPMN Copilot
...
### Advanced configuration options for Camunda 8 Run

Camunda 8 Run now supports additional advanced configuration options, including a Docker deployment, metrics access, and TLS certificates. For more information, see the [Camunda 8 Run documentation](/docs/self-managed/setup/deploy/local/c8run.md).

<!-- https://github.com/camunda/product-hub/issues/2459 -->

### Health and capacity monitoring for clusters in Console

This release introduces a real-time cluster capacity metric for monitoring and scaling your Camunda Platform 8 clusters.
...
Camunda 8 SaaS now supports Amazon Web Services (AWS) deployments. When [creating a new cluster](/components/console/manage-clusters/create-cluster.md), you can select from the following new AWS regions:
...
| Release date  | Changelog(s)                                                                                                                                                                               | Blog                                                                                  |
| :------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------ |
| 11 March 2025 | <ul><li>[ Camunda 8 core ](https://github.com/camunda/camunda/releases/tag/8.7.0-alpha5)</li><li>[ Connectors ](https://github.com/camunda/connectors/releases/tag/8.7.0-alpha5)</li></ul> | [Release blog](https://camunda.com/blog/2025/02/camunda-alpha-release-february-2025/) |
