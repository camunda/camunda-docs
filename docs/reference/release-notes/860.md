...
You can now enable the automatic fetching of Camunda 8 Connector templates in the Desktop Modeler, ensuring you always have the latest templates at your disposal. This feature enhances workflow efficiency and reduces setup time. To enable it, simply set the enable-connector-templates flag as detailed [here](#). <!-- Via https://github.com/camunda/camunda-docs/pull/4053 -->
