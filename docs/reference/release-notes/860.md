...
With Camunda 8 REST API for Process Management, we will move the Go and zbctl clients to the Camunda Community Hub. This means that these clients won’t be officially supported by Camunda anymore.
