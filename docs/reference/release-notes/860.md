...
You can now [enable TLS-encrypted communication](/self-managed/modeler/web-modeler/configuration/ssl.md) between the Web Modeler webapp, REST API, and websocket components.

### API orchestration getting started journey

<!-- https://github.com/camunda/product-hub/issues/2348 -->

New platform users interested in orchestrating API endpoints now have a high-level in-product explanation of Camunda's connectors functionality.

### Remove "Cloud" as a user-facing term

<!-- https://github.com/camunda/product-hub/issues/1989 -->

"Cloud" has been removed from the URLs in SaaS versions of Modeler and Console for simpler readability.
