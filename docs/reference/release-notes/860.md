...
The Modeler now makes templates for pre-built Camunda 8 connectors available for use in BPMN diagrams. This ensures you can easily connect to a growing list of services and protocols, out of the box.
