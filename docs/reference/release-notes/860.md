...
### Migrate process management endpoints to Camunda 8 REST API
...
### Investigate and resolve incidents with execution listeners
...
### Business Knowledge Models (BKM) in DMN
...
### Provide Execution listeners comprehensive support
...
### Version Migration: Automapping for process activities during migration
...
### Automatically onboard users on orgs when logging in via external IDP
