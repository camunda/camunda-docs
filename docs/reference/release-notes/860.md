...
The Help Center now features a step-by-step guide to complete our [human task orchestration (HTO) tutorial](/guides/orchestrate-human-tasks.md), explaining the critical features that every developer interested in HTO needs to know. In addition, users get a glimpse into the user experience for at-scale adoption, and, Enterprise architects get a picture of how Camunda's out-of-the-box Tasklist fits into their architecture.
...
### BPMN diff change list

<!-- https://github.com/camunda/product-hub/issues/2202 -->

Changes in BPMN implementation details are now visible in Web Modeler.
