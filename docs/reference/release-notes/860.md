...
You can now enable automatic fetching of Camunda 8 Connector templates in the Desktop Modeler, so you can always use the latest templates in your BPMN diagrams. This feature enhances workflow efficiency and reduces setup time.
...
- Make a simple customized request to any models available in the region, using the Amazon `InvokeModel` function.
