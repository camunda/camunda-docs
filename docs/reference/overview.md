...
- [Announcements](/reference/announcements-release-notes/880.md) - Stay up to date on versioning changes, end of maintenance updates, OpenSearch support, and other updates.
- [Release notes](/reference/announcements-release-notes/870.md) - Learn where you can find release notes for components of Camunda 8.
