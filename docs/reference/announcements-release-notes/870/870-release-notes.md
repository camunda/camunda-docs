...
To learn more about generating connector templates, see [generate a connector template](/components/connectors/custom-built-connectors/element-template-generator.md).
