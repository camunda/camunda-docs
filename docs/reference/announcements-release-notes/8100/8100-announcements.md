...
**Action:** Change these API clients to OIDC bearer tokens. Then remove `api.accessToken` from your configuration. To keep the 8.9 behavior for the duration of 8.10, set `optimize.security.csl.enabled=false`.
