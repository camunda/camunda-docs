...
The custom / compatible endpoint backends of both the Anthropic and OpenAI providers now also support OAuth 2.0 client credentials, for an internal gateway that issues bearer tokens instead of accepting a static API key.
