...
- For a [Separated Ingress](/self-managed/deployment/helm/configure/ingress-setup.md?ingress=separated) configuration:
...
- For a [Combined Ingress](/self-managed/deployment/helm/configure/ingress-setup.md?ingress=combined) configuration:
