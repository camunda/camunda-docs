...
If you are running Camunda 8 Self-Managed, see the [update guide](/self-managed/manage/upgrade/components/index.md) to learn how to update your Camunda 8 application or server installation to a newer version of Camunda 8.
