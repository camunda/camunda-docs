...
| :--------------------- | :--------------------------- | :----------------------------------------------------------------- | :---------------------------------------------------------------------------------------------- |
| 8 April 2025           | 13 October 2026              | [8.7 release notes](/reference/announcements-release-notes/870.md) | [Announcing Camunda 8.7](https://camunda.com/blog/2024/11/camunda-8-7-releasing-february-2025/) |
...
- [8.7 minor](#87-minor)
- [8.7.0-alpha4](#870-alpha4)
  - [BPMN Copilot SaaS](#bpmn-copilot-saas)
  - [Ad-hoc subprocesses](#ad-hoc-subprocesses)
- [8.7.0-alpha3](#870-alpha3)
  - [Amazon OpenSearch Optimize support Self-ManagedOptimize](#amazon-opensearch-optimize-support-self-managedoptimize)
  - [Camunda cluster update API SaaSAPI](#camunda-cluster-update-api-saasapi)
  - [Connectors SaaSSelf-ManagedConnectors](#connectors-saasself-managedconnectors)
    - [AWS S3 Connector](#aws-s3-connector)
    - [Box Connector](#box-connector)
  - [Document handling SaaSSelf-ManagedAPIModeler](#document-handling-saasself-managedapimodeler)
  - [GitLab sync SaaSSelf-ManagedModeler](#gitlab-sync-saasself-managedmodeler)
  - [Process instance migration SaaSSelf-ManagedZeebe](#process-instance-migration-saasself-managedzeebe)
  - [Replay scenarios SaaSSelf-ManagedModeler](#replay-scenarios-saasself-managedmodeler)
  - [Unified deployment experience from Web Modeler Self-ManagedModeler](#unified-deployment-experience-from-web-modeler-self-managedmodeler)
  - [User task listeners SaaSSelf-ManagedModelerOperate](#user-task-listeners-saasself-managedmodeleroperate)
  - [Zeebe user tasks modeling migration support SaaSSelf-ManagedModeler](#zeebe-user-tasks-modeling-migration-support-saasself-managedmodeler)
- [8.7.0-alpha2](#870-alpha2)
  - [Camunda 8 REST API Query API API](#camunda-8-rest-api-query-api-api)
  - [Connectors SaaSSelf-ManagedConnectors](#connectors-saasself-managedconnectors-1)
    - [AWS Amazon Comprehend Connector](#aws-amazon-comprehend-connector)
    - [Email Connector attachments](#email-connector-attachments)
    - [Google Gemini Connector](#google-gemini-connector)
    - [Webhook Connector document upload](#webhook-connector-document-upload)
  - [Connector Runtime SaaSSelf-ManagedConnectors](#connector-runtime-saasself-managedconnectors)
    ...
    - [Testing Support migration](#testing-support-migration)
  - [Cluster disk space cleared for paused trial clusters SaaS](#cluster-disk-space-cleared-for-paused-trial-clusters-saas)
  - [Document handling SaaSSelf-Managed](#document-handling-saasself-managed)
  - [Export activity logs in Console SaaSConsole](#export-activity-logs-in-console-saasconsole)
  - [Process instance migration SaaSSelf-ManagedZeebe](#process-instance-migration-saasself-managedzeebe-1)
  - [Singapore region available for SaaS SaaS](#singapore-region-available-for-saas-saas)
  - [Tags and properties in Self-Managed Console Self-ManagedConsole](#tags-and-properties-in-self-managed-console-self-managedconsole)
  - [Unified deployment experience from Web Modeler Self-ManagedModeler](#unified-deployment-experience-from-web-modeler-self-managedmodeler-1)
- [8.7.0-alpha1](#870-alpha1)
  - [Activity log information in Console Console](#activity-log-information-in-console-console)
  - [Email Connector Connectors](#email-connector-connectors)
  - [Generate Connector templates (OpenAPI + Postman) SaaSConnectors](#generate-connector-templates-openapi--postman-saasconnectors)
  - [Monorepo Git sync Modeler](#monorepo-git-sync-modeler)
  - [Resize clusters on SaaS SaaSConsole](#resize-clusters-on-saas-saasconsole)
  - [Unified deployment experience for Web Modeler Self-ManagedModeler](#unified-deployment-experience-for-web-modeler-self-managedmodeler)
