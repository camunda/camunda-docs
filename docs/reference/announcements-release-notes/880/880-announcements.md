...
This means some configuration properties have changed or are replaced with new properties. See the [Camunda 8.8 property changes](../../../../self-managed/components/orchestration-cluster/core-settings/configuration/configuration-mapping) for more information.
