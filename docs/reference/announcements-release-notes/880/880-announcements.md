...
| Command changes in `CamundaClient`              | <p><ul><li><p>The method `newUserCreateCommand()` changes to `newCreateUserCommand()`.</p></li><li><p>The method `newUserTaskAssignCommand()` changes to `newAssignUserTaskCommand()`.</p></li><li><p>The method `newUserTaskCompleteCommand()` changes to `newCompleteUserTaskCommand()`.</p></li><li><p>The method `newUserTaskUpdateCommand()` changes to `newUpdateUserTaskCommand()`.</p></li><li><p>The method `newUserTaskUnassignCommand()` changes to `newUnassignUserTaskCommand()`.</p></li><li><p>The method `newClockPinCommand()` changes to `newPinClockCommand()`.</p></li><li><p>The method `newClockResetCommand()` changes to `newResetClockCommand()`.</p></li></ul></p> |
