...
Resource-based authorizations control read and write permissions per specific resource. See [manage users](/components/hub/organization/manage-users/manage-users.md#resource-based-authorizations).
