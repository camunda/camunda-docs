...
<p><a href="../../../../components/hub/workspace/modeler/validation/test-your-process/" class="link-arrow">Scenarios</a></p>
...
Resource-based authorizations control read and write permissions per specific resource. See [manage users](/components/hub/organization/manage-users/resource-based-auth.md).
