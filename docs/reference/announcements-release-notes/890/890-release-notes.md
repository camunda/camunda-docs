...
- Deploy and run any BPMN file directly with full flexibility. Deployment is no longer limited to a main process, and the main process concept has been removed.
