...
<p className="link-arrow">[Secret management](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/configure/secret-management.md)</p>
...
<p className="link-arrow">[Migrate extraConfiguration from 8.8 to 8.9](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/configure/application-configs.md#migrate-extraconfiguration-from-88-to-89)</p>
...
<p className="link-arrow">[Helm 4](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/install/helm-v4.md)</p>
...
Legacy keys continue to work in 8.9 via normalizers, but produce deprecation warnings and will be removed in a future version. See [Secret management](/self-managed/deploy-to-production/deploy-your-baseline/kubernetes/configure/secret-management.md).
...
<p className="link-arrow">[Deploy to Amazon ECS](/self-managed/deploy-to-production/deploy-your-baseline/containers/amazon-ecs/aws-ecs.md)</p>
