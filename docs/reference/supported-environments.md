...
- Please note that `Zeebe`, `Operate`, and `Tasklist` form the Core Orchestration cluster and must be running on the same `minor`, and `patch` level starting from version `8.6.0` going forward.

| Design                | Automate                                          |                                                                            | Improve         |
| --------------------- | ------------------------------------------------- | -------------------------------------------------------------------------- | --------------- |
| Desktop Modeler 5.28+ | (Zeebe, Operate, Tasklist) 8.6., Connectors 8.6.x | Identity 8.6.x Console 8.6.x                                               | Optimize 8.6.x  |
...
| -                     | -                                                 | -                                                                          | -               |
| Web Modeler 8.7.x     | (Zeebe, Operate, Tasklist) 8.7.x                  | Identity 8.7.x Connectors 8.7.x Console 8.7.x                              | Optimize 8.7.x  |
| Web Modeler 8.6.x     | (Zeebe, Operate, Tasklist) 8.6.x                  | Identity 8.6.x Connectors 8.6.x Console 8.6.x                              | Optimize 8.6.x  |
...
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `Web Modeler` 8.8.x \| `Desktop Modeler` TBD | (`Zeebe`, `Operate`, `Tasklist`, `Orchestration Cluster-Identity`) 8.8.x, `Connectors 8.8.x`, `Optimize` 8.8.x  | `Console SM Identity` 8.8.x, `Connectors` 8.8.x, `Self-Managed Console` 8.8.x                          |
