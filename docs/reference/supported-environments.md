...
- **Camunda Spring Boot SDK**: Spring Boot 3.4.x (for the exact version, check the [version matrix](/apis-tools/camunda-spring-boot-sdk/getting-started.md#version-compatibility).)
