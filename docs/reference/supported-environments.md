...
We highly recommend running Camunda 8 Self-Managed in a Kubernetes environment. We provide officially supported [Helm Charts](/self-managed/installation/overview.md) for this. Please follow the [Installation Guide](/self-managed/installation/overview.md) to learn more about installation possibilities.
