...
| Management Identity                                        | OpenJDK 17+  | <ul><li>Keycloak: 25.x, 26.x</li><li>Microsoft SQL Server: 2019</li><li>Oracle Database: 19c</li><li>PostgreSQL: 14.x, 15.x, 16.x, 17.x, or Amazon Aurora PostgreSQL: 13.x, 14.x, 15.x, 16.x, 17.x (required for [certain features](/self-managed/components/management-identity/miscellaneous/configuration-variables.md#database-configuration))</li></ul> |
| Secondary storage                                          | -            | <ul><li>H2 (development only): 2.3</li><li>MariaDB: 10.11, 11.4, 11.8</li><li>Microsoft SQL Server: 2019, 2022</li><li>MySQL: 8.4</li><li>Oracle Database: 19c, 23ai</li><li>PostgreSQL: 15.x, 16.x, 17.x, or Amazon Aurora PostgreSQL (compatible): 14.x, 15.x, 16.x, 17.x</li></ul>                                                                        |
| Web Modeler                                                | -            | <ul><li>H2 (development only): 2.3</li><li>MariaDB: 10.11, 11.4, 11.8</li><li>Microsoft SQL Server (MSSQL): 2019, 2022</li><li>MySQL: 8.4</li><li>Oracle Database: 19c, 23ai</li><li>PostgreSQL: 13.x, 14.x, 15.x, 16.x, 17.x, 18.x, or Amazon Aurora PostgreSQL: 13.x, 14.x, 15.x, 16.x, 17.x</li></ul>                                                     |
