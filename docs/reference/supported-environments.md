...
| Web Modeler                                                | -            | <ul><li>Microsoft SQL Server (MSSQL): 2019, 2022</li><li>Oracle Database: 19c, 23ai</li><li>PostgreSQL: 13.x, 14.x, 15.x, 16.x, 17.x, 18.x, or Amazon Aurora PostgreSQL: 13.x, 14.x, 15.x, 16.x, 17.x</li></ul>                                                                                                                                              |
