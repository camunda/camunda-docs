...
In [the API](/apis-tools/web-modeler-api/index.md), new endpoints commencing with `/api/v1/versions` have been introduced, while the previous `/api/v1/milestones` endpoints are now deprecated.
