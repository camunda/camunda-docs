...
- Operate, Tasklist & Zeebe now use Spring Boot version 3.0. Therefore, [URLs with a trailing slash will fail with an HTTP status 404](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-3.0-Migration-Guide#spring-mvc-and-webflux-url-matching-changes). For Zeebe this only applies to the Actuator endpoints, for details please refer to the [8.2.0 update guide](../guides/update-guide/810-to-820.md#spring-boot-30---url-matching-changes).
