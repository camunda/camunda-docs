...
- In **Camunda HELM `9.0.x`**
  - **Limitation**
    ...
    - **Reference:** n/a
    - **Mitigation:**
      1. Refer to our [docs for the installation](/self-managed/installation/deploy/deploy.md#components-installed-by-the-helm-charts), the docs include guidance about necessary adjustments of the Helm chart configuration.
...
- In **Connectors `8.4.x`**
  - **Missing feature**
    ...
    - **Mitigation:**
      ...
      2. [Disable Connectors component](/self-managed/installation/guides/connect-to-an-oidc-provider.md#configuration) when configuring a custom OIDC provider.
...
[Helm charts versioning](/self-managed/installation/deploy/deploy.md) changed in July 2023.
