...
- In **Optimize `8.5.0`**
  - **Limitation**
    ...
    - **Reference:** n/a
    - **Mitigation:** Optimize can be installed and used in production with limited reporting functionality. Optimize imports all process data generated by Zebee. All repoting functionality as described in the docs will be delivered with upcoming patches.
