...
- [Resource planning](/self-managed/components/orchestration-cluster/zeebe-deployment/operations/resource-planning.md#event-log)
...
- [Resource planning](/self-managed/components/orchestration-cluster/zeebe-deployment/operations/resource-planning.md#snapshots)
...
- [Exporting API](/self-managed/components/orchestration-cluster/zeebe-deployment/operations/management-api.md)
