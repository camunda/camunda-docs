...
- [Architecture](../product-manuals/zeebe/basics/architecture.md#broker)

### Client

A client interacts with the Zeebe broker on behalf of the business application. Clients poll for work from the broker.

- [Architecture](../product-manuals/zeebe/basics/architecture.md#client)
...
- [Clustering](../product-manuals/zeebe/basics/clustering.md)

### Command

A command represents an action to be taken or executed. Example commands include: deploy a workflow, execute a workflow, etc.

- [Internal Processing](../product-manuals/zeebe/basics/internal-processing.md#events-and-commands)

### Correlation

Correlation refers to the act of matching a message with an inflight workflow instance.

- [Message Correlation](../product-manuals/zeebe/reference/message-correlation/message-correlation.md)
...
- [Getting Started Tutorial: Deploy a Workflow](../product-manuals/zeebe/getting-started/deploy-a-workflow.md)
...
- [Exporter](../product-manuals/zeebe/basics/exporters.md)
...
- [Clustering](../product-manuals/zeebe/basics/clustering.md#raft-consensus-and-replication-protocol)
...
- [Architecture](../product-manuals/zeebe/basics/architecture.md#gateway)
...
- [Incident](../product-manuals/zeebe/reference/incidents.md)
...
- [Job Workers](../product-manuals/zeebe/basics/job-workers.md#what-is-a-job)
...
- [Job Workers](../product-manuals/zeebe/basics/job-workers.md#requesting-jobs-from-the-broker)
...
- [Job Workers](../product-manuals/zeebe/basics/job-workers.md)
...
- [Partitions](../product-manuals/zeebe/basics/partitions.md#partition-data-layout)
...
- [Partitions](../product-manuals/zeebe/basics/partitions.md)
...
- [gRPC API Reference](../product-manuals/zeebe/reference/grpc.md)
...
- [Resource Planning](../product-manuals/zeebe/operations/resource-planning.md#snapshots)
...
- [Resource Planning](../product-manuals/zeebe/operations/resource-planning.md#event-log)
...
- [Workflows](../product-manuals/zeebe/basics/workflows.md)
...
- [Variables](../product-manuals/zeebe/reference/variables.md)
- [Data Flow](../product-manuals/zeebe/bpmn-workflows/data-flow.md)
