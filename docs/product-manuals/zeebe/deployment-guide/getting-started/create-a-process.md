...
- A _job_ is simply a work item in a process that needs to be completed before a process instance can proceed to the next step. (_[See: Job Workers](/product-manuals/concepts/job-workers.md)_)
