...
| -- | -- | -- | -- |
| Bolding | Bold when referring to button names or items to select.<br>Bold to refer to another section within a document. | Click "Create New Diagram." | Click **Create New Diagram** under the **Diagrams** tab. |
