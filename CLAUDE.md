# Claude Code instructions for camunda-docs

This file provides instructions for Claude Code working autonomously in this repository.

Read and follow [`AGENTS.md`](AGENTS.md): It contains all repository structure, build commands, style guidelines, and contribution rules.
