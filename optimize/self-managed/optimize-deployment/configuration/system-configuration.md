...
| historyCleanup.processDataCleanup.cleanupMode                                    | 'all'         | Camunda 7 only. Global type of the cleanup to perform for process instances, possible values: 'all' - delete everything related and including the process instance that passed the defined ttl 'variables' - only delete variables of a process instance Note: This doesn't affect the decision instance cleanup which always deletes the whole instance.                                                                                                                                                                                                                                                            |
...
| historyCleanup.processDataCleanup .perProcessDefinitionConfig.${key}.cleanupMode |               | Camunda 7 only. Cleanup mode to use for process instances of the process definition with the ${key}.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
