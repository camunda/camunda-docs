...
Not all features of Optimize are yet supported when using it with OpenSearch as a database. For a full list of the features that are now supported, please refer to the [Camunda 8 OpenSearch features](https://github.com/camunda/product-hub/issues/1908).
