...
// 
// Example usage:
// <ConditionalAdmonition type="warning" date="2025-04-09" text="There is a
// [**newer
// release**](/docs/self-managed/setup/deploy/amazon/amazon-eks/eks-terraform/)
// of the documentation available with updated instructions. Use of the latest
...
// static and don't adhere to the normal Docusaurus link resolution.
