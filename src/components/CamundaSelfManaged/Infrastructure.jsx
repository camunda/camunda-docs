...
const InfrastructureCard = ({ link, title, icon: Icon, description }) => {
  return (
    <a href={link} className="sm-card" title={title}>
  ...
  const infrastructureItems = [
    {
      ...
      link: "/docs/self-managed/setup/deploy/amazon/amazon-eks/",
    },
    {
      title: "Microsoft",
      icon: AzureIcon,
      ...
      link: "/docs/self-managed/setup/deploy/azure/microsoft-aks/",
    },
    {
      title: "Google",
      icon: GCPIcon,
      ...
      link: "/docs/self-managed/setup/deploy/gcp/google-gke/",
    },
    {
      title: "Red Hat OpenShift",
      icon: OpenShiftIcon,
      description: "Run Camunda on OpenShift container platform",
      link: "/docs/self-managed/setup/deploy/openshift/redhat-openshift/",
    },
  ];
