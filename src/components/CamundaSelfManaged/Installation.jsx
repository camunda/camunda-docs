  ...
  const InstallationItems = [
    {
      ...
      link: "/docs/self-managed/installation-methods/helm/",
    },
    {
      title: "Docker",
      icon: DockerIcon,
      description: "Run individual Camunda components in Docker containers",
      link: "/docs/self-managed/installation-methods/docker/",
    },
    {
      title: "Manual JAR",
      icon: JarIcon,
      description: "Direct installation and configuration using JAR files",
      link: "/docs/self-managed/installation-methods/manual/manual-install/",
    },
  ];
