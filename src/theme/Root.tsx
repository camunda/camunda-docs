...
function VersionNotification() {
  ...
  return (
    <div
      ...
      aria-live="polite"
    >
      <svg className="version-switch-toast__icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
