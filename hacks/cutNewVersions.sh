...
PREVIOUS_DOCS_VERSION="8.0"
NEW_OPTIMIZE_VERSION="3.9.0"
PREVIOUS_OPTIMIZE_VERSION="3.8.0"


echo $NEW_DOCS_VERSION
echo $PREVIOUS_DOCS_VERSION
echo $NEW_OPTIMIZE_VERSION
echo $PREVIOUS_OPTIMIZE_VERSION


echo "1/ Creating version $NEW_DOCS_VERSION of main docs..."
npm run docusaurus docs:version $NEW_DOCS_VERSION

echo "2/ Creating version $NEW_OPTIMIZE_VERSION of Optimize docs..."
npm run docusaurus docs:version:optimize $NEW_OPTIMIZE_VERSION

echo "3/ Correcting sidebars files of new versions..."
...
echo "4/ Correcting sidebars files of previous versions..."
