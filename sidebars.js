          ...
          items: [
            {
              Zeebe: [
                {
                  "Zeebe Gateway": [
                    "self-managed/components/orchestration-cluster/zeebe-deployment/zeebe-gateway/overview",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/zeebe-gateway/interceptors",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/zeebe-gateway/filters",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/zeebe-gateway/job-streaming",
                  ],
                },
                {
                  Configuration: [
                    "self-managed/components/orchestration-cluster/zeebe-deployment/configuration/configuration",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/configuration/logging",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/configuration/gateway-health-probes",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/configuration/environment-variables",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/configuration/fixed-partitioning",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/configuration/priority-election",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/configuration/broker-config",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/configuration/gateway-config",
                  ],
                },
                {
                  Security: [
                    "self-managed/components/orchestration-cluster/zeebe-deployment/security/security",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/security/client-authorization",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/security/secure-client-communication",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/security/secure-cluster-communication",
                  ],
                },
                {
                  Operation: [
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/zeebe-in-production",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/resource-planning",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/network-ports",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/setting-up-a-cluster",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/health",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/backpressure",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/disk-space",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/update-zeebe",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/rebalancing",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/management-api",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/backups",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/operations/cluster-scaling",
                  ],
                },
                {
                  type: "category",
                  ...
                  link: {
                    type: "doc",
                    id: "self-managed/components/orchestration-cluster/zeebe-deployment/exporters/exporters",
                  },
                  items: [
                    {
                      type: "category",
                      ...
                      link: {
                        type: "doc",
                        id: "self-managed/components/orchestration-cluster/zeebe-deployment/exporters/camunda-exporter-indices",
                      },
                      items: [
                        "self-managed/components/orchestration-cluster/zeebe-deployment/exporters/index-diagrams/camunda-exporter-indices-identity",
                        "self-managed/components/orchestration-cluster/zeebe-deployment/exporters/index-diagrams/camunda-exporter-indices-operate",
                        "self-managed/components/orchestration-cluster/zeebe-deployment/exporters/index-diagrams/camunda-exporter-indices-tasklist",
                      ],
                    },
                    "self-managed/components/orchestration-cluster/zeebe-deployment/exporters/elasticsearch-exporter",
                    "self-managed/components/orchestration-cluster/zeebe-deployment/exporters/opensearch-exporter",
                  ],
                },
              ],
              Operate: [
                "self-managed/components/orchestration-cluster/operate-deployment/operate-configuration",
                "self-managed/components/orchestration-cluster/operate-deployment/data-retention",
                "self-managed/components/orchestration-cluster/operate-deployment/schema-and-migration",
                "self-managed/components/orchestration-cluster/operate-deployment/importer-and-archiver",
                "self-managed/components/orchestration-cluster/operate-deployment/operate-authentication",
                "self-managed/components/orchestration-cluster/operate-deployment/usage-metrics",
              ],
              Tasklist: [
                "self-managed/components/orchestration-cluster/tasklist-deployment/tasklist-configuration",
                "self-managed/components/orchestration-cluster/tasklist-deployment/tasklist-custom-styling",
                "self-managed/components/orchestration-cluster/tasklist-deployment/data-retention",
                "self-managed/components/orchestration-cluster/tasklist-deployment/importer-and-archiver",
                "self-managed/components/orchestration-cluster/tasklist-deployment/tasklist-authentication",
                "self-managed/components/orchestration-cluster/tasklist-deployment/usage-metrics",
                "self-managed/components/orchestration-cluster/tasklist-deployment/user-task-access-restrictions",
              ],
            },
            {
              type: "category",
