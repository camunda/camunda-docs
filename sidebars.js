module.exports = {
  ...
  "Self-Managed": [
    ...
    {
      // PROVISIONAL holding category: these pages have not moved yet. They will be
      // placed under Manage / Extend / Reference in the next step of the restructure.
      type: "category",
      label: "Manage (pending restructure)",
      link: {
        type: "doc",
