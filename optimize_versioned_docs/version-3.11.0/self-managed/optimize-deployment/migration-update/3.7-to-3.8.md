...
See the [supported environments]($docs$/reference/supported-environments/#camunda-7--optimize-version-matrix) sections for the full range of supported versions.
