...
| Update from             | Recommended update path to 3.9.0                                  |
| ----------------------- | ----------------------------------------------------------------- |
| 3.9.0                   | You are on the latest version.                                    |
| 3.9.0-preview-1 - 3.9.0 | Rolling update to 3.9.0                                           |
| 3.0 - 3.9.0-preview-1   | Rolling update to 3.9.0-preview-1                                 |
