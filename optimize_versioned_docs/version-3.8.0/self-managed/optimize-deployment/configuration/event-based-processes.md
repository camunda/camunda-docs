...
Configuration of the Optimize [Event Ingestion REST API](../../../apis-clients/optimize-api/event-ingestion.md) for [event-based processes]($optimize$/components/userguide/additional-features/event-based-processes).
