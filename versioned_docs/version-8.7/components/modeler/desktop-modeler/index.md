...
> On Windows and Linux you can carry out [additional steps](./install-the-modeler#wire-file-associations) to register the Modeler as the default editor for BPMN, DMN, and Form files.
