...
To deploy diagrams, start process instances, or test tasks, you must first connect Desktop Modeler to Camunda. Follow the steps below to connect to **Camunda 8 SaaS**. To connect to a local installation, visit the [Camunda 8 Self-Managed guide](../../../self-managed/modeler/desktop-modeler/connect-to-self-managed.md).
...
4. Enter a name, the connection URL, and the credentials (client ID and client secret) for your [API client](../../console/manage-clusters/manage-api-clients.md).
...
5. Select the connection you just created to use it for [deployment](./deploy-diagram.md) or [starting a new process instance](./start-instance.md).
