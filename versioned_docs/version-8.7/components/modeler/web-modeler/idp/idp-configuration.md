...
| IDP_AWS_BUCKET_NAME  | `idp-extraction-connector` (default)       | The name of the AWS S3 bucket used for document storage during extraction.                                                                                 |
