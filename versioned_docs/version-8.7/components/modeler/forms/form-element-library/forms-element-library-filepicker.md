...
<DocCardList items={[{type:"link", href:"/docs/components/document-handling/getting-started/", label: "Store, track and manage documents", docId:"components/document-handling/getting-started"}
]}/>
