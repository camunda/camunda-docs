...
| [Optimize alerts](/components/optimize/userguide/additional-features/alerts.md)                   | Optimize allows you to create alerts for reports within a collection. These alerts can notify you when a report hits a predefined critical value. For SaaS users, alerts can be sent to the email addresses of Console users.                                                                                                                                                                        |
...
In Camunda 8 SaaS, [data retention](/components/concepts/data-retention.md) strategies are implemented. This is necessary as the amount of data can grow significantly overtime. These settings are a balance between performance and usability.
