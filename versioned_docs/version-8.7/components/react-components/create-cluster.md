...
See [Clusters](/components/concepts/clusters.md) for more details. Additionally, refer to the [Camunda Academy course](https://academy.camunda.com/c8-h2-create-cluster) on creating clusters.
