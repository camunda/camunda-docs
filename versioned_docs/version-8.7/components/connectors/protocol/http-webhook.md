...
For Self-Managed deployments, you can [configure the request limits](/self-managed/connectors-deployment/connectors-configuration.md#configure-inbound-webhook-request-limits).
