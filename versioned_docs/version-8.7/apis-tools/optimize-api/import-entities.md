...
The request body should contain a JSON array of entity definitions to be imported. These entity definitions may be obtained by using the [report](report/export-report-definitions.md) or [dashboard](dashboard/export-dashboard-definitions.md) export APIs or by [manually exporting entities](/components/optimize/userguide/additional-features/export-import.md#exporting-entities) via the Optimize UI.
