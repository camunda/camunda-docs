  ...
  components: [
    {
      components: [
        {
          content:
            '<style>\n.decision-item {\n  font-size: 16px;\n}\n\n.info-text {\n  font-size: 12px;\n  margin-top: 4px;\n  color: #2e2e2;\n}\n</style>\n\n<div class="decision-item">\n  Do you use user tasks in any of your processes?\n</div>\n<div class="info-text">\n  <a target="_blank" href="https://docs.camunda.io/docs/components/modeler/bpmn/user-tasks/">User tasks</a> are used to model human work in your processes, and often require user input in a form.\n</div>',
          label: "HTML",
          type: "html",
          layout: {
            row: "Row_1cyppoh",
    ...
    },
    {
      components: [
        {
          content:
            '<style>\n.decision-item {\n  font-size: 16px;\n}\n\n.info-text {\n  font-size: 12px;\n  margin-top: 4px;\n  color: #2e2e2;\n}\n</style>\n\n<div class="decision-item">\n  Do you run on SaaS or self-managed?\n</div>\n<div class="info-text">\nLearn more about the distributions <a target="_blank" href="https://docs.camunda.io/docs/self-managed/about-self-managed/">here</a>. \n</div>',
          label: "HTML",
          type: "html",
          layout: {
            row: "Row_0p33f8h",
    ...
    },
    {
      components: [
        {
          content:
            '<style>\n.decision-item {\n  font-size: 16px; \n  margin-top: 0px;\n}\n\n.info-text {\n  font-size: 12px;\n  margin-top: 4px;\n  color: #2e2e2;\n}\n</style>\n\n<div class="decision-item">\n  Do you run or develop a custom task application, or plan to do so?\n</div>\n<div class="info-text">\nA custom task application means you are using the <a href="https://docs.camunda.io/docs/apis-tools/tasklist-api-rest/tasklist-api-rest-overview/">Tasklist API</a> (REST or GraphQL) or <a href="https://docs.camunda.io/docs/self-managed/concepts/exporters/">custom exporters</a> to manage user tasks.\n</div>',
          label: "HTML",
          type: "html",
          layout: {
            row: "Row_1t8ben5",
    ...
    },
    {
      components: [
        {
          content:
            '<style>\n.decision-item {\n  font-size: 16px;\n}\n\n.info-text {\n  font-size: 12px;\n  margin-top: 4px;\n  color: #2e2e2;\n}\n</style>\n\n<div class="decision-item">\n  Do you run the Camunda Tasklist UI?\n</div>\n<div class="info-text">\nLearn more about the Camunda Tasklist UI <a href="https://docs.camunda.io/docs/components/tasklist/userguide/using-tasklist/">here</a>. \n</div>',
          label: "HTML",
          type: "html",
          layout: {
            row: "Row_0ukpji8",
