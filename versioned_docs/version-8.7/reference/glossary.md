...
A partition represents a logical grouping of data in a Zeebe Broker. This data includes process variables stored in RocksDB, commands, and events generated by Zeebe stored in the log. The number of partitions is defined by configuration.
