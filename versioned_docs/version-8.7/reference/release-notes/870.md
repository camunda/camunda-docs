...
This release extends support for [document handling](/components/concepts/document-handling.md) to the following Connectors:

- [SendGrid](/components/connectors/out-of-the-box-connectors/sendgrid.md): Provides attachment support.
- [Slack](/docs/components/connectors/out-of-the-box-connectors/slack.md): Supports adding attachments and increasing template versions.
