...
:::note
The Zeebe Java client will not be developed further and will only receive bug fixes for as long as version 8.7 is officially supported. This client is scheduled for removal in version 8.10.
:::
...
:::note
The Spring Zeebe SDK will not be developed further and will only receive bug fixes for as long as version 8.7 is officially supported. This SDK is scheduled for removal in version 8.10.
:::
