...
Starting with Connectors 8.7.25, the connector runtime introduces the [secret filter](/self-managed/connectors-deployment/connectors-configuration.md#secret-filter), defaulting to `STRICT`.
