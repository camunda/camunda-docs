...
| Connectors  |                                                                                                                                        | Connectors act as a client in the OIDC flow. <br/><br/> For outbound-only mode (when `CAMUNDA_CONNECTOR_POLLING_ENABLED` is `false`), only Zeebe client properties are required: <br/> `ZEEBE_CLIENT_ID=[client-id]`<br/> `ZEEBE_CLIENT_SECRET=[client-secret]`<br/> `ZEEBE_AUTHORIZATION_SERVER_URL=[provider-issuer]`<br/> `ZEEBE_TOKEN_AUDIENCE=[Zeebe audience]`<br/> `ZEEBE_TOKEN_SCOPE=[Zeebe scope]` (optional)<br/><br/> For inbound mode, Operate client properties are required:<br/> `OPERATE_CLIENT_PROFILE=oidc`<br/> `OPERATE_CLIENT_AUDIENCE=[Operate audience]`<br/> `OPERATE_CLIENTID=[client-id]`<br/> `OPERATE_CLIENTSECRET=[client-secret]`<br/> `OPERATE_CLIENT_BASEURL=[provider-issuer]`<br/> `OPERATE_CLIENT_SCOPE=[opreate-client-scope]`<br/> `OPERATE_CLIENT_AUTHURL=[operate token endpoint]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
