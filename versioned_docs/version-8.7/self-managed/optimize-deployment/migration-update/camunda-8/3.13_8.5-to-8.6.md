---
id: 3.13_8.5-to-8.6
title: "Upgrade notes (8.5/3.13 to 8.6)"
---

:::note Heads up!
To upgrade Optimize to version 8.6, perform the steps in the [migration and upgrade instructions](./instructions.md).
:::

The upgrade to 8.6 can be performed from any 8.5 release.
...
As of Optimize 8.6, instances of Optimize running with Camunda 8 exclusively use the `8.x.x` versioning scheme. Instances of Optimize running with Camunda 7 exclusively use the `3.x.x` versioning scheme. This means you will only be able to upgrade to Optimize 8.6 if you currently use Optimize 8.5/3.13 with Camunda 8. Optimize instances of versions 8.5/3.13 running with Camunda 7 cannot be upgraded to Optimize 8.6.
