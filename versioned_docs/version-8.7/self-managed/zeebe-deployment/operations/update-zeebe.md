...
id: update-zeebe
title: "Upgrade Zeebe"
description: "This section describes how to upgrade Zeebe to a new version."
---
...
:::info
Review the [upgrade guide](/self-managed/operational-guides/update-guide/introduction.md) for general upgrade procedures you must follow and to check for known issues relating to the specific upgrade you are planning.
:::
