...
In version 8.6.0, the Zeebe Gateway memory usage has increased due to the introduction of new features.
While this change improves the performance of the Gateway, it may require additional memory resources to ensure optimal operation.
To address this, you can adjust the memory settings.
If you are running on default 512Mi memory, increasing it to 600Mi should mitigate the issue.
