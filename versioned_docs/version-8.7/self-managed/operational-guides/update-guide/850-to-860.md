...
description: "Review which adjustments must be made to upgrade from Camunda 8.5.x to Camunda 8.6.0."
---

The following sections explain which adjustments must be made to upgrade from Camunda 8.5.x to 8.6.x for each component.
