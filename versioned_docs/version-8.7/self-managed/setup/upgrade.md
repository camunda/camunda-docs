...
:::note
When upgrading to a new version of the Camunda 8 Helm charts, we recommend upgrading to the **latest patch** release of the next **major** version of the chart.
