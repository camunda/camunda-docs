...
docker run --rm --name=HybridConnectorRuntime \
    ...
    -e OPERATE_CLIENT_PROFILE=saas \
    -e OPERATE_CLIENT_CLUSTERID='<YOUR_CLUSTER_ID>' \
    -e OPERATE_CLIENT_REGION='<YOUR_CLUSTER_REGION>' \
    -e OPERATE_CLIENT_CLIENTID='<YOUR_CLIENT_ID>' \
    -e OPERATE_CLIENT_CLIENTSECRET='<YOUR_CLIENT_SECRET>' \
