...
When you open Operate at http://localhost:8080/operate/ (or http://localhost:8081 using Docker Compose), you should now note the process deployed to your local Self-Managed setup.
