...
This guide walks you through the steps to set up OAuth for your applications using Microsoft Entra ID as the identity provider. We cover setting up the necessary environment variables and configuring Microsoft Entra.

## What is Microsoft Entra?

Microsoft Entra ID (previously known as Azure AD) is a cloud-based identity and access management service from Microsoft that provides a secure environment for authentication and identity management.
...
3. **Enhanced security**: Utilize advanced security features of Microsoft Entra, such as conditional access and multi-factor authentication, to protect sensitive workflows and operations performed through the Zeebe client.
...
Also ensure that Connectors are registered in Microsoft Entra. For Camunda 8.7, it is advised to use the Connectors client in Microsoft Entra to obtain tokens for communication with Zeebe and Operate.
