...
|webhookAlerting.webhooks.${webhookName}.proxy.enabled|false|Whether an HTTP proxy should be used for requests to the webhook URL.|
|webhookAlerting.webhooks.${webhookName}.proxy.host|null|The proxy host to use, must be set if webhookAlerting.webhooks.${webhookName}.proxy.enabled = true.|
|webhookAlerting.webhooks.${webhookName}.proxy.port|null|The proxy port to use, must be set if webhookAlerting.webhooks.${webhookName}.proxy.enabled = true.|
|webhookAlerting.webhooks.${webhookName}.proxy.sslEnabled|null|Whether this proxy is using a secured connection (HTTPS).|
