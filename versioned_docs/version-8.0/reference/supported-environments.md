...
We highly recommend running Camunda Platform 8 Self-Managed in a Kubernetes environment. We provide officially supported [Helm Charts](/self-managed/platform-deployment/kubernetes-helm.md) for this. Please follow the [Installation Guide](/self-managed/platform-deployment/platform-8-deployment.md) to learn more about installation possibilities.
