...
The obtained list of entity exports can be imported into other Optimize systems either using the dedicated [import API](../import-entities.md) or [via UI]($optimize$/userguide/additional-features/export-import#importing-entities).
