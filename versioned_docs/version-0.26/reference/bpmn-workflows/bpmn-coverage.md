...
<div className="bpmn-symbol-container">
    <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/embedded-subprocesses/embedded-subprocesses">
        <EmbeddedSubprocessSvg className="implemented" />
    </a>
    <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/call-activities/call-activities">
        <CallActivitySvg className="implemented" />
    </a>
    <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/event-subprocesses/event-subprocesses">
...
<div className="bpmn-symbol-container">
    <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/service-tasks/service-tasks">
        <ServiceTaskSvg className="implemented" />
    </a>
    <a href="#">
        <UserTaskSvg />
    </a>
    <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/receive-tasks/receive-tasks">
...
<div className="bpmn-symbol-container">
    <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/exclusive-gateways/exclusive-gateways">
        <ExclusiveGatewaySvg className="implemented" />
    </a>
    <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/parallel-gateways/parallel-gateways">
        <ParallelGatewaySvg className="implemented" />
    </a>
    <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/event-based-gateways/event-based-gateways">
...
<div className="bpmn-symbol-container">
    <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/multi-instance/multi-instance">
...
<table className="bpmn-coverage-event-table">
  ...
  <tbody>
    <tr>
        <td>
            <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/none-events/none-events">None</a>
        </td>
        <td>
            <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/none-events/none-events">
    ...
    <tr>
        <td>
            <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/message-events/message-events">Message</a>
        </td>
        <td>
            <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/message-events/message-events">
    ...
    <tr>
        <td>
            <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/timer-events/timer-events">Timer</a>
        </td>
        <td>
            <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/timer-events/timer-events">
    ...
    <tr>
        <td>
            <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/error-events/error-events">Error</a>
        </td>
        <td></td>
        <td>
            <a href="https://docs.camunda.io/docs/reference/bpmn-workflows/error-events/error-events">
