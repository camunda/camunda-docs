...
See the API reference for publish message for more information, including additional request fields and code samples.
...
See the API reference for correlate message for more information, including additional request fields and code samples.
...
To know if a published message was correlated (and to which process instance), use the message correlation endpoint.
