...
Use the migration command RPC to change the process model of a running process instance.
...
A full overview of error codes can be found in the migration command RPC.
