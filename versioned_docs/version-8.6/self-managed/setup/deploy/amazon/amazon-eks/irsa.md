...
You can find the complete usage details in the [c8-sm-checks repository](https://github.com/camunda/c8-sm-checks/tree/v1.2.1). Below is a quick reference for common usage options:
