...
| **OAuth Client Secret (Zeebe)**      | `global.identity.auth.zeebe.existingSecret.name`, `global.identity.auth.zeebe.existingSecret`           | OAuth client secret for Zeebe’s internal system client | Generated by default if not set |
