...
With Camunda 8.6 the Spring-Zeebe community project was replaced with an official [Spring Zeebe SDK](../../../apis-tools/spring-zeebe-sdk/getting-started.md). A feature gap on testing support was only closed with the 8.6.7 patch release, we thus urge users to directly migrate to 8.6.7 or newer.
