...
title: "Upgrade notes (3.8.x to 3.9.x-preview-1)"
---

:::note Heads up!
To upgrade Optimize to version 3.9.x-preview-1, perform the following steps: [Migration & Update Instructions](./instructions.md).
:::

The upgrade to 3.9.x-preview-1 can be performed from any 3.8.x release.
