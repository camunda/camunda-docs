...
- [OpenJDK ≥ 17](https://openjdk.org/install/) and [Maven 3](https://maven.apache.org/index.html)
...
2. Open Desktop Modeler and click the rocket icon in the bottom left corner.
