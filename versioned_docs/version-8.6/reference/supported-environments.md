...
| Identity    | OpenJDK 17+  | Keycloak 24.x, 25.x<br/>PostgreSQL 14.x, 15.x, 16.x or Amazon Aurora PostgreSQL 13.x, 14.x, 15.x, 16.x (required for [certain features](/self-managed/identity/miscellaneous/configuration-variables.md#database-configuration))<br/>Oracle 19c<br/>SQL Server 2019 |
