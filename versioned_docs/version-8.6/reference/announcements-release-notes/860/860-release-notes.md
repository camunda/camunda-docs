...
[Spring Boot 3.5.x compatibility](../../../apis-tools/spring-zeebe-sdk/getting-started.md#version-compatibility) is verified for the `8.6.30` patch release onward, as [Spring Boot OSS support](https://spring.io/projects/spring-boot#support) for the bundled Spring Boot version 3.4 ends in December 2025.

## 8.6.7

### Spring Zeebe SDK - test support

[Testing support for the Spring Zeebe SDK](/apis-tools/spring-zeebe-sdk/getting-started.md#writing-test-cases) is available with the 8.6.7 patch release.
