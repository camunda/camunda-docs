...
Along with the gateway protocol definition, [the gateway service also bundles a default service configuration file](https://github.com/camunda/camunda/blob/stable/8.6/zeebe/gateway-protocol-impl/src/main/resources/gateway-service-config.json).
...
Usage of this file largely depends on the gRPC bindings for your language of choice. For example, when using Java, you would programatically configure your
client using:
