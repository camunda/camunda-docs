...
- **Helm CLI**: 3.13.x (for the exact version, check the [version matrix](https://helm.camunda.io/camunda-platform/version-matrix/))
...
| --------------------- | ---------------------------------------------------------------------------------------- |
| Camunda 8.8.x (alpha) | [Helm chart 13.x](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.8/)  |
| Camunda 8.7.x (alpha) | [Helm chart 12.x](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.7/)  |
