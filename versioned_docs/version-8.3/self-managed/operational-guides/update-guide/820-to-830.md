...
Upgrading may take longer if the experimental consistency checks enabled. In case the duration of the downtime needs to
be shortened, please set the following properties to `false` while migrating Zeebe to `8.3.0`:
