...
Existing solutions using Camunda 7 might simply keep running on Camunda 7. The has ongoing [support](https://docs.camunda.org/enterprise/announcement/), so there is no need to rush on a migration project.
