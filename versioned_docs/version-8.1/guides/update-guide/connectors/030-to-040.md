...
To function properly, Spring Zeebe runtime requires connection to [Operate API](../../../apis-clients/operate-api/index.md). Read more on [how to connect to Operate or disable it completely](../../../self-managed/connectors-deployment/connectors-configuration.md#local-installation).
