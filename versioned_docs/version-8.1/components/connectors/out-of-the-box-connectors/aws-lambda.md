...
:::note
We do not recommend exposing your AWS IAM credentials as plain text. Instead, use Camunda secrets. Refer to [managing secrets](components/console/manage-clusters/manage-secrets.md) to learn more.
:::
