...
- [Camunda 8 Core](https://github.com/camunda/camunda-platform/releases/tag/8.5.0)
...
Release date: 12th of March 2024

Changelog(s):

- [Camunda 8 Core](https://github.com/camunda/camunda-platform/releases/tag/8.5.0-alpha2)
- [Connectors](https://github.com/camunda/connectors/releases/tag/8.5.0-alpha2)
...
Release date: 13th of Feb 2024

Changelog(s):

- [Camunda 8 Core](https://github.com/camunda/camunda-platform/releases/tag/8.5.0-alpha1)
- [Connectors](https://github.com/camunda/connectors/releases/tag/8.5.0-alpha1)
