...
Use supported Spring Zeebe SDK in your Spring or Spring Boot projects to interact with the Camunda 8 engine API and build process applications. Spring Zeebe SDK works with Zeebe gRPC and the new Zeebe REST API.
...
### Multi-region: Productise the two regions, Active-Active, Self-Managed setup (Zeebe, Operate, Tasklist)
