...
RocksDB will then allocate [512MB per partition](https://github.com/camunda/camunda/blob/stable/8.5/dist/src/main/config/broker.yaml.template#L963) by default.
