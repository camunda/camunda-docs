...
To store your backups in Azure Storage, choose the `AZURE` backup store and specify how to connect with the Azure container. This configuration can be set in your Zeebe [`config/application.yaml`](/docs//self-managed/zeebe-deployment/configuration/configuration.md):
