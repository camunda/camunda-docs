...
:::note
The soft pause feature is only available from Zeebe 8.5.1 onwards. For earlier versions, use the regular pause exporting instead.
:::
...
By default, the indices are prefixed with `zeebe-record`. If you have configured a different prefix when configuring Elasticsearch/OpenSearch exporter in Zeebe, use this instead.
   ...
   <Tabs groupId="search-engine">
      ...
      The following uses the [Elasticsearch snapshot API](https://www.elastic.co/guide/en/elasticsearch/reference/current/create-snapshot-api.html) to create a snapshot.
      ...
      <details>
         ...
         ```json
         {
            "snapshot":{
               ...
               "indices":[
                  "zeebe-record_process_8.5.2_2025-06-03",
                  "zeebe-record_job_8.5.2_2025-06-03",
                  "zeebe-record_process-instance-creation_8.5.2_2025-06-03",
                  "zeebe-record_process-instance_8.5.2_2025-06-03",
                  "zeebe-record_deployment_8.5.2_2025-06-03"
               ],
               "data_streams":[
...
### 3. Wait for backup `x` of the exported Zeebe indices to complete before proceeding
   ...
   <Tabs groupId="search-engine">
      ...
      The following uses the [Elasticsearch snapshot API](https://www.elastic.co/guide/en/elasticsearch/reference/current/get-snapshot-status-api.html) to get the snapshot status.
