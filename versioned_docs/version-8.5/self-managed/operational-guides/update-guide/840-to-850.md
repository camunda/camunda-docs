...
The Camunda Helm chart v10.0.0 has major changes in the values file structure.
:::

Some keys in the values file have been changed in the Camunda Helm chart v10.0.0. For compatibility, the keys are deprecated in the Camunda release cycle 8.5 and they will be removed in the Camunda 8.6 release (October 2024).
