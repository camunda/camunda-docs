...
description: "Review which adjustments must be made to upgrade from Camunda 8.4.x to Camunda 8.5.0."
---

The following sections explain which adjustments must be made to upgrade from Camunda 8.4.x to 8.5.x for each component.
