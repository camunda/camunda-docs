...
Identity now uses the Keycloak frontend URL instead of the backend URL due to the Keycloak dependency. This change may affect customers who have blocked the Keycloak frontend URL from other services, including Camunda applications, and can potentially impact Identity's functionality.
