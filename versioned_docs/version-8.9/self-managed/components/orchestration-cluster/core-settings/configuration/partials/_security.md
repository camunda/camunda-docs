...
| `camunda.security.authentication.providers.oidc.<provider-id>.user-info-enabled`            | If enabled, will enrich the access token with information from the `/userinfo` endpoint.                                                                                                                                                                                                                                               | `true`                               |
...
| `CAMUNDA_SECURITY_AUTHENTICATION_PROVIDERS_OIDC_<provider-id>_USERINFOENABLED`            | If enabled, will enrich the access token with information from the `/userinfo` endpoint.                                                                                                                                                                                                                                               | `true`                               |
