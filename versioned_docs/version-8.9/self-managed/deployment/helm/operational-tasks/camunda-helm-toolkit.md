...
The toolkit rewrites supported configuration keys and reports changes that need your attention. A clean result is not proof your deployment is ready to upgrade: the toolkit doesn't upgrade your deployment, migrate stored data, validate a live cluster, or replace the [Helm upgrade procedure](/self-managed/upgrade/helm/880-to-890.md).
