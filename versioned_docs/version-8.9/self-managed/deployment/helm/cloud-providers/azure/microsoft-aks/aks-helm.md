...
- (optional) Permissions to install Kubernetes operators (cluster-admin or equivalent) to deploy infrastructure services such as Elasticsearch, PostgreSQL, and Keycloak. This guide installs them directly from source to provide full control over versions and configuration.
  For the tool versions used, check the [.tool-versions](https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/.tool-versions) file in the related repository. This contains an up-to-date list of versions we also use for testing.
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/generic/kubernetes/single-region/procedure/chart-env.sh
```
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/procedure/check-env-variables.sh
```
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region-rdbms/procedure/check-env-variables.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/generic/kubernetes/single-region/procedure/export-ingress-setup-vars.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/procedure/export-domain-setup-vars.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/procedure/install-ingress-nginx.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/procedure/external-dns-azure-config.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/procedure/install-external-dns.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/generic/kubernetes/single-region/procedure/install-cert-manager-crds.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/procedure/install-cert-manager.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/procedure/install-cert-manager-issuer.sh
```
...
```yaml reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/helm-values/values-domain.yml
```
...
```yaml reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region-rdbms/helm-values/values-domain.yml
```
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/procedure/create-external-db-secrets.sh
```
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region-rdbms/procedure/create-external-db-secrets.sh
```
...
```yaml reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/helm-values/values-no-domain.yml
```
...
```yaml reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region-rdbms/helm-values/values-no-domain.yml
```
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/generic/kubernetes/single-region/procedure/assemble-envsubst-values.sh
```
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/azure/kubernetes/aks-single-region/procedure/create-webmodeler-secret.sh
```
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.9/generic/kubernetes/single-region/procedure/install-chart.sh
```
