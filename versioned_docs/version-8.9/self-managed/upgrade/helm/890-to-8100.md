...
1. For each finding, go to the matching section under [Apply manual configuration changes](#apply-manual-configuration-changes), for example the [deprecated application configuration Helm keys](#deprecated-application-configuration-helm-keys) reference below.
