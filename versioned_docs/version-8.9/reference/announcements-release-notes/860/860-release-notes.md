...
| -------------- | ------------------ | --------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| 8 October 2024 | 14 April 2026      | [Patch Releases and Changelogs](#technical-changelogs-for-all-86x-patch-releases) | [Release blog](https://camunda.com/blog/2024/10/camunda-8-6-release/) | [Self-Managed update guide](versioned_docs/version-8.7/self-managed/operational-guides/update-guide/850-to-860.md) |
