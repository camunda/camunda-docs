...
| :--------- | :------------------------------------------------------------------ | :-------------- | :---------------------------------------------------------------------------------------------------------------------------- |
| Core       | [8.9.10](https://github.com/camunda/camunda/releases/tag/8.9.10)    | Regression      | [Tasklist V1: candidate group task visibility](#tasklist-v1-candidate-group-task-visibility)                                  |
| Core       | [8.9.12](https://github.com/camunda/camunda/releases/tag/8.9.12)    | Breaking change | [Individual component Docker images no longer produced](#individual-component-docker-images-no-longer-produced)               |
| Core       | [8.9.15](https://github.com/camunda/camunda/releases/tag/8.9.15)    | Regression      | [Nested input mappings can silently drop sibling fields](#nested-input-mapping-sibling-fields)                                |
| Core       | [8.9.15](https://github.com/camunda/camunda/releases/tag/8.9.15)    | Regression      | [Chained input mappings can silently drop FEEL temporal value types](#chained-input-mapping-temporal-type-loss)               |
...
| Core       | [8.9.1](https://github.com/camunda/camunda/releases/tag/8.9.1)      | Regression      | [Multi-instance sub-process output mapping variable scope regression](#multi-instance-output-mapping-regression)              |
| Core       | [8.9.1](https://github.com/camunda/camunda/releases/tag/8.9.1)      | Regression      | [Output mapping behavior change for object variables](#output-mapping-behavior-change)                                        |
| Core       | [8.9.1](https://github.com/camunda/camunda/releases/tag/8.9.1)      | Breaking change | [`getMessageKeys()` removed from the exporter record](#getmessagekeys-removed-from-the-exporter-record)                       |
| Core       | [8.9.1](https://github.com/camunda/camunda/releases/tag/8.9.1)      | Change          | [Message TTL cleanup batch size pacing change](#message-ttl-cleanup-batch-size-pacing-change)                                 |
| Connectors | [8.9.10](https://github.com/camunda/connectors/releases/tag/8.9.10) | Breaking change | [Connector secret filter now defaults to STRICT](#connector-secret-filter-strict-default)                                     |
