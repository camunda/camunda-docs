...
| Management Identity                                        | OpenJDK 17+   | <ul><li>Keycloak 26.x</li><li>PostgreSQL 14.x, 15.x, 16.x, 17.x, or Amazon Aurora PostgreSQL 13.x, 14.x, 15.x, 16.x, 17.x (required for [certain features](/self-managed/components/management-identity/miscellaneous/configuration-variables.md#database-configuration))</li><li>Oracle 19c</li><li>Microsoft SQL Server 2019, 2022, 2025</li></ul> |
