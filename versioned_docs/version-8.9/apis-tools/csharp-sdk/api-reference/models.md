...
Request and response model classes (544 types).
...
- [SearchUserTaskEffectiveVariablesRequest](#searchusertaskeffectivevariablesrequest) — User task effective variable search query request
