...
description: "Learn more about inclusive gateways, which allow for making multiple decisions based on data or process variables, and can be diverging or converging."
---
