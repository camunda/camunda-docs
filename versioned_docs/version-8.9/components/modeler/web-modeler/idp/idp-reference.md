...
IDP allows you to create, configure, and publish **document extraction templates** and **document classification templates**. These are types of [connector templates](/components/connectors/custom-built-connectors/connector-templates.md).

- **Document extraction templates** extract specific data fields from documents. See [document extraction](idp-document-extraction.md).
- **Document classification templates** classify documents by type using LLMs. See [document classification](idp-document-classification.md).
...
| Test classification                        | <img src={CrossImg} class="table-tick" alt="Cannot access" width="15px"/> | <img src={TickImg} class="table-tick" alt="Can access" width="15px"/> | <img src={TickImg} class="table-tick" alt="Can access" width="15px"/> |
