...
To configure with Helm, visit the [Self Managed installation documentation](/self-managed/deployment/helm/install/quick-install.md).
...
#### Helm chart: Customer users and clients for Identity

It is now possible to add customer users and clients for Management Identity

See the [Adding Customer Users and Clients](/self-managed/concepts/custom-users-and-clients/) for more information on configuring custom users and clients on Management Identity on intial Helm install.
...
- For a [Separated Ingress](/self-managed/deployment/helm/configure/ingress/ingress-setup.md?ingress=separated) configuration:
...
- For a [Combined Ingress](/self-managed/deployment/helm/configure/ingress/ingress-setup.md?ingress=combined) configuration:
