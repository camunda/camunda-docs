...
:::info
To learn more, see [Elasticsearch changes in Components update 8.7 to 8.8](/self-managed/update/components/870-to-880.md#elasticsearch).
:::
...
For more information on how to migrate, see the [upgrade guide](/self-managed/update/components/870-to-880.md#cluster-configuration).
...
For more information on how to modify your existing configuration, see the [upgrade guide](/self-managed/update/components/870-to-880.md#changed-configuration-options).
