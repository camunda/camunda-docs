...
- Upon cluster creation, [create your first client](/components/console/manage-clusters/manage-api-clients.md#create-a-client). Ensure you check the `Optimize` client scope box.
