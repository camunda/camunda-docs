...
| **[Data Migrator](../data-migrator/)**                                               | Copies active Camunda 7 runtime instances to Camunda 8. History (audit) migration is available as experimental.                                                                                     | [camunda-7-to-8-data-migrator](https://github.com/camunda/camunda-7-to-8-data-migrator)                         |
