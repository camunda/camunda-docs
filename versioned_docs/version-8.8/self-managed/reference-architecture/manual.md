...
- Modern CPU: 2 cores
- Memory: 4 GB RAM
- Storage: 32 GB SSD-backed (1,000 IOPS recommended). HDD-backed volume types (such as AWS EBS `sc1` and `st1`) cannot meet Zeebe's Raft flush latency requirements and are not supported.
