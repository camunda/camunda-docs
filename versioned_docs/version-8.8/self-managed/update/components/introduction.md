...
Upgrade individual Camunda 8 components when moving from version 8.7 to 8.8. Component-level steps may be required depending on which Camunda components you use and how your environment is configured.
