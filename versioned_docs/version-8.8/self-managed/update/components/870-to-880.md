...
Use this page together with the deployment upgrade guide for your environment. Start with the [Upgrade Camunda 8 overview](/self-managed/update/880/) and apply the component-specific steps in this guide as required by your setup.
