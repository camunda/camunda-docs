...
Review component changes and migration steps that may be required when upgrading a Camunda 8 Self-Managed deployment from 8.7.x to 8.8.x.

Use this guide alongside your deployment upgrade guide (for example, Helm or Docker Compose). It explains migrations and behavior changes you may need depending on your setup.
...
<p><a href="../../../components/identity/role.md#assign-users-to-a-role" class="link-arrow">Assign users to a role</a></p>
...
:::note
You enable importers by setting:
