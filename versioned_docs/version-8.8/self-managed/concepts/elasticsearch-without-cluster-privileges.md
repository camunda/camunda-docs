...
- [Components update 8.7 to 8.8](/self-managed/update/components/870-to-880.md)
- [Helm chart upgrade guide: 8.7 to 8.8](/self-managed/update/helm/helm-870-880.md)

These steps may require stopping or scaling down the Camunda application before running the migration.
:::

If the target upgrade also requires a data or application migration (as documented in [Upgrade to Camunda 8.8](/self-managed/update/overview.md)), follow the migration sequence:
