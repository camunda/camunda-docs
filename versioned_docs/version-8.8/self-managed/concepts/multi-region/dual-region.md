...
Follow the [Cluster Scaling steps](../../components/orchestration-cluster/zeebe/operations/cluster-scaling.md) respecting the [Zeebe cluster configurations](#zeebe-cluster-configuration).
...
| Zeebe Cluster Scaling       | Supported. See [Zeebe cluster constraints](#zeebe-cluster-configuration)                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
