...
Follow the upgrade recommendations provided in the [Camunda Helm chart](/self-managed/update/helm/index.md) and the [component-specific upgrade guides](/self-managed/update/components/introduction.md).

The general procedure outlined in the [upgrade overview](/self-managed/update/overview.md) also applies. Before starting, always create a [Camunda-supported backup](/self-managed/operational-guides/backup-restore/backup-and-restore.md).
