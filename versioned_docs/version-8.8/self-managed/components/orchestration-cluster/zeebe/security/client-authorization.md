...
The Zeebe Gateway supports [Orchestration Cluster Identity](/self-managed/components/orchestration-cluster/identity/initial-setup.md)-based auth token validation.
