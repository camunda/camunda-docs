...
In Camunda 8.6 the Spring-Zeebe community project was replaced by the [Camunda Spring Boot SDK](../../../apis-tools/camunda-spring-boot-starter/getting-started.md).

As [testing support for the Camunda Spring Boot SDK](../../../apis-tools/camunda-spring-boot-starter/getting-started.md#writing-test-cases) was only added with the 8.6.7 release, Camunda recommends you migrate directly to version 8.6.7 or later.
...
With this change, there is no need to do extra steps with the post-renderer. You can install the chart as normal. Please refer to the [Red Hat OpenShift document](/self-managed/deployment/helm/cloud-providers/openshift/redhat-openshift.md) for more information.
