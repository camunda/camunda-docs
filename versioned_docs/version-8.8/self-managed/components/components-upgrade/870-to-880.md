...
The Identity Migration Application requires consistent entity IDs between Management Identity and Orchestration Cluster Identity to ensure a smooth migration. To ensure this, you can configure the following properties matching the values used in your Management Identity setup.
...
| `CAMUNDA_MIGRATION_IDENTITY_ENTITIES_DEFAULT_PATTERN`       | Configure the pattern that the IDs have to respect. Specific entities configuration have precedence.                            | `[^a-z0-9_@.-]` |
...
| `CAMUNDA_MIGRATION_IDENTITY_ENTITIES_ROLE_PATTERN`          | Configure the pattern that ROLES IDs have to follow, it has precedence against the default property.                            |                 |
...
| `CAMUNDA_MIGRATION_IDENTITY_ENTITIES_GROUP_PATTERN`         | Configure the pattern that GROUPS IDs have to follow, it has precedence against the default property.                           |                 |
...
| `CAMUNDA_MIGRATION_IDENTITY_ENTITIES_USER_PATTERN`          | Configure the pattern that USERS IDs have to follow, it has precedence against the default property.                            |                 |
...
| `CAMUNDA_MIGRATION_IDENTITY_ENTITIES_MAPPINGRULE_PATTERN`   | Configure the pattern that MAPPING RULES IDs have to follow, it has precedence against the default property.                    |                 |
...
| `camunda.migration.identity.entities.defaults.pattern`       | Configure the pattern that the IDs have to respect. Specific entities configuration have precedence.                            | `[^a-z0-9_@.-]` |
...
| `camunda.migration.identity.entities.role.pattern`           | Configure the pattern that ROLES IDs have to follow, it has precedence against the default property.                            |                 |
...
| `camunda.migration.identity.entities.group.pattern`          | Configure the pattern that GROUPS IDs have to follow, it has precedence against the default property.                           |                 |
...
| `camunda.migration.identity.entities.user.pattern`           | Configure the pattern that USERS IDs have to follow, it has precedence against the default property.                            |                 |
...
| `camunda.migration.identity.entities.mapping-rule.pattern`   | Configure the pattern that MAPPING RULES IDs have to follow, it has precedence against the default property.                    |                 |
