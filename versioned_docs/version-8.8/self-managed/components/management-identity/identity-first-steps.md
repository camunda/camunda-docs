...
:::note
Management Identity is included in the full and standalone Web Modeler [Docker Compose configurations](/self-managed/quickstart/developer-quickstart/docker-compose.md#docker-compose-configurations) and in the default [Helm chart deployment](/self-managed/deployment/helm/install/quick-install.md). These configurations include Keycloak. The lightweight Docker Compose configuration does not start Management Identity or Keycloak.
:::
...
- [Docker Compose full or standalone configuration](/self-managed/quickstart/developer-quickstart/docker-compose.md#docker-compose-configurations): `http://localhost:8084/`
