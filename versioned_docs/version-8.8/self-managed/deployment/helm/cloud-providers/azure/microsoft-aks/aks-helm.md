...
- (optional) Custom domain name/[DNS zone](https://learn.microsoft.com/en-us/azure/dns/dns-zones-records) in Azure DNS. This allows you to expose Camunda 8 endpoints and connect via community-supported [zbctl](https://github.com/camunda-community-hub/zeebe-client-go/blob/stable/8.8/cmd/zbctl/zbctl.md) or [Camunda Modeler](https://camunda.com/download/modeler/).
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/procedure/check-env-variables.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/procedure/export-domain-setup-vars.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/procedure/install-ingress-nginx.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/procedure/external-dns-azure-config.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/procedure/install-external-dns.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/procedure/install-cert-manager.sh
```
...
```shell reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/procedure/install-cert-manager-issuer.sh
```
...
```yaml reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/helm-values/values-domain.yml
```
...
```bash reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/procedure/create-external-db-secrets.sh
```
...
```yaml reference
https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/azure/kubernetes/aks-single-region/helm-values/values-no-domain.yml
```
