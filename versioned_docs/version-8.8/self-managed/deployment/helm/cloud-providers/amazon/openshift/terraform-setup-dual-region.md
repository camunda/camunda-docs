...
Consult the [Camunda ROSA module documentation](https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/aws/modules/rosa-hcp/README.md) for more information.
...
You can find the reference files used on [this page](https://github.com/camunda/camunda-deployment-references/tree/stable/8.8/aws/openshift/rosa-hcp-dual-region/)
...
1.  Set up the required environment variables from the OpenShift terraform module:
    ...
    ```bash reference
    https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/aws/openshift/rosa-hcp-dual-region/procedure/gather-cluster-login-id.sh
    ```
...
1.  Verify your connection to the clusters with `oc`:
    ...
    ```bash reference
    https://github.com/camunda/camunda-deployment-references/blob/stable/8.8/aws/openshift/rosa-hcp-dual-region/procedure/verify-cluster-nodes.sh
    ```
