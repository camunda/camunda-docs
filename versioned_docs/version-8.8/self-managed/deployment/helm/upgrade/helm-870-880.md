...
- if [resource authorizations](../../../../../version-8.7/self-managed/identity/access-management/resource-authorizations.md) are used, you must enable the following to take your resource authorizations into account:
