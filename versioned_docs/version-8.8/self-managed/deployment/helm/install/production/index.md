...
- When upgrading the Camunda Helm chart, make sure to read the [upgrade guide](/self-managed/update/components/introduction.md) and corresponding new version release notes before upgrading. Perform the upgrade on a test environment first before attempting in production.
...
- Make sure to follow our [upgrade guide](/self-managed/update/helm/index.md) when performing the upgrade on your Helm chart.
