...
Use this page together with the deployment upgrade guide for your environment. Start with the [Upgrade Camunda 8 overview](/self-managed/upgrade/overview.md) and apply the component-specific steps in this guide as required by your setup.
...
:::note
If you are upgrading with Helm, enable data migration in the Helm upgrade guide. See [Data migration](/self-managed/upgrade/helm/helm-870-880.md#data-migration) in the Helm upgrade guide.
