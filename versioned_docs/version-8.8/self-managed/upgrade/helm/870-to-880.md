...
| :--------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Confirm latest `8.7.x` patch                   | Confirm your deployment is running the latest `8.7.x` patch. All Camunda upgrades must start from the latest patch of the current minor version. If you are upgrading from a version earlier than 8.7, see [Upgrading from an earlier version](/self-managed/upgrade/index.md#upgrading-from-an-earlier-version).      |
