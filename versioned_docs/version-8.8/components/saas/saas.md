...
| Secure connectivity (AWS PrivateLink)                        | <p>Enable private inbound connectivity from your VPC to AWS-hosted Orchestration Clusters using AWS PrivateLink. Available for Enterprise plans. Supported for 8.8 AWS-hosted clusters.</p><p>See [version 8.9 secure connectivity (AWS PrivateLink) documentation](/versioned_docs/version-8.9/components/saas/secure-connectivity/index.md) for more information.</p>                                                                                                                                                                                                                                                                                                                     |
