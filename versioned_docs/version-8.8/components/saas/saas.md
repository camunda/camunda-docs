...
| [Secure connectivity (AWS PrivateLink)](/docs/components/saas/secure-connectivity/) | Enable private inbound connectivity from your VPC to AWS-hosted Orchestration Clusters using AWS PrivateLink. Available for Enterprise plans. Supported for 8.8 AWS-hosted clusters.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
