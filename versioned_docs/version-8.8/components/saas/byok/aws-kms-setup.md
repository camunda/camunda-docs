...
1. Download [create-byok-kms-key-single-region.sh](/components/saas/byok/downloads/create-byok-kms-key-single-region.sh).
...
1. Download [create-byok-kms-key-multi-region.sh](/components/saas/byok/downloads/create-byok-kms-key-multi-region.sh).
...
6. **Edit key policy**
   - Switch to policy view and replace the existing policy with the [provided key policy](/components/saas/byok/downloads/aws-kms-key-policy.json).
