...
1. Download [create-byok-kms-key-single-region.sh](https://github.com/camunda/camunda-docs/tree/main/versioned_docs/version-8.8/components/saas/byok/downloads/create-byok-kms-key-single-region.sh).
...
1. Download [create-byok-kms-key-multi-region.sh](https://github.com/camunda/camunda-docs/tree/main/versioned_docs/version-8.8/components/saas/byok/downloads/create-byok-kms-key-multi-region.sh).
...
6. **Edit key policy**
   - Switch to policy view and replace the existing policy with the [provided key policy](https://github.com/camunda/camunda-docs/tree/main/versioned_docs/version-8.8/components/saas/byok/downloads/aws-kms-key-policy.json).
