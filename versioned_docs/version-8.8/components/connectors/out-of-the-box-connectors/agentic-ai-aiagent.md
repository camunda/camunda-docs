...
- [AI Agent Sub-process](#ai-agent-subprocess)
- [AI Agent Task](#ai-agent-task)

:::tip

- You can choose the implementation type that best fits your use case, but the **recommended approach** for most use cases is to use the [**AI Agent Sub-process**](#ai-agent-subprocess) implementation due to the simplified configuration and support for event sub-processes.
...
- With the [AI Agent Sub-process](#ai-agent-subprocess) implementation type, the tool calling loop is handled internally and so is not explicitly modeled in the BPMN diagram.
