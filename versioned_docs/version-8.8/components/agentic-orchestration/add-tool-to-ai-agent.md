...
1. Open your process in [Web Modeler](/components/modeler/web-modeler/index.md) or [Desktop Modeler](/components/modeler/desktop-modeler/index.md).
...
:::note
Modeler provides [modeling guidance](/components/modeler/reference/modeling-guidance/rules/agent-fromai-contract.md) that flags malformed `fromAi()` calls as you model.
:::
