...
<!--- Source: https://github.com/camunda/camunda/blob/stable/8.8/identity/client/src/pages/authorizations/modals/add-modal/AddModal.tsx#L40 --->
...
| `PROCESS_DEFINITION`               | `*`, `order_process`                   | All processes / BPMN Process ID      | `CANCEL_PROCESS_INSTANCE`, `CREATE_PROCESS_INSTANCE`, `DELETE_PROCESS_INSTANCE`, `MODIFY_PROCESS_INSTANCE`, `READ_PROCESS_DEFINITION`, `READ_PROCESS_INSTANCE`, `READ_USER_TASK`, `UPDATE_PROCESS_INSTANCE`, `UPDATE_USER_TASK`                                                                                                                                                                                                            |
...
| `USER`                             | `*`, `felix.mueller`                   | All users / Username                 | `CREATE`, `DELETE`, `READ`, `UPDATE`                                                                                                                                                                                                                                                                                                                                                                                                       |
