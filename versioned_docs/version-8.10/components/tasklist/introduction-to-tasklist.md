...
As you model and run business processes using BPMN, users are notified in Tasklist when they're assigned a task, and run the work that's required for the specific task. Also, tasks shows up in Tasklist whether the preceding step ran automatically or an [AI agent](/reference/glossary.md#ai-agent) produced the result a person now acts on.
