...
## Event sub-process conditional start events
...
For details, see [expression-based evaluation](../../../concepts/conditionals.md#expression-based-evaluation).
