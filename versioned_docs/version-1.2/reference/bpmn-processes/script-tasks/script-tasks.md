...
Script tasks behave exactly like [service tasks](/reference/bpmn-processes/service-tasks/service-tasks.md). Both task
...
A script task must define a [job type](/reference/bpmn-processes/service-tasks/service-tasks.md#task-definition). It specifies
