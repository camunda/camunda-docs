...
RocksDB will then allocate [512MB per partition](https://github.com/camunda/camunda/blob/stable/8.4/dist/src/main/config/broker.yaml.template#L946) by default.
