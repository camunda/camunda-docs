---
id: 3.7-to-3.8
title: "Upgrade notes (3.7.x to 3.8.x)"
---

:::note Heads up!
To upgrade Optimize to version 3.8.x, perform the following steps: [Migration & Update Instructions](./instructions.md).
:::

The upgrade to 3.8.x can be performed from any 3.7.x release.
...
See the [supported environments](/reference/supported-environments.md#camunda-7--optimize-version-matrix) sections for the full range of supported versions.
