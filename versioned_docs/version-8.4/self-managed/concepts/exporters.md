...
[Elasticsearch exporter](https://github.com/camunda/camunda/tree/stable/8.4/exporters/elasticsearch-exporter).
...
[exporter interface](https://github.com/camunda/camunda/blob/stable/8.4/exporter-api/src/main/java/io/camunda/zeebe/exporter/api/Exporter.java).
...
in the form of a [configuration](https://github.com/camunda/camunda/tree/stable/8.4/exporter-api/src/main/java/io/camunda/zeebe/exporter/api/context/Configuration.java) object when the broker calls the `Exporter#configure(Configuration)` method.
...
[exporter stream processor](https://github.com/camunda/camunda/tree/stable/8.4/broker/src/main/java/io/camunda/zeebe/broker/exporter/stream/ExporterDirector.java).
