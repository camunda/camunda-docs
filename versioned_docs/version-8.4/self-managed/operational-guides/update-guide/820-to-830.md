...
For more details about the breaking changes in the Helm chart, check the [upgrade page for v8.3.0](../../platform-deployment/helm-kubernetes/update.md#v830-minor).
...
For more details and alternatives please refer to the [Camunda Helm Update instructions](/self-managed/platform-deployment/helm-kubernetes/update.md#v83).
:::
