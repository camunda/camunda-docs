...
The application uses the `$schema` property to ensure compatibility for a given element template. You find [the latest supported version here](https://www.npmjs.com/package/@camunda/element-templates-json-schema).
