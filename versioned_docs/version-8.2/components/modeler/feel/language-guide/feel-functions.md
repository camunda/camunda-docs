...
Invokes a built-in function (e.g. [contains()](/components/modeler/feel/builtin-functions/feel-built-in-functions-string.md#containsstring-match)) or user-defined
