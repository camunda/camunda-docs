...
:::note
Use Camunda secrets to avoid exposing your AWS IAM credentials as plain text. Refer to [manage secrets](components/console/manage-clusters/manage-secrets.md) to learn more.
:::
